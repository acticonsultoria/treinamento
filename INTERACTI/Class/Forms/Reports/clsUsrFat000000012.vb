...
Public Class clsUsrFat000000012
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX,
        ...
        Try
            ...
            oSqlParameter(i).Value = sAgrupadoPor

            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fat000000012", oSqlParameter)
