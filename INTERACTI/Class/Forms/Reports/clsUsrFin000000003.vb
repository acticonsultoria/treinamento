...
Public Class clsUsrFin000000003
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGridLavalpa(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Seta Parametros - Código Tipo Título Financeiro
            oSqlParameter(i) = New SqlParameter
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fin000000003_lavalpa", oSqlParameter)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fin000000003", oSqlParameter)
