...
Public Class clsUsrFin000000002
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGridLavalpa(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fin000000002_lavalpa", oSqlParameter)
    ...
    Public Sub LoadGridNorsul(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fin000000002", oSqlParameter)
