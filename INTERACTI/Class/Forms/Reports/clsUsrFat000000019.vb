...
Public Class clsUsrFat000000019
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX,
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fat000000019", oSqlParameter)
            ...
            oChildColumn1(0) = oDataSet.Tables(1).Columns("codigo_emissao_capa")
            oChildColumn1(1) = oDataSet.Tables(1).Columns("codigo_emissao_item")
