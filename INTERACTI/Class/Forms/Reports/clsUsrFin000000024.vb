...
Public Class clsUsrFin000000024

#Region "::: FUNCTION / SUB :::"
    Public Sub Update(ByVal lCodigoTituloCapa As Long, _
                      ByVal dValor As Double, _
                      ByVal dDataVencimento As Date)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_financeiro_titulo_boleto_report", oSqlParameter)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fin000000024", oSqlParameter)
    ...
    Public Sub LoadGridValores(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fin000000024_2", oSqlParameter)
    ...
    End Sub
    Public Sub LoadGridPercentuais(ByVal oGrid As GridEX, _
                      ByVal iCodigoParceiroNegocio As Integer, _
                      ByVal sDataEmissaoInicio As String, _
                      ByVal sDataEmissaoTermino As String, _
                      ByVal sDataVencimentoInicio As String, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fin000000024_3", oSqlParameter)
