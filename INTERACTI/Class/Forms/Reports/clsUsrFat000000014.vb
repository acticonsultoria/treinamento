...
Public Class clsUsrFat000000014
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fat000000014", oSqlParameter)
    ...
    Public Sub LoadGrafico(ByVal oChart As Chart, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grafico_fat000000014", oSqlParameter)

            'Carrega Gráfico
            oChart.Series.Clear()
            oChart.Series.Add("Default")
            oChart.Series("Default").Points.DataBind(oSqlDataReader, "GRUPO DE ITEM", "VALOR FATURADO", "Tooltip=TAG")
