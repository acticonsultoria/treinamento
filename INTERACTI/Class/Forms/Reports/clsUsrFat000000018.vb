...
Public Class clsUsrFat000000018
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX,
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_fat000000018", oSqlParameter)
            
            Dim oParentColumn(1) As DataColumn
            Dim oChildColumn1(1) As DataColumn

            oParentColumn(0) = oDataSet.Tables(0).Columns("codigo_entrada_capa")
            oParentColumn(1) = oDataSet.Tables(0).Columns("codigo_entrada_item")

            oChildColumn1(0) = oDataSet.Tables(1).Columns("codigo_entrada_capa")
            oChildColumn1(1) = oDataSet.Tables(1).Columns("codigo_entrada_item")
