...
Public Class clsFrmCmpRequisicaoReprovar
    ...
    Public Sub ReprovarRequisicao()
        ...
        Try
            ...
            For i = 0 To UBound(gSelecaoRow)
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_compras_requisicao_reprovar", oSqlParameter)
