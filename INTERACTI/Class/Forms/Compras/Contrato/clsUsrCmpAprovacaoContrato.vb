...
Public Class clsUsrCmpAprovacaoContrato
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Update(ByVal lCodigo As Long, _
                      ...
                      ByVal dTolerancia As Double, _
                      ByVal iCodigoCentroCusto As Integer, _
                      ByVal iTipoTitulo As Integer, _
                      ByVal bAtivo As Boolean, _
                      ByVal sDescritivo As String)
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iTipoTitulo : i += 1
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_compras_aprovar_contrato", oSqlParameter)
    ...
    Public Sub LoadGridAprovacaoSuperior(ByVal oGrid As GridEX, _
                                         ByVal lNumeroContrato As Long, _
                                         ByVal sParceiroNegocio As String, _
                                         ByVal sTipoTitulo As String, _
                                         ByVal sDataInicioFiltro As String, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_compras_aprovacao_superior_contrato", oSqlParameter)
    ...
    Public Sub AprovarContrato(ByVal lCodigoPedido As Long)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_compras_aprovacao_contrato", oSqlParameter)
