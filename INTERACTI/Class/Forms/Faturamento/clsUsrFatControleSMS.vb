...
Public Class clsUsrFatControleSMS
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            oSqlParameter(i).Value = IIf(sCliente = "", DBNull.Value, sCliente) : i += 1
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_emissao_sms", oSqlParameter)
    ...
    'Public Sub LoadGridEnvioSMS(ByVal oGrid As GridEX, _
    ...
    Public Sub UpdateStatus(ByVal lCodigo As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_faturamento_emissao_sms_status", oSqlParameter)
