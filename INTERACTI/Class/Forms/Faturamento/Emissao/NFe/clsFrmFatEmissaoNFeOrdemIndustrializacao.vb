...
Public Class clsFrmFatEmissaoNFeOrdemIndustrializacao
...
#Region "::: MATÉRIA PRIMA :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_emissao_ordem_industrializacao_materia_prima", oSqlParameter)
    ...
    Private Sub InsertProduto(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_ordem_industrializacao_item", oSqlParameter)
