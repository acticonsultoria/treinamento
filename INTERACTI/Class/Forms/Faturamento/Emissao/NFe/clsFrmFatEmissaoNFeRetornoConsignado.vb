...
Public Class clsFrmFatEmissaoNFeRetornoConsignado
...
#Region "::: DEVOLUÇÃO DA NOTA FISCAL :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_retorno_consignado", oSqlParameter)
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                Call InsertItem(lCodigoEmissaoCapa, _
                                ...
                                oRow.Cells("codigo_regra_faturamento_venda").Value, _
                                oRow.Cells("codigo_regra_faturamento_devolucao").Value, _
                                oRow.Cells("quantidade_vendida").Value, _
                                oRow.Cells("quantidade_retorno").Value, _
                                oRow.Cells("valor_unitario").Value, _
                                oRow.Cells("valor_unitario_venda").Value)
    ...
    Private Sub InsertItem(ByVal lCodigoEmissaoCapa As Long, _
                           ...
                           ByVal iCodigoRegraFaturamentoVenda As Integer, _
                           ByVal iCodigoRegraFaturamentoDevolucao As Integer, _
                           ByVal dQuantidadeVendida As Double, _
                           ByVal dQuantidadeDevolvida As Double, _
        ...
        Try
            ...
            'Seta Parametros - Código Regra Faturamento - Venda
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_regra_faturamento_venda"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoRegraFaturamentoVenda : i += 1

            'Seta Parametros - Código Regra Faturamento - Devolução
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_regra_faturamento_devolucao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoRegraFaturamentoDevolucao : i += 1

            'Seta Parametros - Quantidade Vendida
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "quantidade_vendida"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dQuantidadeVendida : i += 1

            'Seta Parametros - Quantidade Devolvida
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "quantidade_devolvida"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dQuantidadeDevolvida : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_retorno_consignado", oSqlParameter)
