...
Public Class clsFrmFatEmissaoNFeRemessaDemonstracao
...
#Region "::: REMESSA DEMONSTRAÇÃO :::"

    Public Sub LoadGridRemessaDemonstracao(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_remessa_demonstracao", oSqlParameter)
    ...
    Public Sub ImportarRemessaDemonstracao(ByVal lCodigoEmissaoCapa As Long, _
                                           ByVal iCodigoCliente As Integer, _
    ...
    Public Sub InsertTransporte(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_transporte_remessa_demonstracao", oSqlParameter)
    ...
    Public Sub InsertFatura(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_fatura_remessa_demonstracao", oSqlParameter)
    ...
    Public Sub InsertItem(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_item_remessa_demonstracao", oSqlParameter)
