...
Public Class clsFrmFatEmissaoNFeLocalEntrega
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            oSqlParameter(1).Value = IIf(sLogradouro = "", DBNull.Value, sLogradouro)
            ...
            oSqlParameter(2).Value = IIf(sNumero = "", DBNull.Value, sNumero)
            ...
            oSqlParameter(4).Value = IIf(sBairro = "", DBNull.Value, sBairro)
            ...
            oSqlParameter(5).Value = IIf(sUF = "", DBNull.Value, sUF)
            ...
            oSqlParameter(6).Value = IIf(iMunicipio = -1, DBNull.Value, iMunicipio)
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_local_entrega", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_faturamento_emissao_local_entrega", oSqlParameter)
    ...
    Public Sub LoadControles(ByVal lCodigoEmissaoCapa As Long, _
                             ByVal iCodigoEndereco As Integer, _
        ...
        Try
            ...
            'Seta Parametros - Código Endereço
            ...
            oSqlParameter(i).Value = txtCNPJ.Text.Trim : i += 1
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_parceiro_negocio_endereco_faturamento", oSqlParameter)
    ...
    Public Sub LoadControles(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_emissao_local_entrega", oSqlParameter)
