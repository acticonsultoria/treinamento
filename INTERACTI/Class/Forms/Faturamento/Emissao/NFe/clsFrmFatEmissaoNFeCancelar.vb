...
Public Class clsFrmFatEmissaoNFeCancelar
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub UpdateNFeCancelamento(ByVal sMensagemSefaz As String, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_faturamento_emissao_capa_nfe_cancelamento", oSqlParameter)
    ...
    Public Sub UpdateNFeCancelamento(ByVal lCodigoEmissaoCapa As Long, _
    ...
    Public Function ValidaNFe() As Integer
    ...
    Public Sub DeleteMovimentacaoEstoque()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_estoque_movimentacao_faturamento_emissao", oSqlParameter)
    ...
    Public Sub DeleteContasReceber()
        ...
        Try
            ...
            'Seta Parametros - Código Emissão Capa
            oSqlParameter(0) = New SqlParameter
            oSqlParameter(0).ParameterName = "codigo_faturamento_emissao_capa"
            oSqlParameter(0).Direction = ParameterDirection.Input
            oSqlParameter(0).SqlDbType = SqlDbType.BigInt
            oSqlParameter(0).Value = lCodigoEmissaoCapa
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_financeiro_titulo_faturamento_emissao", oSqlParameter)
