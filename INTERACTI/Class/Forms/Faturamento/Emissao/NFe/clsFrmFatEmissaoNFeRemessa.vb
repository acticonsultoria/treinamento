...
Public Class clsFrmFatEmissaoNFeRemessa
...
#Region "::: REMESSA :::"
    ...
    Public Sub LoadGridRemessa(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_remessa2", oSqlParameter)
            ...
            For Each oRow As GridEXRow In oGrid.GetDataRows
                If IsDBNull(oRow.Cells("codigo_regra_faturamento").Value) Then
    ...
    Public Sub ImportarRemessa(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                Call InsertItem2(lCodigoEmissaoCapa, _
    ...
    Public Sub InsertTransporte(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_transporte_remessa", oSqlParameter)
    ...
    Public Sub InsertFatura(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_fatura_remessa", oSqlParameter)
    ...
    Public Sub InsertItem(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_item_remessa", oSqlParameter)
    ...
    End Sub
    Public Sub InsertItem2(ByVal lCodigoEmissaoCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_item_remessa2", oSqlParameter)
