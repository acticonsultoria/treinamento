...
Public Class clsUsrFatEmissaoNFs
    ...
    Public Sub LoadDadosNotaFiscal(ByVal lCodigo As Long, _
        ...
        Try
            ...
            While oSqlDataReader.Read
                ...
                txtCnae.Text = oSqlDataReader.Item("cnae")
...
#End Region
    ...
    Public Function ImportarNFSe(ByRef lCodigo As Long, _
                            ByVal sNotaFiscal As String, _
                            ByVal sNumeroRPS As String, _
                            ByVal dDataEmissao As Date, _
                            ByVal iCodigoNaturezaOperacao As Integer, _
                            ByVal sUFTributacao As String, _
                            ByVal sMunicipioTributacao As String, _
                            ByVal sCNPJTomador As String, _
                            ByVal sRazaoSocialTomador As String, _
                            ByVal sCodigoVerificacao As String, _
                            ByVal sServicoCompleto As String, _
                            ByVal sDiscriminacao As String, _
                            ...
                            ByVal dValorISS As Double, _
                            ByVal dBaseCalculo As Double, _
                            ByVal dValorISSRetido As Double) As String
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.BigInt
            oSqlParameter(i).Value = CLng(sNotaFiscal) : i += 1
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = LTrim(RTrim(sUFTributacao)) : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "municipio_tributacao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 1000
            oSqlParameter(i).Value = RTrim(sMunicipioTributacao) : i += 1
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "servico_completo"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 1000
            oSqlParameter(i).Value = sServicoCompleto : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "discriminacao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 1000
            oSqlParameter(i).Value = RTrim(sDiscriminacao) : i += 1
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = sCodigoVerificacao : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "cnpj_tomador"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 1000
            oSqlParameter(i).Value = LTrim(RTrim(Mid(LTrim(RTrim(sCNPJTomador)), 1, 18))) : i += 1


            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "razao_social_tomador"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 1000
            oSqlParameter(i).Value = RTrim(sRazaoSocialTomador) : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "numero_rps"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.BigInt
            oSqlParameter(i).Value = IIf(IsNumeric(sNumeroRPS), sNumeroRPS, DBNull.Value) : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_emissao_nfse_importar", oSqlParameter)
...
#Region "::: DISPARO DE EMAIL :::"
    ...
    Public Sub EnviarEmailEmissaoNFS(ByVal sCodigoVerificacao As String)
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = sCodigoVerificacao : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_email_faturamento_servico_emissao", oSqlParameter)
