...
Imports INTERACTI.br.gov.sp.sjc.notajoseense

Public Class clsUsrFatEntradaNF
...
#Region "::: VARIAVEIS - CAPA :::"
    ...
    Private iCodigoTipoEntrada As Integer
...
#Region "::: PROPERTIE - CAPA :::"
    ...
    Public Property CodigoTipoEntrada() As Integer
        Get
            Return iCodigoTipoEntrada
        End Get
        Set(ByVal value As Integer)
            iCodigoTipoEntrada = value
        End Set
    End Property
...
#Region " ::: CAPA "
    ...
    Public Sub UpdateNotaFiscal()
        ...
        Try
            ...
            'Seta Parametros - importar direto
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_tipo_entrada"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoTipoEntrada : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iTipoNotaFiscal : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Value = sEspecie : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.DateTime
            oSqlParameter(i).Value = sDataEntrada : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iCodigoFormaPagamento : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 44
            oSqlParameter(i).Value = IIf(sChaveAcessoDACTE = "", DBNull.Value, sChaveAcessoDACTE) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Value = IIf(sNumeroProtocolo = "", DBNull.Value, sNumeroProtocolo) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Value = IIf(sArquivoNFe = "", DBNull.Value, sArquivoNFe) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 100
            oSqlParameter(i).Value = IIf(sStatusNFe = "", DBNull.Value, sStatusNFe) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Value = bInspecao : i += 1 : ReDim Preserve oSqlParameter(i)
    ...
    Public Sub DeleteNotaFiscal()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                Dim iFinanceiro As Integer
                iFinanceiro = LoadCodigo("sp_validate_entrada_nota_fiscal_financeiro " & oRow.Cells("codigo").Value & ", " & goUsuario.iEmpresa)

                If iFinanceiro >= 1 Then
                    MsgBox("Existem títulos financeiros quitados para a NF [ " & oRow.Cells("nota_fiscal").Value & " ]!", MsgBoxStyle.OkOnly + MsgBoxStyle.Information)
                    Exit Sub
                End If
    ...
    Public Sub GerarPedidoNotaFiscal()

        'Variaveis Locais
        Dim oSqlParameter(2) As SqlParameter
        Dim i As Integer
        Dim sNotasComPedido As String = ""
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                If oRow.Cells("possui_pedido").Value = 0 Then
                    ...
                    'Executa Query
                    ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_compras_pedido_nota_entrada", oSqlParameter)
                Else
                    sNotasComPedido += oRow.Cells("nota_fiscal").Value + "; "
                End If

            Next

            If sNotasComPedido <> "" Then
                MsgBox("As notas fiscais: " + sNotasComPedido + " já possuem pedido de compra.")
            End If
    ...
    Public Sub LoadDadosNotaFiscal(ByVal lCodigoEntradaCapa As Long, _
                                   ByVal cboTipoEntrada As UIComboBox, _
                                   ...
                                   ByVal txtInformacoesContrato As MaskedEditBox, _
                                   ByVal cboTipoDocumentoPagamento As UIComboBox, _
                                   ByVal txtDescritivo As EditBox, _
                                   ByVal txtCCeSequencia As MaskedEditBox, _
                                   ByVal dtpCCeDataEvento As CalendarCombo, _
                                   ByVal txtCCeNumeroProtocolo As MaskedEditBox, _
                                   ByVal txtCCeCorrecao As EditBox)
        ...
        Try
            ...
            Else
                ...
                While oSqlDataReader.Read
                    ...
                    If IsDBNull(oSqlDataReader.Item("codigo_tipo_entrada")) Then
                        cboTipoEntrada.SelectedIndex = -1
                    Else
                        cboTipoEntrada.SelectedValue = oSqlDataReader.Item("codigo_tipo_entrada")
                    End If
                    ...
                    txtCCeSequencia.Text = oSqlDataReader.Item("cce_sequencia")
                    dtpCCeDataEvento.Value = oSqlDataReader.Item("cce_data_evento")
                    txtCCeNumeroProtocolo.Text = oSqlDataReader.Item("cce_numero_protocolo")
                    txtCCeCorrecao.Text = oSqlDataReader.Item("cce_correcao")
    ...
    Public Function ImportarXML(ByVal sArquivoXML As String, _
                                ...
                                ByVal iCodigoTipoEntrada As Integer) As String
        ...
        Try
            ...
            'Seta Parametros - Codigo Tipo Entrada
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_tipo_entrada"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoTipoEntrada : i += 1
            ...
            If sArquivoXML.ToUpper.Contains("CTEPROC") Then
                ...
                sReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_entrada_importar_xml_cte", oSqlParameter), String)
            ElseIf sArquivoXML.ToUpper.Contains("CTEOSPROC") Then

                sReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_entrada_importar_xml_cte_OS", oSqlParameter), String)
            Else
                If iCodigoTipoEntrada <> 1 Then

                    sReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_entrada_importar_xml2", oSqlParameter), String)
                Else
            ...
            If sReturn = "" Then
                ...
                If iCodigoTipoEntrada <> 1 Then
                    lCodigoEntradaCapa = oSqlParameter(1).Value
                End If
    ...
    'Public Function ImportarXML(ByVal sArquivoXML As String, _
    '                            ByVal sCaminhoArquivo As String, _
    '                            ByVal bImportarDireto As Boolean) As String
    ...
    '        'Seta Parametros - Importar Direto
    '        oSqlParameter(i) = New SqlParameter
    '        oSqlParameter(i).ParameterName = "importar_direto"
    '        oSqlParameter(i).Direction = ParameterDirection.Input
    '        oSqlParameter(i).SqlDbType = SqlDbType.Bit
    '        oSqlParameter(i).Value = bImportarDireto : i += 1
    ...
    Public Sub LoadDadosPedidoCompra(ByVal lCodigoEntradaCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_entrada_dados_pedido_compra", oSqlParameter)
    ...
    Public Sub VincularPedido(ByVal lCodigoEntradaCapa As Long, _
                              ByVal iCodigoPedido As Integer)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_faturamento_entrada_capa_vincular_pedido", oSqlParameter)
    ...
    Public Sub UpadatePagarEstoqueRequisicao()
        'Variaveis Locais
        Dim oSqlParameter(0) As SqlParameter
        Dim i As Integer = 0
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_estoque_requisicao_pagar_item_automatico", oSqlParameter)
...
#Region " ::: PRODUTO ::: "
    ...
    Public Sub LoadGridExportar(ByVal oGrdListagem As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_entrada_exportar_contabilidade", oSqlParameter)
...
#Region " ::: CCE ::: "
    ...
    Public Sub DeleteCCe()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_faturamento_entrada_cce", oSqlParameter)
    ...
    Public Sub InsertCCe(ByVal sSequencia As String, _
                         ByVal sDataEvento As String, _
                         ByVal sNumeroProtocolo As String, _
                         ByVal sCorrecao As String)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_entrada_cce", oSqlParameter)
...
#Region " ::: COMPRAS ::: "
    ...
    Public Sub InsertComprasRetornoConserto(ByVal lCodigoEntradaCapa As Long, _
...
#Region " ::: FINANCEIRO ::: "
    ...
    Public Sub DeleteFinanceiro()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_faturamento_entrada_fatura_financeiro", oSqlParameter)
    ...
    Public Sub InsertFinanceiro(ByVal oGrid As GridEX)
        ...
        Try
            ...
            For Each oRow As GridEXRow In oGrid.GetDataRows
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_entrada_fatura_financeiro", oSqlParameter)
    ...
    Public Sub LoadGridFinanceiro(ByVal lCodigoEntradaCapa As Long, _
                                  ByVal oGrid As GridEX)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_entrada_fatura_financeiro", oSqlParameter)
...
#Region "::: QUALIDADE :::"
    ...
    Public Sub InsertOpcaoCriterioAvaliacao(ByVal lCodigoEntradaCapa As Long, _
                                            ByVal iCodigoCriterioAvaliacao As Integer, _
                                            ByVal iCodigoCriterioAvaliacaoOpcao As Integer, _
        ...
        Try
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_criterio_avaliacao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iCodigoCriterioAvaliacao : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_criterio_avaliacao_opcao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iCodigoCriterioAvaliacaoOpcao : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_entrada_criterio_avaliacao", oSqlParameter)
    ...
    Public Sub LoadGridCriterioAvaliacao(ByVal oGrid As GridEX, _
                                         ByVal lCodigoEntradaCapa As Long)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_entrada_criterio_avaliacao", oSqlParameter)
    ...
    Public Sub LoadGridCriterioAvaliacaoOpcao(ByVal oGrid As GridEX, _
                                              ByVal lCodigoEntradaCapa As Long, _
                                              ByVal iCodigoCriterioAvaliacao As Integer)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_entrada_criterio_avaliacao_opcao", oSqlParameter)
