...
Public Class clsFrmFatEntradaNFeLocalRetirada
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Salvar()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_faturamento_entrada_local_retirada", oSqlParameter)
    ...
    Public Sub LoadControles(ByVal lCodigoEntradaCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_entrada_local_retirada", oSqlParameter)
