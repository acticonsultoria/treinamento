...
Imports INTERACTI.NFSE_Jacarei.CancelarNFSeEnvio
Imports INTERACTI.NFSE_Jacarei.CancelarNFSeRetorno
Imports INTERACTI.NFSE_Jacarei.ValidaXML
Imports INTERACTI.NFSE_Jacarei.WebService

Public Class clsNFSE_Jacarei_CancelarNFSe
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            Dim oInfRPS As New NFSE_Jacarei.CancelarNFSeEnvio.tcIdentificacaoNfse
            ...
            Dim oPedido As New NFSE_Jacarei.CancelarNFSeEnvio.tcPedidoCancelamento
            Dim oPedidoCancelamento As New NFSE_Jacarei.CancelarNFSeEnvio.tcInfPedidoCancelamento
            ...
            sRetornoValidacao = ValidaArquivoXML(sArquivoEnvio, _
                                                 goConfiguracaoNFSe.sPastaXSD & "servico_cancelar_nfse_envio.xsd", _
            ...
            Else
                ...
                Try
                    ...
                    If goConfiguracaoNFSe.iCodigoTipoAmbienteNFSe = TipoAmbienteNFe.homologacao Then
                        sRetornoWS = WS_CancelarNFSeHomologacao(sArquivoEnvio)
                    ElseIf goConfiguracaoNFSe.iCodigoTipoAmbienteNFSe = TipoAmbienteNFe.producao Then
                        sRetornoWS = WS_CancelarNFSeProducao(sArquivoEnvio)
                    End If
