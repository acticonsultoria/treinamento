...
Imports INTERACTI.NFSE_Jacarei.AssinaturaDigital
Imports INTERACTI.NFSE_Jacarei.EnviarLoteEnvio
Imports INTERACTI.NFSE_Jacarei.ValidaXML
Imports INTERACTI.SQLHelper

Namespace NFSE_Jacarei.DadosServico
        ...
        Private Overloads Shared Sub NFSE_A_Cabecalho(ByRef oTNFSE As EnviarLoteRpsEnvio, _
            ...
            Try
                ...
                If oSqlDataReader.Read Then
                    Dim otcCpfCnpj As New NFSE_Jacarei.EnviarLoteEnvio.tcCpfCnpj
                    otcCpfCnpj.ItemElementName = ConsultarLoteEnvio.ItemChoiceType.Cnpj
                    otcCpfCnpj.Item = oSqlDataReader.Item("cnpj")
                    oTNFSE.LoteRps.CpfCnpj = otcCpfCnpj
                    oTNFSE.LoteRps.id = ""
            ...
            Try
                ...
                If oSqlDataReader.Read Then
                    ...
                    With oInfRps
                        ...
                        .OptanteSimplesNacional = IIf((oSqlDataReader.Item("codigo_regime_tributario") = CInt(RegimeTributario.LucroPresumido) Or oSqlDataReader.Item("codigo_regime_tributario") = CInt(RegimeTributario.LucroReal)), 2, 1)
        ...
        Private Overloads Shared Sub NFSE_E_ConstrucaoCivil(ByRef oTNFSE As EnviarLoteRpsEnvio)
            ...
            Try
                ...
                If oSqlDataReader.Read Then
                    ...
                    'Setando
                    oTNFSE.LoteRps.ListaRps(0).InfRps.ContrucaoCivil = oDadosConstrucaoCivil
        ...
        Private Overloads Shared Sub NFSE_F_Prestador(ByRef oTNFSE As EnviarLoteRpsEnvio)
            ...
            Try
                ...
                If oSqlDataReader.Read Then
                    ...
                    Dim otcCpfCnpj As New NFSE_Jacarei.EnviarLoteEnvio.tcCpfCnpj
                    otcCpfCnpj.ItemElementName = ConsultarLoteEnvio.ItemChoiceType.Cnpj
                    otcCpfCnpj.Item = RetirarAcento2(oSqlDataReader.Item("cnpj"))
                    oIdentificacaoPrestador.CpfCnpj = otcCpfCnpj
        ...
        Private Overloads Shared Sub NFSE_H_Servico(ByRef oTNFSE As EnviarLoteRpsEnvio)
            ...
            Try
                ...
                If oSqlDataReader.Read Then
                    ...
                    End If
                    oDadosServico.MunicipioPrestacaoServico = oSqlDataReader.Item("codigo_ibge_municipio")
                    ...
                    oDadosServico.ItemListaServico = Replace(oSqlDataReader.Item("codigo_servico"), ".", "")
            ...
            Try
                ...
                If oSqlDataReader.Read Then
                    ...
                    If Not IsDBNull(oSqlDataReader.Item("aliquota_iss")) Then
                        oValores.Aliquota = FormatarNumero(oSqlDataReader.Item("aliquota_iss") / 100, TipoFormatacao.oDecimal_4_Casas)
                        oValores.AliquotaSpecified = True
                    End If
                ...
                If oSqlDataReader.Read Then
                    ...
                    With oEndereco
                        ...
                        If IsDBNull(oSqlDataReader.Item("codigo_ibge")) = False Then
                            .Cidade = oSqlDataReader.Item("codigo_ibge")
