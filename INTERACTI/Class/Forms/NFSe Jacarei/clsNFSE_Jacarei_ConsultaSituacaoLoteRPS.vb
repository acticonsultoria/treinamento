...
Imports INTERACTI.NFSE_Jacarei.ConsultarRPSEnvio
Imports INTERACTI.NFSE_Jacarei.ConsultarRPSRetorno
Imports INTERACTI.NFSE_Jacarei.ValidaXML
Imports INTERACTI.NFSE_Jacarei.WebService

Public Class clsNFSE_Jacarei_ConsultaSituacaoLoteRPS
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Dim oTConsLoteNFSe As New ConsultarSituacaoLoteEnvio.ConsultarSituacaoLoteRpsEnvio

        Try

            Dim oPrestador As New NFSE_Jacarei.ConsultarSituacaoLoteEnvio.tcIdentificacaoPrestador
            Dim otcCpfCnpj As New NFSE_Jacarei.ConsultarSituacaoLoteEnvio.tcCpfCnpj
            ...
            sRetornoValidacao = ValidaArquivoXML(sArquivoEnvio, _
                                                 goConfiguracaoNFSe.sPastaXSD & "servico_consultar_situacao_lote_rps_envio.xsd", _
                                                 "servico_consultar_situacao_lote_rps_envio.xsd")
            'sRetornoValidacao = ValidaArquivoXML(sArquivoEnvio, _
            '                                     goConfiguracaoNFSe.sPastaXSD & "servico_consultar_lote_rps_envio.xsd", _
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        'Váriaveis Locais
        Dim oTRetConsSituacaoLote As New ConsultarNfseResposta

        Try

            'Carrega arquivo de Retorno
            oTRetConsSituacaoLote = NFSE_Jacarei.ConsultarRPSRetorno.ConsultarNfseResposta.Load(sArquivo)
