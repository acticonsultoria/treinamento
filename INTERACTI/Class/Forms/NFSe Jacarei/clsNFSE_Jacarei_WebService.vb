...
Imports System.Net
Imports INTERACTI.NFSE_Jacarei.CertificadoDigital

Namespace NFSE_Jacarei
...
#Region "::: FUNCION PRODUÇÃO :::"
        ...
        Public Overloads Shared Function WS_EnvioLoteNFSeProducao(ByVal sMensagem As String) As String
            ...
            Try
                ...
                'Váriaveis Locais
                Dim oServiceGinfesImplService As New br.com.issnetonline.producao.Servicos
                ...
                'Consumindo o WebService
                sRetorno = oServiceGinfesImplService.RecepcionarLoteRps(sDadosNFSe)
        ...
        Public Overloads Shared Function WS_ConsultaSituacaoLoteRPSProducao(ByVal sMensagem As String) As String
            ...
            Try
                ...
                'Consumindo o WebService
                sRetorno = oServiceGinfesImplService.ConsultaSituacaoLoteRPS(sDadosNFSe)
