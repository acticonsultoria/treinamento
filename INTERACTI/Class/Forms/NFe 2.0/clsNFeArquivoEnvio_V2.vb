...
Public Class clsNFeArquivoEnvio_V2
    ...
    Public Function ArquivoNFe(ByVal sArquivoXML As String, _
        ...
        Try
            ...
            sCabecalho = "<?xml version=""1.0"" encoding=""UTF-8""?>" & _
                         "<nfeProc xmlns=""http://www.portalfiscal.inf.br/nfe"" xmlns:ds=""http://www.w3.org/2000/09/xmldsig#"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xsi:schemaLocation=""http://www.portalfiscal.inf.br/nfe procNFe_v2.00.xsd"" versao=""2.00"">" & _
                         "</nfeProc>"
            ...
            If sArquivoXMLCancelamento <> "" Then
                oNodeEnvioCancelamento = oXmlDocumentCancelamentoNFe.GetElementsByTagName("cancNFe")
                oNodeProtocoloCancelamento = oXmlDocumentProtocoloCancelamento.GetElementsByTagName("retCancNFe")
