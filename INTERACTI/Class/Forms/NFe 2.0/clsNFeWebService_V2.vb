...
Namespace NFe
    ...
    Public NotInheritable Class WebService_V2

        Public Overloads Shared Function WSStatusServico_V2(ByVal sMensagem As String) As String
            ...
            Try
                ...
                oNFeCabecalho.versaoDados = "2.00"
        ...
        Public Overloads Shared Function WSRecepcaoLote_V2(ByVal sMensagem As String) As String
            ...
            Try
                ...
                'Váriaveis Locais
                Dim oNfeRecepcaoLote As New br.gov.fazenda.nfe.V2_RecepcaoLote.NfeRecepcao2
                Dim oMsgCabecalho As New br.gov.fazenda.nfe.V2_RecepcaoLote.nfeCabecMsg
                ...
                sRetorno = oNfeRecepcaoLote.nfeRecepcaoLote2(oXmlDocument).OuterXml
        ...
        Public Overloads Shared Function WSRetRecepcaoLote_V2(ByVal sMensagem As String) As String
            ...
            Try
                ...
                'Váriaveis Locais
                Dim oNfeRetRecepcaoLote As New br.gov.fazenda.nfe.V2_RetRecepcaoLote.NfeRetRecepcao2
                Dim oMsgCabecalho As New br.gov.fazenda.nfe.V2_RetRecepcaoLote.nfeCabecMsg
                ...
                sRetorno = oNfeRetRecepcaoLote.nfeRetRecepcao2(oXmlDocument).OuterXml
        ...
        Public Overloads Shared Function WSCancelarNotaFiscal_V2(ByVal sMensagem As String) As String
            ...
            Try
                ...
                'Váriaveis Locais
                Dim oNfeCancelamento As New br.gov.fazenda.nfe.V2_CancelamentoNF.NfeCancelamento2
                Dim oMsgCabecalho As New br.gov.fazenda.nfe.V2_CancelamentoNF.nfeCabecMsg

                'Seta URL
                oNfeCancelamento.Url = LoadURLNFe(WebServiceNFe.NfeCancelamento, goEmitente.sUF)

                'Adiciona Certificado
                oNfeCancelamento.ClientCertificates.Add(oCertificado)

                'Caso tenha Proxy
                If goConfiguracaoNFe.bHabilitarProxy = True Then
                    Dim sEndereco As String = goConfiguracaoNFe.sEndereco & ":" & goConfiguracaoNFe.iPorta
                    oNfeCancelamento.Proxy = New WebProxy(sEndereco, True)
                    If goConfiguracaoNFe.sDominio.Trim = "" Then
                        oNfeCancelamento.Proxy.Credentials = New NetworkCredential(goConfiguracaoNFe.sUsuario, Cripitografar(goConfiguracaoNFe.sSenha))
                    Else
                        oNfeCancelamento.Proxy.Credentials = New NetworkCredential(goConfiguracaoNFe.sUsuario, Cripitografar(goConfiguracaoNFe.sSenha), goConfiguracaoNFe.sDominio)
                    End If
                End If
                ...
                oMsgCabecalho.cUF = goEmitente.iUF
                oMsgCabecalho.versaoDados = "2.00"
                oNfeCancelamento.nfeCabecMsgValue = oMsgCabecalho

                sRetorno = oNfeCancelamento.nfeCancelamentoNF2(oXmlDocument).OuterXml
                oNfeCancelamento.Dispose()
        ...
        Public Overloads Shared Function WSConsultaSituacaoNF_V2(ByVal sMensagem As String) As String
        ...
        Public Overloads Shared Function WSInutilizacaoNumeracaoNFe(ByVal sMensagem As String) As String
