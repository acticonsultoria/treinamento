...
Imports INTERACTI.NFe.ConsultaRecepcaoNFe_V2
Imports INTERACTI.NFe.RetConsultaRecepcaoNFe_V2
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V2

Public Class clsNFeConsultaRecepcaoNFe_V2
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTConsReciNFe.versao = "2.00"
            oTConsReciNFe.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, ConsultaStatusServico_V2.TAmb.Item2, ConsultaStatusServico_V2.TAmb.Item1)
            ...
            sRetornoValidacao = ValidaArquivoXML(sPathArquivoEnvio, _
                                                 goConfiguracaoNFe.sPastaXSD & "consReciNFe_v2.00.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sArquivoRetornoXML = WSRetRecepcaoLote_V2(sPathArquivoEnvio)
