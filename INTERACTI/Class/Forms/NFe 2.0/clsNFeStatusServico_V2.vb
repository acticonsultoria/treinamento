...
Imports INTERACTI.NFe.ConsultaStatusServico_V2
Imports INTERACTI.NFe.RetConsultaStatusServico_V2
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V2


Public Class clsNFeStatusServico_V2
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTConsStatServ.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, ConsultaStatusServico_V2.TAmb.Item2, ConsultaStatusServico_V2.TAmb.Item1)
            oTConsStatServ.cUF = DefineEnum(goConfiguracaoNFe.sCodigoEstado, GetType(ConsultaStatusServico_V2.TCodUfIBGE))
            ...
            sRetornoValidacao = ValidaArquivoXML(sArquivoEnvio, _
                                                 goConfiguracaoNFe.sPastaXSD & "consStatServ_v2.00.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sRetornoWS = WSStatusServico_V2(sArquivoEnvio)
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        Try
            ...
            iCodigoTipoAmbiente = IIf(oTRetConsStatServ.tpAmb = ConsultaStatusServico_V2.TAmb.Item1, TipoAmbienteNFe.producao, TipoAmbienteNFe.homologacao)
