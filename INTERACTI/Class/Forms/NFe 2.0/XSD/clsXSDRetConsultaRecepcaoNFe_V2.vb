...
Namespace NFe.RetConsultaRecepcaoNFe_V2
    '
    ...
    Partial Public Class TRetConsReciNFe
        Public Shared Function Load(ByVal sFileName As String) As TRetConsReciNFe

            Dim oFileStream As FileStream
            Dim oReturn As TRetConsReciNFe

            Try

                oFileStream = OpenRead(sFileName)
                Dim oXmlSerializer As New XmlSerializer(GetType(TRetConsReciNFe))
