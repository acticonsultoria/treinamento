...
Namespace NFe.RetCancelamentoNFe_V2
    '
    ...
    Partial Public Class TRetCancNFe
        Public Shared Function Load(ByVal sFileName As String) As TRetCancNFe

            Dim oFileStream As FileStream
            Dim oReturn As TRetCancNFe

            Try

                oFileStream = OpenRead(sFileName)
                Dim oXmlSerializer As New XmlSerializer(GetType(TRetCancNFe))
