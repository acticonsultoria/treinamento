...
Imports INTERACTI.NFe.ConsultaSituacaoNF_V2
Imports INTERACTI.NFe.RetConsultaSituacaoNFe_V2
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V2

Public Class clsNFeConsultaSituacao_V2
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTConsSitNFe.versao = "2.00"
            oTConsSitNFe.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, ConsultaStatusServico_V2.TAmb.Item2, ConsultaStatusServico_V2.TAmb.Item1)
            ...
            sRetornoValidacao = ValidaArquivoXML(sPathArquivoEnvio, _
                                                 goConfiguracaoNFe.sPastaXSD & "consSitNFe_v2.00.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sXMLRetorno = WSConsultaSituacaoNF_V2(sPathArquivoEnvio)
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        Try
            ...
            Else
                ...
                sUF = "SP"
                sAmbiente = IIf(oTRetConsSitNFe.protNFe.infProt.tpAmb = RetConsultaSituacaoNFe_V2.TAmb.Item1, "PRODUÇÃO", "HOMOLOGAÇÃO")
            End If
