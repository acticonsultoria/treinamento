...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function SendRecusa(ByVal sChaveAcesso As String, _
                               ByVal sSequencia As String, _
                               ByVal lLote As Long, _
                               ByVal sJustificativa As String) As Boolean
    ...
    Public Sub InsertManifestacao(ByVal sChaveAcesso As String, _
                                  ...
                                  Optional ByVal sJustificativa As String = "")
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = IIf(sJustificativa = "", DBNull.Value, sJustificativa)
