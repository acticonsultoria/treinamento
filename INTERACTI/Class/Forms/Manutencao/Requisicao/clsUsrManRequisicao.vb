...
Public Class clsUsrManRequisicao
...
#Region "::: REQUISIÇÃO :::"
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_manutencao_requisicao", oSqlParameter)
    ...
    Public Sub Insert()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_manutencao_requisicao", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_manutencao_requisicao", oSqlParameter)
    ...
    Public Sub LoadGridRequisicao(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoRequisitante : i += 1
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_manutencao_requisicao", oSqlParameter)
...
#Region "::: MANUTENÇÃO :::"
    ...
    Public Sub LoadGridManutencao(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_manutencao_requisicao_manutencao", oSqlParameter)
    ...
    Public Sub DeleteManutencao(ByVal lCodigoRequisicao As Long)
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                oSqlParameter(i).Direction = ParameterDirection.Input
                oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
                oSqlParameter(i).Value = oRow.Cells("codigo_manutencao").Value : i += 1
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_manutencao_requisicao_manutencao", oSqlParameter)
    ...
    Public Sub InsertManutencao(ByVal lCodigoRequisicao As Long, _
                                ByVal iCodigoManutencao As Integer, _
                                ByVal sComplemento As String, _
                                ByVal sDataNecessidade As String, _
                                ByVal iCodigoArea As Integer, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_manutencao_requisicao_manutencao", oSqlParameter)
    ...
    Public Sub UpdateManutencao(ByVal lCodigoRequisicao As Long, _
                                ByVal iCodigoManutencao As Integer, _
                                ByVal sComplemento As String, _
                                ByVal sDataNecessidade As String, _
                                ByVal iCodigoArea As Integer, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_manutencao_requisicao_manutencao", oSqlParameter)
...
#Region "::: HISTÓRICO :::"
    ...
    Public Sub LoadGridHistorico(ByVal oGrid As GridEX, _
                                 ...
                                 ByVal iCodigoRequisicaoManutencao As Integer)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_manutencao_requisicao_manutencao_historico", oSqlParameter)
