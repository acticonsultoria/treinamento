...
Public Class clsUsrIntProsoftFinanceiro
...
#Region "::: FUNCTION / SUB :::"
            ...
            For iLinha As Integer = 0 To UBound(lCodigo)
                ...
                If iInformacao = 1 Then 'Capa
                    If iTipo = TipoDocumentoFiscal.Entrada Then
                        oSqlDataReader = SQLHelper.ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_prosoft_entrada_capa", oSqlParameter)
                    Else
                        oSqlDataReader = SQLHelper.ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_prosoft_emissao_capa", oSqlParameter)
                    End If
                Else
                    If iTipo = TipoDocumentoFiscal.Entrada Then
                        oSqlDataReader = SQLHelper.ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_prosoft_entrada_item", oSqlParameter)
                    Else
                        oSqlDataReader = SQLHelper.ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_prosoft_emissao_item", oSqlParameter)
                    End If
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Quety
            oDataSet = SQLHelper.ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_integracao_financeiro_prosoft", oSqlParameter)
    ...
    Public Sub LoadGridModelo1(ByVal oGrid As GridEX, _
                               ByVal sDataInicio As String, _
        ...
        Try
            ...
            'Executa Quety
            oDataSet = SQLHelper.ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_integracao_modelo1", oSqlParameter)
