...
Public Class clsUsrPrdApontamentoAutomatizado
...
#Region "::: APONTAMENTO :::"
    ...
    Public Sub LoadGridApontamento(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_producao_ordem_producao_apontamento_automatizado", oSqlParameter)
    ...
    Public Sub UpdateApontamento(ByVal lCodigo As Long, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = sPeriodo : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_producao_apontamento_automatizado", oSqlParameter)
    ...
    Public Sub ExcluirApontamento(ByVal lCodigo As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_producao_apontamento_automatizado", oSqlParameter)
