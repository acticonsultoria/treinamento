...
Public Class clsUsrPrdApontamentoIssartel
...
#Region "::: APONTAMENTO :::"
    ...
    Public Sub LoadDadosApontamento(ByVal iCodigoTipoApontamento As Integer, _
        ...
        Try
            ...
            oSqlParameter(i).Value = sProntuarioFuncionario : i += 1 : ReDim Preserve oSqlParameter(i)
    ...
    Public Sub LoadDadosOrdemProducao(ByVal lCodigoOrdemProducao As Long, _
                                      ...
                                      ByRef bOperacaoExterna As Boolean, _
                                      ByRef sProjeto As String, _
                                      ByRef sSubProjeto As String, _
                                      ByRef iQuantidadeRejeito As Integer)
        ...
        Try
            ...
            While oSqlDataReader.Read
                ...
                sProjeto = oSqlDataReader.Item("projeto")
                sSubProjeto = oSqlDataReader.Item("sub_projeto")
                iQuantidadeRejeito = oSqlDataReader.Item("quantidade_rejeito")
    ...
    Public Sub ValidateDataAbertura(ByVal lCodigoOrdemProducao As Long, _
                                    ByVal dtpDataAbertura As CalendarCombo)
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_ordem_producao_apontamento", oSqlParameter)
    ...
    Public Sub LoadGridApontamentoLoteOF(ByVal oGrid As GridEX, _
                                  ByVal lCodigoOrdemProducao As Long)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_producao_ordem_producao_apontamento_lote_of", oSqlParameter)
    ...
    Public Sub UpdateApontamento(ByVal iCodigoTipoApontamento As Integer, _
                                 ...
                                 ByVal dDataTermino As DateTime, _
                                 ByVal sLocalizacao As String, _
                                 Optional ByVal dQuantidadeAberturaTotal As Double = 0, _
                                 Optional ByVal bNaoAplicavel As Boolean = False)
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iSequenciaConcorrente : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iCodigoApontamentoFuncionarioParada : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = IIf(iCodigoParceiroNegocio = -1, DBNull.Value, iCodigoParceiroNegocio) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = IIf(iCodigoMotivoParada = -1, DBNull.Value, iCodigoMotivoParada) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Value = IIf(dQuantidadeAbertura = -1, DBNull.Value, dQuantidadeAbertura) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = IIf(dQuantidadeAberturaTotal = 0, dQuantidadeAbertura, dQuantidadeAberturaTotal) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = IIf(dQuantidadeProduzida = -1, DBNull.Value, dQuantidadeProduzida) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = IIf(dQuantidadeRejeito = -1, DBNull.Value, dQuantidadeRejeito) : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = sLocalizacao : i += 1 : ReDim Preserve oSqlParameter(i)

            'Seta Parametros - Nao aplicavel
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "nao_aplicavel"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Bit
            oSqlParameter(i).Value = bNaoAplicavel

            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_producao_apontamento_issartel", oSqlParameter)
    ...
    Public Sub ExcluirApontamento(ByVal lCodigoOrdemProducao As Long, _
                               ByVal iSequencia As Integer, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_producao_apontamento_issartel", oSqlParameter)
...
#Region "::: APONTAMENTO - LOTE :::"

    Public Sub LoadGridApontamentoLote(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Seta Parametros - Código Operacao
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_operacao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoOperacao

            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_producao_ordem_producao_apontamento_lote", oSqlParameter)
