...
Public Class clsUsrPrdApontamentoDespesa
...
#Region "::: APONTAMENTO :::"
    ...
    Public Sub LoadDadosApontamento(ByVal iCodigoTipoApontamento As Integer, _
                                    ByVal lCodigoOrdemDespesa As Long, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_producao_apontamento_despesa_dados", oSqlParameter)
    ...
    Public Sub LoadDadosOrdemDespesa(ByVal lCodigoOrdemDespesa As Long, _
                                      ByVal iSequencia As Integer, _
                                      ByRef sOrdemDespesa As String, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_producao_ordem_despesa_apontamento_dados", oSqlParameter)

            While oSqlDataReader.Read

                sOrdemDespesa = oSqlDataReader.Item("ordem_despesa")
    ...
    Public Sub UpdateApontamento(ByVal iCodigoTipoApontamento As Integer, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_producao_apontamento_despesa", oSqlParameter)
    ...
    Public Sub ExcluirApontamento(ByVal lCodigoOrdemProducao As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_producao_apontamento_despesa", oSqlParameter)
