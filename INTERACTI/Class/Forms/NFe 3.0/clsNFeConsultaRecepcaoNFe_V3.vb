...
Imports INTERACTI.NFe.ConsultaRecepcaoNFe_V3
Imports INTERACTI.NFe.RetConsultaRecepcaoNFe_V3
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V3

Public Class clsNFeConsultaRecepcaoNFe_V3
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTConsReciNFe.versao = "3.10"
            oTConsReciNFe.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, ConsultaStatusServico_V3.TAmb.Item2, ConsultaStatusServico_V3.TAmb.Item1)
            ...
            sRetornoValidacao = ValidaArquivoXML(sPathArquivoEnvio, _
                                                 goConfiguracaoNFe.sPastaXSD & "consReciNFe_v3.10.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sArquivoRetornoXML = WSRetRecepcaoLote_V3(sPathArquivoEnvio)
