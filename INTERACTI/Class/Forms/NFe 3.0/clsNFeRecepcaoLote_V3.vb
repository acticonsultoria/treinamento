...
Imports INTERACTI.NFe.RetRecepcaoLote_V3
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V3

Public Class clsNFeRecepcaoLote_V3
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            Try
                ...
                sArquivoRetorno = WSRecepcaoLote_V3(sArquivoEnvio)
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        Try
            ...
            sDataRecibo = Now
            sRecibo = oTRetEnviNFe.infRec.nRec
            iTempoMedio = oTRetEnviNFe.infRec.tMed
