...
Imports INTERACTI.NFe.RecepcaoLote_V3
...
#Region "::: FUNCTION / SUB :::"
        ...
        Public Overloads Shared Function ArquivoNFe(ByVal lLote As Long, _
            ...
            Try
                ...
                sRetornoValidacao = ValidaArquivoXML(sArquivo, _
                                                     goConfiguracaoNFe.sPastaXSD & "nfe_v3.10.xsd")
            ...
            Catch ex As Exception
                oTNFe = Nothing
                sMensagemErro = ex.HelpLink + " - " + ex.Message
                Return False
            End Try
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        If Not IsDBNull(oSqlDataReader.Item("dSaiEnt")) Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        Select Case oSqlDataReader.Item("codigo_tipo_nota_fiscal")
                            ...
                            Case CInt(TipoNotaFiscal.NotaFiscal)
                                ...
                                oTNFeInfNFeIdeNFrefRefNF.cUF = DefineUF(oSqlDataReader.Item("cUF"))
                                oTNFeInfNFeIdeNFrefRefNF.mod = TNFeInfNFeIdeNFrefRefNFMod.Item01
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        If oSqlDataReader.Item("uf") <> "EX" Then
                            ...
                            If oSqlDataReader.Item("cnpj_cpf") <> "00000000000000" Then oTNFe.infNFe.dest.Item = oSqlDataReader.Item("cnpj_cpf")
                        Else
        ...
        Private Overloads Shared Sub NFe_GA_AutorizacaoXML(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                ex.HelpLink = "GA - AUTORIZAÇÃO XML"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_H_DetalhamentoProduto(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then
                    ex.HelpLink = "H - DETALHAMENTO PRODUTO"
                End If
        ...
        Private Overloads Shared Sub NFe_I_ProdutoServico(ByRef oTNFeItem As TNFeInfNFeDet, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        sProdutoServico = oTNFeItem.prod.cProd
                        ...
                        'CEST - Para substituição tributária
                        Call NFe_I05_ProdutoServicoCEST(oTNFeItem, _
                                                        lCodigoEmissaoCapa, _
                                                        lCodigoEmissaoItem)
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "I - PRODUTO SERVIÇO (" + sProdutoServico + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_I_ProdutoServicoDI(ByRef oTNFeItem As TNFeInfNFeDet, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        sProdutoDi = oTNFeItem.prod.cProd
                        ...
                        If Not IsDBNull(oSqlDataReader.Item("CNPJ")) Then oTNFeItem.prod.DI(iDI).CNPJ = oSqlDataReader.Item("CNPJ")
            ...
            Catch ex As Exception
                ex.HelpLink = "I - PRODUTO SERVIÇO DI(" + sProdutoDi + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_I_ProdutoServicoDIAdicao(ByRef oTNFeItemDI As TNFeInfNFeDetProdDI, _
                                                                  ByVal lCodigoEmissaoCapa As Long, _
                                                                  ByVal lCodigoEmissaoItem As Long)
            Dim sProdutoServicoDiAdicao As String
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        sProdutoServicoDiAdicao = oTNFeItemDI.dDI.ToString
                        ...
                        If Not IsDBNull(oSqlDataReader.Item("nDraw")) Then oTNFeItemDI.adi(iAdicao).nDraw = oSqlDataReader.Item("nDraw")
            ...
            Catch ex As Exception
                ex.HelpLink = "I - PRODUTO SERVIÇO DI ADIÇÃO(" + sProdutoServicoDiAdicao + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_I03_ProdutoServicoExporta(ByRef oTNFeItem As TNFeInfNFeDet, _
                                                            ByVal lCodigoEmissaoCapa As Long, _
                                                            ByVal lCodigoEmissaoItem As Long)
            Dim sProdutoServicoExporta As String
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        sProdutoServicoExporta = oTNFeItem.prod.cProd


                        'Seta Valores
                        If Not IsDBNull(oSqlDataReader.Item("nDraw")) Then oTNFeItem.prod.detExport(iExporta).nDraw = oSqlDataReader.Item("nDraw")



                        'Instncia
                        If Not IsDBNull(oSqlDataReader.Item("nRe")) Then

                            oTNFeItem.prod.detExport(iExporta).exportInd = New TNFeInfNFeDetProdDetExportExportInd
            ...
            Catch ex As Exception
                ex.HelpLink = "I03 - PRODUTO SERVIÇO EXPORTA(" + sProdutoServicoExporta + ")"
                Throw ex
            End Try

        End Sub

        Private Overloads Shared Sub NFe_I05_ProdutoServicoCEST(ByRef oTNFeItem As TNFeInfNFeDet, _
                                                            ByVal lCodigoEmissaoCapa As Long, _
                                                            ByVal lCodigoEmissaoItem As Long)
            Dim sProdutoServico As String
            Try
                ...
                'Executa Query
                oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_faturamento_emissao_xml_item_cest", oSqlParameter)
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        'Inserir caso haja
                        If Not IsDBNull(oSqlDataReader.Item("CEST")) Then
                            oTNFeItem.prod.CEST = oSqlDataReader.Item("CEST")
                        End If
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "I05 - PRODUTO SERVIÇO CEST (" + oTNFeItem.prod.cProd + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_M_Impostos(ByRef oTNFeItem As TNFeInfNFeDet, _
            ...
            Try
                ...
                sImposto = oTNFeItem.imposto.ToString
                ...
                If goEmitente.iRegimeTributario = CInt(RegimeTributario.LucroPresumido) Or _
                        goEmitente.iRegimeTributario = CInt(RegimeTributario.LucroReal) Then
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "M - IMPOSTOS(" + oTNFeItem.prod.cProd + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_N_ImpostosICMS(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    sImpostoICMS = oTNFeImposto.ICMS.Item
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "N - IMPOSTOS ICMS(" + sImpostoICMS + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_N_ImpostosICMSSimples(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
                                                               ByVal lCodigoEmissaoCapa As Long, _
                                                               ByVal lCodigoEmissaoItem As Long)
            Dim sImpostoICMSSimples As String
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    'Instancia Objeto
                    oTNFeImposto.ICMS = New TNFeInfNFeDetImpostoICMS()
                    sImpostoICMSSimples = oTNFeImposto.ICMS.Item
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "N - IMPOSTOS ICMS SIMPLES(" + sImpostoICMSSimples + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_O_ImpostosIPI(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        'Instancia Objeto
                        oTNFeImposto.IPI = New TIpi
                        sImpostoIPI = oTNFeImposto.IPI.Item
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "O - IMPOSTOS IPI(" + sImpostoIPI + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_P_ImpostosII(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        sImpostoII = oTNFeImposto.II.ToString
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "P - IMPOSTOS II(" + sImpostoII + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_Q_ImpostosPIS(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        ' sImpostoPis = oTNFeImposto.PIS.Item.ToString
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "Q - IMPOSTOS PIS(" + sImpostoPis + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_R_ImpostosPISST(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        If IsDBNull(oSqlDataReader.Item("codigo_tipo_calculo_imposto")) = False Then
                            ...
                            sImpostoPisSt = oTNFeImposto.PISST.ToString
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "R - IMPOSTOS PISST(" + sImpostoPisSt + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_S_ImpostosCOFINS(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        sImpostoCofins = oTNFeImposto.COFINS.ToString
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "S - IMPOSTOS COFINS(" + sImpostoCofins + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_T_ImpostosCOFINSSST(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
                                                             ByVal lCodigoEmissaoCapa As Long, _
                                                             ByVal lCodigoEmissaoItem As Long)
            Dim sImpostoConfinsSt As String
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        If IsDBNull(oSqlDataReader.Item("codigo_tipo_calculo_imposto")) = False Then
                            ...
                            sImpostoConfinsSt = oTNFeImposto.COFINSST.ToString
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "T - IMPOSTOS CONFINSSST(" + sImpostoConfinsSt + ")'"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_U_ImpostosISSQN(ByRef oTNFeImposto As TNFeInfNFeDetImposto, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        sImpostoIssqn = oTNFeImposto.ISSQN.ToString
            ...
            Catch ex As Exception
                ex.HelpLink = "U - IMPOSTOS ISSQN(" + sImpostoIssqn + ")"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_W_Total(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "W - TOTAL"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_X_Transporte(ByRef oTNFe As TNFe, _
            ...
            Try
                ...
                If oSqlDataReader.HasRows = True Then
                    ...
                    While oSqlDataReader.Read
                        ...
                        'Veículo 
                        If Not IsDBNull(oSqlDataReader.Item("placa")) Then
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "X - TRANSPORTE"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_X_TransporteReboque(ByRef oTNFeInfNFeTransp As TNFeInfNFeTransp, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "X - TRANSPORTE REBOQUE"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_X_TransporteVolume(ByRef oTNFeInfNFeTransp As TNFeInfNFeTransp, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "X - TRANSPORTE VOLUME"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_X_TransporteVolumeLacre(ByRef oTNFeInfNFeTranspVol As TNFeInfNFeTranspVol, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "X - TRANSPORTE VOLUME LACRE"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_Y_Cobranca(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "Y - COBRANÇA"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_Y_CobrancaDuplicata(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "Y - COBRANÇA DUPLICATA"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_Z_InformacoesAdicionais(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "Z - INFORMAÇÕES ADICIONAIS"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_ZA_InformacoesComercioExterior(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "ZA - INFORMAÇÕES COMERCIO EXTERIOR"
                Throw ex
            End Try
        ...
        Private Overloads Shared Sub NFe_ZB_InformacoesCompras(ByRef oTNFe As TNFe, _
            ...
            Catch ex As Exception
                If ex.HelpLink = "" Then ex.HelpLink = "ZB - INFORMAÇÕES COMPRAS"
                Throw ex
            End Try
                ...
                If (File.Exists(sArquivoXML)) Then
                    ...
                    Else
                        ...
                        sCabecalho = "<?xml version=""1.0"" encoding=""UTF-8""?>" & _
                                      "<enviNFe versao=""3.10"" xmlns=""http://www.portalfiscal.inf.br/nfe"">" & _
