...
#Region "::: PROPERTIE :::"
    Public WriteOnly Property DataEvento As Date
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTEventoInfEvento.dhEvento = Format(dDataEvento, "yyyy-MM-ddTHH:mm:ss") & IIf(goConfiguracaoNFe.bHorarioVerao = True, "-02:00", "-03:00")
            ...
            'ReDim oTEnvEvento.evento(0)
            'oTEnvEvento.evento(0) = New INTERACTI.NFe.EventoCancelamento.TEvento
            'oTEnvEvento.evento(0) = oTEvento
            'oTEnvEvento.idLote = "001"
            ...
            Else
                ...
                sXMLCancelamentoEnvio = oStreamReader.ReadToEnd
                oStreamReader.Close()
                ...
                sXMLCancelamentoRecepcao = sArquivoRetorno
