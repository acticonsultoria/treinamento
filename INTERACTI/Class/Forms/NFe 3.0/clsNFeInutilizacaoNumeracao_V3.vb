...
Imports INTERACTI.NFe.InutilizacaoNFe_V3
Imports INTERACTI.NFe.RetInutilizacaoNFe_V3
Imports INTERACTI.NFe.AssinaturaDigital_V3
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V3

Public Class clsNFeInutilizacaoNumeracao_V3
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTInutNFeInfInut.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, InutilizacaoNFe_V3.TAmb.Item2, InutilizacaoNFe_V3.TAmb.Item1)
            oTInutNFeInfInut.xServ = TInutNFeInfInutXServ.INUTILIZAR
            oTInutNFeInfInut.cUF = DefineEnum(goEmitente.iUF, GetType(InutilizacaoNFe_V3.TCodUfIBGE))
            oTInutNFeInfInut.ano = Mid(iAno, 3, 2)
            oTInutNFeInfInut.CNPJ = goEmitente.sCNPJ.Replace(".", "").Replace("/", "").Replace("-", "")
            oTInutNFeInfInut.mod = DefineEnum(iModelo, GetType(InutilizacaoNFe_V3.TMod))
            ...
            sRetornoValidacao = ValidaArquivoXML(goConfiguracaoNFe.sPastaEnvio & sID & "-ped-inutilizacao-ass.xml", _
                                                 goConfiguracaoNFe.sPastaXSD & "inutNFe_v3.10.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sRetornoWS = WSInutilizacaoNumeracaoNFe_V3(sArquivoEnvio)
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        Try
            ...
            iCodigoTipoAmbiente = IIf(oTRetInutNFeInfInut.tpAmb = RetInutilizacaoNFe_V3.TAmb.Item1, TipoAmbienteNFe.producao, TipoAmbienteNFe.homologacao)
