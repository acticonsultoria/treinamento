...
Public Class clsUsrNFeLogInutilizacao
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
                        ...
                        ByVal iModelo As Integer, _
                        ByVal iSerie As Integer, _
                        ByVal lNotaFiscalInicial As Long, _
                        ByVal lNotaFiscalTermino As Long, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_nfe_log_inutilizacao", oSqlParameter)
            ...
            With oGrid
                ...
                .RootTable.Columns.Item("ano").DataMember = "ano"
                .RootTable.Columns.Item("cnpj").DataMember = "cnpj"
                .RootTable.Columns.Item("modelo_nf").DataMember = "codigo_modelo_nota_fiscal"
                .RootTable.Columns.Item("serie").DataMember = "serie"
                .RootTable.Columns.Item("nf_inicial").DataMember = "nota_fiscal_inicial"
                .RootTable.Columns.Item("nf_final").DataMember = "nota_fiscal_final"
