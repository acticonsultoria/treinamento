...
Namespace NFe.RetRecepcaoLote_V3
    ...
    Partial Public Class TRetEnviNFe
        Public Shared Function Load(ByVal sFileName As String) As TRetEnviNFe

            Dim oFileStream As FileStream
            Dim oReturn As TRetEnviNFe

            Try

                oFileStream = OpenRead(sFileName)
                Dim oXmlSerializer As New XmlSerializer(GetType(TRetEnviNFe))
