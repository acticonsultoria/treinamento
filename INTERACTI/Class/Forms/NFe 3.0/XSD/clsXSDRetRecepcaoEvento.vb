...
Namespace NFe
    ...
    Public NotInheritable Class RetRecepcaoEvento
        '
        ...
        Partial Public Class TEvento
            Public Shared Function Load(ByVal sFileName As String) As TEvento

                Dim oFileStream As FileStream
                Dim oReturn As TEvento
        ...
        Partial Public Class TEventoInfEvento
            ...
            Private verEventoField As TEventoInfEventoVerEvento
            ...
            '''<remarks/>
            Public Property verEvento() As TEventoInfEventoVerEvento
                Get
                    Return Me.verEventoField
                End Get
                Set(ByVal value As TEventoInfEventoVerEvento)
        ...
        Partial Public Class TEventoInfEventoDetEvento
            ...
            Private xCondUsoField As TEventoInfEventoDetEventoXCondUso
            ...
            '''<remarks/>
            Public Property xCondUso() As TEventoInfEventoDetEventoXCondUso
                Get
                    Return Me.xCondUsoField
                End Get
                Set(ByVal value As TEventoInfEventoDetEventoXCondUso)
        ...
        Public Enum TEventoInfEventoDetEventoXCondUso
            ...
            '''<remarks/>
            <System.Xml.Serialization.XmlEnumAttribute("A Carta de Correção é disciplinada pelo § 1º-A do art. 7º do Convênio S/N, de 15 " & _
                "de dezembro de 1970 e pode ser utilizada para regularização de erro ocorrido na " & _
                "emissão de documento fiscal, desde que o erro não esteja relacionado com: I - as" & _
                " variáveis que determinam o valor do imposto tais como: base de cálculo, alíquot" & _
                "a, diferença de preço, quantidade, valor da operação ou da prestação; II - a cor" & _
                "reção de dados cadastrais que implique mudança do remetente ou do destinatário; " & _
                "III - a data de emissão ou de saída.")> _
            ...
            '''<remarks/>
            <System.Xml.Serialization.XmlEnumAttribute("A Carta de Correcao e disciplinada pelo paragrafo 1o-A do art. 7o do Convenio S/N" & _
                ", de 15 de dezembro de 1970 e pode ser utilizada para regularizacao de erro ocor" & _
                "rido na emissao de documento fiscal, desde que o erro nao esteja relacionado com" & _
                ": I - as variaveis que determinam o valor do imposto tais como: base de calculo," & _
                " aliquota, diferenca de preco, quantidade, valor da operacao ou da prestacao; II" & _
                " - a correcao de dados cadastrais que implique mudanca do remetente ou do destin" & _
                "atario; III - a data de emissao ou de saida.")> _
        ...
        Partial Public Class TRetEnvEvento
            Public Shared Function Load(ByVal sFileName As String) As TRetEnvEvento

                Dim oFileStream As FileStream
                Dim oReturn As TRetEnvEvento

                Try

                    oFileStream = OpenRead(sFileName)
                    Dim oXmlSerializer As New XmlSerializer(GetType(TRetEnvEvento))
                    oReturn = oXmlSerializer.Deserialize(oFileStream)
