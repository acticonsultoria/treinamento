...
Namespace NFe.EventoCancelamento
    '
    ...
    Partial Public Class TEnvEvento
        Public Sub Save(ByVal sFileName As String)
            ...
            Try
                ...
                Dim oXmlSerializer As New XmlSerializer(GetType(TEnvEvento))
    ...
    Public Enum TEventoInfEventoTpEvento
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlEnumAttribute("110111")> _
        Item110111
    End Enum
    ...
    Partial Public Class detEvento
        ...
        Public Property descEvento() As detEventoDescEvento
            Get
                Return Me.descEventoField
            End Get
            Set(ByVal value As detEventoDescEvento)
                Me.descEventoField = Value
            End Set
        End Property
        ...
        Public Property versao() As detEventoVersao
            Get
                Return Me.versaoField
            End Get
            Set(ByVal value As detEventoVersao)
                Me.versaoField = Value
            End Set
        End Property
    End Class
