            ...
            Try
                ...
                If oCollection2.Count > 0 Then
                    For i = 0 To oCollection2.Count - 1
                        If oCollection2(i).Subject.ToString = goConfiguracaoNFe.sCertificado AndAlso _
                           IsNothing(oCollection2(i).NotAfter) = False AndAlso _
                           DateDiff(DateInterval.Day, Now.Date, oCollection2(i).NotAfter) > 0 Then
                            Return oCollection2(i).Subject.ToString()
                        End If
                    Next
                    Return ""
                Else
