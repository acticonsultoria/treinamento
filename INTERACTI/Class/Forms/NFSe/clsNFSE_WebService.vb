...
Imports System.Net
Imports INTERACTI.NFSE.CertificadoDigital
...
#Region "::: FUNCION HOMOLOGAÇÃO :::"
        ...
        Public Overloads Shared Function WS_EnvioLoteNFSeHomologacao(ByVal sMensagem As String) As String
            ...
            Try
                ...
                Dim oCabecalho As New NFSE.GERAL.cabecalho
                oCabecalho.versao = "3"
...
#Region "::: FUNCION PRODUÇÃO :::"
        ...
        Public Overloads Shared Function WS_EnvioLoteNFSeProducao(ByVal sMensagem As String) As String
            ...
            Try
                ...
                'Váriaveis Locais
                Dim oServiceGinfesImplService As New br.gov.sp.sjc.notajoseense.NotaFiscalSoap
                'Dim oServiceGinfesImplService As New br.com.ginfes.sjcproducao.ServiceGinfesImplService
                Dim sCabecalho As String = ""
                ...
                'sDadosNFSe = Replace(sDadosNFSe, "<Aliquota>2.00<", "<Aliquota>2<")
        ...
        Public Overloads Shared Function WS_ConsultaLoteNFSeProducao(ByVal sMensagem As String) As String
            ...
            Try
                ...
                sDadosNFSe = Replace(sDadosNFSe, " xmlns=""http://www.ginfes.com.br/servico_consultar_lote_rps_envio_v03.xsd""", " xmlns=""http:/www.abrasf.org.br/nfse.xsd""")
                sDadosNFSe = Replace(sDadosNFSe, " xmlns=""http://www.ginfes.com.br/tipos_v03.xsd""", "")
        ...
        Public Overloads Shared Function WS_ConsultaSituacaoLoteRPSProducao(ByVal sMensagem As String) As String
            ...
            Try
                ...
                sDadosNFSe = Replace(sDadosNFSe, " xmlns=""http://www.ginfes.com.br/servico_consultar_situacao_lote_rps_envio_v03.xsd""", " xmlns=""http:/www.abrasf.org.br/nfse.xsd""")
                sDadosNFSe = Replace(sDadosNFSe, " xmlns=""http://www.ginfes.com.br/tipos_v03.xsd""", "")
