        ...
        Public Overloads Shared Function ValidaArquivoXML(ByVal sArquivoXML As String, _
            ...
            Else
                ...
                Try
                    ...
                    If sNomeXSD.Contains("nfse.xsd") Then
                        oXmlReaderSettings.Schemas.Add("http:/www.abrasf.org.br/nfse.xsd", XmlReader.Create(sArquivoXSD))

                    Else
                        oXmlReaderSettings.Schemas.Add("http://www.ginfes.com.br/" & sNomeXSD, XmlReader.Create(sArquivoXSD))
                        oXmlReaderSettings.Schemas.Add("http://www.ginfes.com.br/tipos_v03.xsd", XmlReader.Create(goConfiguracaoNFSe.sPastaXSD & "tipos_v03.xsd"))
