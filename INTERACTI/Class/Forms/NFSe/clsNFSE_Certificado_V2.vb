            ...
            Try
                ...
                If oCollection.Count > 0 Then
                    For i = 0 To oCollection.Count - 1
                        If oCollection(i).Subject.ToString = goConfiguracaoNFe.sCertificado Then
                            Return oCollection(i).Subject.ToString()
                        End If
                    Next
                    Return ""
                Else
            ...
            Try
                ...
                If sCertificado = "" Then
                    ...
                    If (sCollection.Count = 0) Then
                        ...
                        frmMain.Informacao("Certificado Digital", Color.Red)
                    Else
                        'Seta Certificado
                ...
                Else
                    ...
                    If (sCollection.Count = 0) Then
                        ...
                        frmMain.Informacao("Certificado Digital: " & sCertificado, Color.Red)
                        'Reseta Certificado
                        oX509Cert.Reset()
                    Else
                        'Seta Certificado
