...
Public Class clsNFSE_ConsultaNFSe
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Dim oTConsSitNFSe As New ConsultarNfseEnvio

        Try

            oTConsSitNFSe.Prestador = New NFSE.GERAL.tcIdentificacaoPrestador
            'Informação do prestador

            oTConsSitNFSe.Prestador.Cnpj = Replace(Replace(Replace(goEmitente.sCNPJ, ".", ""), "-", ""), "/", "")
