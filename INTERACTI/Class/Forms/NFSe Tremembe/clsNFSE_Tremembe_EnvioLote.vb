Imports System.IO
Imports System.Xml
Imports INTERACTI.NFSE_Tremembe.DadosServico.clsNFSE_DadosServico
Imports INTERACTI.NFSE_Tremembe.EnvioLoteRPS
Imports INTERACTI.NFSE_tremembe.RetEnvioLoteRPS
Imports INTERACTI.NFSE_Tremembe.ValidaXML
Imports INTERACTI.NFSE_Tremembe.WebService

Public Class clsNFSE_Tremembe_EnvioLote
    ...
    '            sArquivoRetorno = goConfiguracaoNFSe.sPastaRecibo & IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, "H", "P") & Format(lLote, "000000") & "-rec.xml"
    ...
    '                sProtocolo = ""
    '            Else
    '                sProtocolo = oTRetEnvioNFSe.Protocolo
