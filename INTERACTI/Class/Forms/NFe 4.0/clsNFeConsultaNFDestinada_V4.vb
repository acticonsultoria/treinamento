...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send(ByVal sUltimoNSU As String) As Boolean
        ...
        Try
            ...
            'Parâmetros0
            oTConsSitNFe.versao = ConsultaNFDest_V4.TVeConsNFeDest.Item101
    ...
    Public Function LoadArquivo() As Boolean
        ...
        Dim oClsUsrIntNFeDestinada As New clsUsrIntNFeDestinada
        Try
                ...
                For Each oRet In oTRetConsultaNFDest.ret
                    ...
                    If Not oRet.ResNFe Is Nothing Then
                        ...
                        With oRet.resNFe
                            ...
                            'Inserindo os dados
                            oClsUsrIntNFeDestinada.InsertNFeAutorizada(.NSU, _
                                                                       .chNFe, _
                                                                       .Item, _
                                                                       .xNome, _
                                                                       .IE, _
                    ...
                    If Not oRet.resCanc Is Nothing Then
                        ...
                        With oRet.resCanc
                            ...
                            'Inserindo os dados
                            oClsUsrIntNFeDestinada.InsertNFeCancelada(.NSU, _
                                                                       .chNFe, _
                                                                       .Item, _
                                                                       .xNome, _
                                                                       .IE, _
                    ...
                    If Not oRet.resCCe Is Nothing Then
                        ...
                        With oRet.resCCe
                            ...
                            'Inserindo os dados
                            oClsUsrIntNFeDestinada.InsertNFeCCe(.NSU, _
                                                                       .chNFe, _
                                                                        .dhEvento, _
                                                                       .tpEvento, _
                                                                       .descEvento, _
