...
Public Class clsNFeManifestacaoDestinatario_V4
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function LoadArquivo() As Boolean
        ...
        Try
            ...
            If oTRetEnvEvento.cStat = "128" Then
                ...
                ElseIf oTRetEnvEvento.retEvento(0).infEvento.xMotivo.ToUpper.Contains("DUPLICIDADE") Then
    ...
    Public Sub InsertManifestacao(ByVal sChaveAcesso As String, _
        ...
        Try
            ...
            'Executa Quety
            SQLHelper.ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_integracao_manifestacao", oSqlParameter)
    ...
    Public Function SendOperacaoNaoRealizada(ByVal sChaveAcesso As String, ByVal sSequencia As String, ByVal lLote As Long) As Boolean
        ...
        Try
            ...
            Dim oTInfEvento As New ManifestacaoDestinatario.TEventoInfEvento
            oTEvento.versao = "1.00"
            oTInfEvento.Id = "ID" + "210240" + sChaveAcesso + "0" + sSequencia '210240 - Operação Não realizada
            oTInfEvento.cOrgao = ManifestacaoDestinatario.TCOrgaoIBGE.Item91 'SVAN
            oTInfEvento.tpAmb = ManifestacaoDestinatario.TAmb.Item1 'Produção
            oTInfEvento.ItemElementName = ManifestacaoDestinatario.ItemChoiceType.CNPJ
            oTInfEvento.Item = Replace(Replace(Replace(goEmitente.sCNPJ, ".", ""), "/", ""), "-", "")
            ...
            Dim oTInfEventoDetEvento As New INTERACTI.NFe.ManifestacaoDestinatario.TEventoInfEventoDetEvento
            oTInfEventoDetEvento.descEvento = ManifestacaoDestinatario.TEventoInfEventoDetEventoDescEvento.OperacaonaoRealizada  'TEMP
            oTInfEventoDetEvento.versao = ManifestacaoDestinatario.TEventoInfEventoDetEventoVersao.Item100
    ...
    Public Function LoadArquivoOperacaoNaoRealizada() As Boolean
