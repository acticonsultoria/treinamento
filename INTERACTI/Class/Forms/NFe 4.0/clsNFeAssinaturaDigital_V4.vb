...
Namespace NFe
    ...
    Public NotInheritable Class AssinaturaDigital_V4
...
#Region "::: FUNCTION / SUB :::"
        ...
        Public Overloads Shared Function AssinarXML(ByVal sArquivoXML As String, _
            ...
            Try
                ...
                sXMLDocument = oStreamReader.ReadToEnd.Replace("xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance""", "").Replace("xmlns:xsd=""http://www.w3.org/2001/XMLSchema""", "").Replace("xmlns:ds=""http://www.w3.org/2000/09/xmldsig#""", "").Replace("xsi:schemaLocation=""http://www.portalfiscal.inf.br/nfe enviNFe_v4.00.xsd""", "")
