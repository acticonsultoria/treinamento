...
Imports INTERACTI.NFe.ConsultaStatusServico_V4
Imports INTERACTI.NFe.RetConsultaStatusServico_V4
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V4


Public Class clsNFeStatusServico_V4
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTConsStatServ.versao = "4.00"
            oTConsStatServ.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, ConsultaStatusServico_V4.TAmb.Item2, ConsultaStatusServico_V4.TAmb.Item1)
            oTConsStatServ.cUF = DefineEnum(goConfiguracaoNFe.sCodigoEstado, GetType(ConsultaStatusServico_V4.TCodUfIBGE))
            oTConsStatServ.xServ = TConsStatServXServ.STATUS
            ...
            sRetornoValidacao = ValidaArquivoXML(sArquivoEnvio, _
                                                 goConfiguracaoNFe.sPastaXSD & "consStatServ_v4.00.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sRetornoWS = WSStatusServico_V4(sArquivoEnvio)
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        Try
            ...
            iCodigoTipoAmbiente = IIf(oTRetConsStatServ.tpAmb = ConsultaStatusServico_V4.TAmb.Item1, TipoAmbienteNFe.producao, TipoAmbienteNFe.homologacao)
