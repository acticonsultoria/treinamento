...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTConsSitNFe.versao = ConsultaSituacaoNF_V4.TVerConsSitNFe.Item400
            oTConsSitNFe.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, ConsultaStatusServico_V4.TAmb.Item2, ConsultaStatusServico_V4.TAmb.Item1)
            oTConsSitNFe.chNFe = sChaveAcesso
            oTConsSitNFe.xServ = TConsSitNFeXServ.CONSULTAR
            ...
            sRetornoValidacao = ValidaArquivoXML(sPathArquivoEnvio, _
                                                 goConfiguracaoNFe.sPastaXSD & "consSitNFe_v4.00.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sXMLRetorno = WSConsultaSituacaoNF_V4(sPathArquivoEnvio)
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        Try
            ...
            Else
                ...
                sUF = "SP"
                sAmbiente = IIf(oTRetConsSitNFe.protNFe.infProt.tpAmb = RetConsultaSituacaoNFe_V4.TAmb.Item1, "PRODUÇÃO", "HOMOLOGAÇÃO")
            End If
