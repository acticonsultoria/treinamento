...
Imports INTERACTI.NFe.InutilizacaoNFe_V4
Imports INTERACTI.NFe.RetInutilizacaoNFe_V4
Imports INTERACTI.NFe.AssinaturaDigital_V4
Imports INTERACTI.NFe.ValidaXML
Imports INTERACTI.NFe.WebService_V4

Public Class clsNFeInutilizacaoNumeracao_V4
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTInutNFeInfInut.tpAmb = IIf(goConfiguracaoNFe.iCodigoTipoAmbienteNFe = TipoAmbienteNFe.homologacao, InutilizacaoNFe_V4.TAmb.Item2, InutilizacaoNFe_V4.TAmb.Item1)
            oTInutNFeInfInut.xServ = TInutNFeInfInutXServ.INUTILIZAR
            oTInutNFeInfInut.cUF = DefineEnum(goEmitente.iUF, GetType(InutilizacaoNFe_V4.TCodUfIBGE))
            oTInutNFeInfInut.ano = Mid(iAno, 3, 2)
            oTInutNFeInfInut.CNPJ = goEmitente.sCNPJ.Replace(".", "").Replace("/", "").Replace("-", "")
            oTInutNFeInfInut.mod = DefineEnum(iModelo, GetType(InutilizacaoNFe_V4.TMod))
            ...
            sRetornoValidacao = ValidaArquivoXML(goConfiguracaoNFe.sPastaEnvio & sID & "-ped-inutilizacao-ass.xml", _
                                                 goConfiguracaoNFe.sPastaXSD & "inutNFe_v4.00.xsd")
            ...
            Else
                ...
                Try
                    ...
                    sRetornoWS = WSInutilizacaoNumeracaoNFe_V4(sArquivoEnvio)
    ...
    Public Sub LoadArquivo(ByVal sArquivo As String)
        ...
        Try
            ...
            iCodigoTipoAmbiente = IIf(oTRetInutNFeInfInut.tpAmb = RetInutilizacaoNFe_V4.TAmb.Item1, TipoAmbienteNFe.producao, TipoAmbienteNFe.homologacao)
