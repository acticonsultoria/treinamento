...
Namespace MDFe.EventoCancelamento_V3
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1"), _
     ...
     System.Xml.Serialization.XmlRootAttribute("eventoMDFe", [Namespace]:="http://www.portalfiscal.inf.br/mdfe", IsNullable:=False)> _
    ...
    Partial Public Class evCancMDFe
        Public Sub Save(ByVal sFileName As String)
            ...
            Try
                ...
                oStreamWriter = CreateText(sFileName)
                Dim oXmlSerializer As New XmlSerializer(GetType(evCancMDFe))
                oXmlSerializer.Serialize(oStreamWriter, Me)
        ...
        End Sub
        Private descEventoField As evCancMDFeDescEvento
        ...
        '''<remarks/>
        Public Property descEvento() As evCancMDFeDescEvento
            Get
                Return Me.descEventoField
            End Get
            Set(value As evCancMDFeDescEvento)
