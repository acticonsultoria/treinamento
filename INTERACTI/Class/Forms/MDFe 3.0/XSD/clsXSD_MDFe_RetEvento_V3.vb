...
Namespace MDFe.RetEvento_V3
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1"), _
     ...
     System.Xml.Serialization.XmlRootAttribute("retEventoMDFe", [Namespace]:="http://www.portalfiscal.inf.br/mdfe", IsNullable:=False)> _
    Partial Public Class TRetEvento

        Public Shared Function Load(ByVal sFileName As String) As TRetEvento

            Dim oFileStream As FileStream
            Dim oReturn As TRetEvento

            Try

                oFileStream = OpenRead(sFileName)
                Dim oXmlSerializer As New XmlSerializer(GetType(TRetEvento))
