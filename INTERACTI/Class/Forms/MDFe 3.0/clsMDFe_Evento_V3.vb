...
Public Class clsMDFe_Evento_V3
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Function Send() As Boolean
        ...
        Try
            ...
            oTEventoInfEvento.dhEvento = Format(dDataEmissao, "yyyy-MM-ddTHH:mm:ss")
            oTEventoInfEvento.nSeqEvento = CInt(sSequencia)
            oTEventoInfEventoDetEvento.versaoEvento = "1.00"
            ...
            sRetornoValidacao = ValidaArquivoXML(sArquivo, _
                                                 goConfiguracaoMDFe.sPastaXSD & "evCancMDFe_v1.00.xsd",
            ...
            sRetornoValidacao = ValidaArquivoXML(goConfiguracaoMDFe.sPastaEnvio & sID & "-ped-cancelamento-ass.xml", _
                                                 goConfiguracaoMDFe.sPastaXSD & "eventoMDFe_v1.00.xsd", _
