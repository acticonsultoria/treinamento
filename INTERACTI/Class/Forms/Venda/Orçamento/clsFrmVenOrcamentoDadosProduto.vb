...
Public Class clsFrmVenOrcamentoDadosProduto
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGridCompra(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_dados_compra_item", oSqlParameter)
    ...
    Public Sub LoadGridVenda(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_dados_venda_item", oSqlParameter)
