...
Public Class clsUsrVenOrcamento

#Region "::: VARIAVEIS :::"

    'Variaveis da Classe
    Private iModalidade As Integer
    ...
    Private sObrigacoesContratante As String
    Private sObrigacoesContratada As String
...
#Region "::: PROPERTIE :::"
    ...
    Public Property ObrigacoesContratante() As String
        Get
            Return sObrigacoesContratante
        End Get
        Set(ByVal value As String)
            sObrigacoesContratante = value
        End Set
    End Property

    Public Property ObrigacoesContratada() As String
        Get
            Return sObrigacoesContratada
        End Get
        Set(ByVal value As String)
            sObrigacoesContratada = value
        End Set
    End Property
...
#Region "::: ORCAMENTO:::"
    ...
    Public Sub InsertPedidoVendaItem(ByVal lCodigoOrcamento As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_venda_orcamento_pedido_venda_item", oSqlParameter)
    ...
    Public Sub LoadGridGerarPedido(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_gerar_pedido", oSqlParameter)
    ...
    Public Sub EnviarEmail(ByVal lCodigoOrcamento As Long, _
        ...
        Try
            ...
            'Seta Parametros - Codigo Orçamento
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_orcamento"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.BigInt
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_email_venda_orcamento", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "modalidade"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iModalidade : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "data_prazo_resposta"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.DateTime
            oSqlParameter(i).Value = sPrazoResposta : i += 1
    ...
    Public Sub LoadControlesOrcamento(ByVal lCodigo As Long, _
                                      ...
                                      ByVal dtpPrazoResposta As CalendarCombo, _
                                      ByVal cboModalidade As UIComboBox)
        ...
        Try
            ...
            If oSqlDataReader.HasRows Then
                ...
                While oSqlDataReader.Read
                    ...
                    If IsDBNull(oSqlDataReader.Item("modalidade")) = False Then
                        cboModalidade.SelectedValue = oSqlDataReader.Item("modalidade")
                    Else
                        cboModalidade.SelectedIndex = -1
                    End If

                    dtpPrazoResposta.Value = oSqlDataReader.Item("data_prazo_resposta")
                    ...
                    If IsDBNull(oSqlDataReader.Item("status")) = False Then
    ...
    Public Sub LoadControlesOrcamento(ByVal lCodigo As Long, _
                                      ...
                                      ByVal txtObservacaoCirurgia As EditBox)
    ...
    Public Sub UpdatePrazoResposta(ByVal lCodigoOrcamento As Long, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Date
            oSqlParameter(i).Value = IIf(sDataPrazoResposta = "", DBNull.Value, sDataPrazoResposta) : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_venda_orcamento_prazo_resposta", oSqlParameter)
    ...
    Public Sub UpdateHoraOrcamento(ByVal lCodigoOrcamento As Long, _
                                   ByVal dHoraOrcamento As Double)
        ...
        Try
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "hora_orcamento"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dHoraOrcamento : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_venda_orcamento_hora_orcamento", oSqlParameter)
    ...
    Public Sub UpdateHoraAprovacao(ByVal lCodigoOrcamento As Long, _
                                   ByVal dHoraAprovacao As Double)
        ...
        Try
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "hora_aprovacao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dHoraAprovacao : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_venda_orcamento_hora_aprovacao", oSqlParameter)
    ...
    Public Sub LoadDadosHoras(ByVal lCodigoOrcamento As Long, _
                              ByVal txtNumeroOrcamento As MaskedEditBox, _
                              ByVal txtDataOrcamento As MaskedEditBox, _
                              ByVal txtCliente As MaskedEditBox)
    ...
    Public Sub LoadGridHoras(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_horas", oSqlParameter)
    ...
    Public Sub UpdateHoras(ByVal lCodigoOrcamento As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_venda_orcamento_horas", oSqlParameter)
    ...
    Public Sub InsertHoras(ByVal lCodigoOrcamento As Long, _
                           ByVal sData As String, _
                           ByVal dQuantidadeHoras As Double, _
                           ByVal sObservacao As String)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_venda_orcamento_horas", oSqlParameter)
    ...
    Public Sub DeleteHoras(ByVal lCodigo As Long)
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_venda_orcamento_horas", oSqlParameter)
...
#Region "::: PRODUTO :::"
    ...
    Public Sub InsertProduto(ByVal sCodigoProduto As String, _
    ...
    Public Sub UpdateProduto(ByVal sCodigoProduto As String, _
                             ByVal sDescricao As String, _
                             ByVal sComplemento As String, _
                             ByVal iCodigoDestinacao As Integer, _
                             ByVal dPrecoVenda As Double, _
        ...
        'Variaveis Locais
        Dim oSqlParameter(39) As SqlParameter
        Dim i As Integer = 0
    ...
    Public Sub EditarProduto(ByVal iCodigoOrcamentoItem As Integer, _
                             ...
                             ByVal txtValorUnitarioProduto As NumericEditBox, _
                             ...
                             ByVal txtValorICMSST As NumericEditBox, _
        ...
        Try
            ...
            If oSqlDataReader.HasRows Then
                ...
                While oSqlDataReader.Read
                    ...
                    'Carrega Váriavel
                    cboProduto.Text = oSqlDataReader.Item("codigo_produto")
                    ...
                    txtValorUnitarioProduto.Value = oSqlDataReader.Item("valor_unitario")
                    ...
                    txtValorICMSST.Value = oSqlDataReader.Item("valor_icms_st")
    ...
    Public Sub LoadDadosEntrega(ByVal lCodigoOrcamento As Long, _
                                ByVal iCodigoOrcamentoItem As Integer, _
        ...
        Try
            ...
            'Seta Parametros - Código Orçamentp
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_orcamento"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.BigInt
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_item_entrega_editar", oSqlParameter)
            ...
            While oSqlDataReader.Read
                ...
                oPrevisaoEntrega.sNotaFiscal = oSqlDataReader.Item("numero_pedido")
    ...
    Public Sub UpdateDestinacao(ByVal lCodigoOrcamento As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_venda_orcamento_item_destinacao", oSqlParameter)
    ...
    Public Sub UpdatePrazoEntrega(ByVal lCodigoOrcamento As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_venda_orcamento_item_prazo_entrega", oSqlParameter)
...
#Region "::: SERVIÇO :::"
    ...
    Public Sub InsertServico(ByVal sCodigoProduto As String, _
                             ByVal sDescricao As String, _
                             ByVal sComplemento As String, _
                             ByVal dQuantidade As Double, _
                             ByVal iCodigoUnidadeMedida As Integer, _
    ...
    Public Sub UpdateServico(ByVal sCodigoProduto As String, _
                             ByVal sDescricao As String, _
                             ByVal sComplemento As String, _
                             ByVal dQuantidade As Double, _
                             ByVal iCodigoUnidadeMedida As Integer, _
    ...
    Public Sub EditarServico(ByVal iCodigoOrcamentoItem As Integer, _
                             ...
                             ByVal txtTerceirosOmServico As MaskedEditBox, _
                             ByVal txtTerceirosEspecificadorServico As MaskedEditBox)
        ...
        Try
            ...
            If oSqlDataReader.HasRows Then
                ...
                While oSqlDataReader.Read
                    ...
                    'Carrega Váriavel
                    cboServico.Text = oSqlDataReader.Item("codigo_produto")
                    ...
                    txtTerceirosRcServico.Text = oSqlDataReader.Item("rc")
                    txtTerceirosOmServico.Text = oSqlDataReader.Item("om")
    ...
    Public Sub LoadDadosServico(ByVal lCodigoServico As Long, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_dados_item", oSqlParameter)
...
#Region "::: ORÇAMENTO - IMPORTAR EXCEL"

    Public Sub InsertItemExcelTemp(ByVal iCodigoIntegracao As Integer, _
                                   ByVal sTipoVenda As String, _
                                   ByVal dQuantidade As Double, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = sTipoVenda : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_venda_orcamento_importacao_excel_temp", oSqlParameter)
    ...
    Public Sub InsertItemExcel(ByVal iCodigoOrcamento As Integer, ByVal iCodigoCliente As Integer, _
                               ByVal bComNF As Boolean, ByVal dDataEntrega As Date)
        ...
        Try
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "com_nf"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Bit
            oSqlParameter(i).Value = bComNF : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_venda_orcamento_importacao_excel", oSqlParameter)
    ...
    Public Sub LoadGridProdutoExcel(ByVal oGrid As GridEX)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_item_temp", oSqlParameter)
