...
Public Class clsUsrVenOrcamentoRapido
...
#Region "::: ORCAMENTO:::"
    ...
    Public Sub LoadGridServicoRapido(ByVal oGrid As GridEX)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_orcamento_rapido_valor_servico", oSqlParameter)
...
#Region "::: ISSARTEL :::"
    ...
    Public Sub LoadControlesOrcamentoIssartel(ByVal lCodigo As Long, _
                                 ...
                                 ByVal txtFatorCambialEuro As NumericEditBox)
    ...
    Public Sub LoadDadosMPIssartel(ByVal lCodigo As Long, _
                                   ByVal txtValorKilo As NumericEditBox)
    ...
    Public Sub EditarProdutoIssartel(ByVal iCodigoOrcamentoItem As Integer, _
                               ...
                               ByVal txtProjeto As MaskedEditBox, _
                               ByVal txtSubProjeto As MaskedEditBox)
        ...
        Try
            ...
            If oSqlDataReader.HasRows Then
                ...
                While oSqlDataReader.Read
                    ...
                    txtProjeto.Text = oSqlDataReader.Item("projeto")
                    txtSubProjeto.Text = oSqlDataReader.Item("sub_projeto")
    ...
    Public Sub InsertOperacaoIssartel(ByVal lCodigoOrcamento As Long, _
                        ...
                        ByVal dTZ As Double, _
                        ByVal dTP As Double, _
                        ByVal dValorTotal As Double, _
                        ByVal dValorHoraTZ As Double, _
                        ByVal dValorHoraTP As Double)
        ...
        Try
            ...
            'Seta Parametros - Preço Mínimo
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "tz"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dTZ : i += 1

            'Seta Parametros - Custo Teórico
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "tp"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dTP : i += 1
