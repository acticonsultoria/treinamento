...
Public Class clsFrmVenPedidoOrcamento
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGridOrcamento(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_venda_orcamento_cliente", oSqlParameter)
    ...
    Public Sub InsertPedido(ByVal lCodigoOrcamento As Long)
    ...
    Public Sub UpdatePedido(ByRef lCodigoPedido As Long)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_venda_pedido_orcamento", oSqlParameter)
    ...
    Public Sub InsertPedidoItem(ByVal lCodigoPedido As Long, _
                                ByVal lCodigoOrcamento As Long, _
                                ByVal iCodigOrcamentoItem As Integer, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iCodigOrcamentoItem : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_venda_pedido_item_orcamento", oSqlParameter)
