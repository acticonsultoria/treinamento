...
Public Class clsUsrIndFinanceiro
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGridSintetico As GridEX, _
                        ...
                        ByVal iCodigoBudget As Integer, _
                        ByVal iCodigoTipoGrafico As Integer, _
                        ByVal iMeta As Integer, _
                        ByVal iCodigoClassificationBudget As Integer, _
        ...
        Try
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_forecast"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoBudget : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_classification_budget"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = IIf(iCodigoClassificationBudget = -1, DBNull.Value, iCodigoClassificationBudget) : i += 1
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = IIf(iCodigoUsuario = -1, DBNull.Value, iCodigoUsuario) : i += 1
            ...
            oSqlParameter(i).Value = iEmpresa

            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, sProcedure, oSqlParameter)

            'Não carregar novamente, apenas trazer do 
            ' oSqlDataReader = oDataSet.Tables(0).CreateDataReader
    ...
    Public Sub FormataGrafico(ByVal oChart As Chart, _
        ...
        Try
            ...
            oChart.ChartAreas(0).AxisY.Margin = True
            oChart.ChartAreas(0).AxisX.Margin = False
            oChart.ChartAreas(0).AxisY.LabelStyle.Format = "R$ #,#0"
    ...
    Public Sub VerificaCamposGrafico(ByVal iCodigo As Integer, _
                                     ...
                                     ByVal cboUsuario As Janus.Windows.EditControls.UIComboBox, _
                                     ByVal cboClassificationBudget As Janus.Windows.EditControls.UIComboBox, _
        ...
        Try
            ...
            If oSQLDataReader.Read Then
                ...
                If oSQLDataReader.Item("usuario") = True Then
                ...
                If oSQLDataReader.Item("classification_budget") = True Then
                    cboClassificationBudget.Visible = True

                Else
                    cboClassificationBudget.Visible = False
                    cboClassificationBudget.SelectedIndex = -1
                End If
