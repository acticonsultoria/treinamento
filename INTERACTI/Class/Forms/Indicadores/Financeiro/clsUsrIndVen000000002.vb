...
Public Class clsUsrIndVen000000002
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_grid_chart_ven000000002", oSqlParameter)
    ...
    Public Sub LoadGrafico(ByVal oChart As Chart, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_chart_ven000000002", oSqlParameter)
            ...
            'Carrega Gráfico
            oChart.Series("Default").Points.DataBind(oSqlDataReader, "descricao", "valor", "Tooltip=tag")
