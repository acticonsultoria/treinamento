...
Public Class clsUsrFinTituloExcluirPrevisao
...
#Region "::: TÍTULO :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_titulo_excluir_previsao", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For j = 0 To UBound(gSelecaoRow)
                ...
                oSqlParameter(i).Value = gSelecaoRow(j).Cells("codigo_titulo_capa").Value : i += 1
