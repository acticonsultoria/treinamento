...
Public Class clsUsrFinReceitaCancelarPagamento
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Seta Parametros - Código Tipo de Documento de Pagamento
            oSqlParameter(i) = New SqlParameter
            ...
            'Seta Parametros - N° Documento Pagamento
            oSqlParameter(i) = New SqlParameter
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_titulo_pagamento_cancelar", oSqlParameter)
    ...
    Public Sub CancelarPagamento()
        ...
        Try
            ...
            For Each oRow In gSelecaoRow
                ...
                'Seta Parametros - Código Pagamento
                oSqlParameter(i) = New SqlParameter
                oSqlParameter(i).ParameterName = "codigo_titulo_parcela_pagamento"
                oSqlParameter(i).Direction = ParameterDirection.Input
                oSqlParameter(i).SqlDbType = SqlDbType.BigInt
                oSqlParameter(i).Value = oRow.Cells("codigo_titulo_parcela_pagamento").Value : i += 1
                ...
                oSqlParameter(i).Value = oRow.Cells("valor_pago").Value

                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_financeiro_titulo_parcela_pagamento_cancelar", oSqlParameter)
    ...
    Public Sub CancelarPagamentoIndividual(ByVal lCodigoTituloCapa As Long, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iNumeroParcela

            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_financeiro_titulo_parcela_pagamento_cancelar_individual", oSqlParameter)
