...
Public Class clsUsrFinReceitaAdiantamento
...
#Region "::: VARIAVEIS :::"
    ...
    Private lCodigoPedidoVendaAdiantamento As Long
...
#Region "::: PROPERTIE :::"
    ...
    Public Property CodigoPedidoVendaAdiantamento() As Long
        Get
            Return lCodigoPedidoVendaAdiantamento
        End Get
        Set(ByVal value As Long)
            lCodigoPedidoVendaAdiantamento = value
        End Set
    End Property
...
#Region "::: TÍTULO :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            'Seta Parametros - Codigo Pedido de Venda
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_pedido_venda_adiantamento"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = lCodigoPedidoVendaAdiantamento : i += 1 : ReDim Preserve oSqlParameter(i)
    ...
    Public Sub Update()
        ...
        Try
            ...
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 20
            oSqlParameter(i).Value = sNumeroDocumento : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 3
            oSqlParameter(i).Value = IIf(sSerie = "", DBNull.Value, sSerie) : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iTipoDocumento : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.BigInt
            oSqlParameter(i).Value = lParceiroNegocio : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.DateTime
            oSqlParameter(i).Value = sDataEmissao : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iTipoTituloFinanceiro : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iMoeda : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dFatorCambial : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dMultaPagamento : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dJurosPagamento : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dDescontoPagamento : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 500
            oSqlParameter(i).Value = sDescritivo : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dValor : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dDescontoValor : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dDescontoPercentual : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iFormaPagamento : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iNumeroParcela : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = iIntervaloParcela : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = goUsuario.iEmpresa : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = goUsuario.iUsuario : i += 1 : i += 1 : ReDim Preserve oSqlParameter(i)
    ...
    Public Sub LoadControlesAdiantamento(ByVal lCodigo As Long, _
                                         ByVal txtNumeroDocumento As MaskedEditBox, _
                                         ByVal txtSerie As MaskedEditBox, _
                                         ByVal cboParceiroNegocio As UIComboBox, _
                                         ByVal dtpDataEmissao As CalendarCombo, _
