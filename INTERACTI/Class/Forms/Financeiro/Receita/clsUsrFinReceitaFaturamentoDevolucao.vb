...
Public Class clsUsrFinReceitaFaturamentoDevolucao
...
#Region "::: NOTA FISCAL :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
                        ...
                        ByVal lNotaFiscalDevolucao As Long, _
                        ByVal sDataDevolucaoInicio As String, _
                        ByVal sDataDevolucaoTermino As String)
        ...
        Try
            ...
            'Seta Parametros - Nota Fiscal Devolução
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "nota_fiscal_devolucao"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.BigInt
            oSqlParameter(i).Value = lNotaFiscalDevolucao : i += 1

            'Seta Parametros - Data Devolução Início
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "data_devolucao_inicio"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.DateTime
            oSqlParameter(i).Value = IIf(sDataDevolucaoInicio = "", DBNull.Value, sDataDevolucaoInicio) : i += 1

            'Seta Parametros - Data Devolução Término
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "data_devolucao_termino"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.DateTime
            oSqlParameter(i).Value = IIf(sDataDevolucaoTermino = "", DBNull.Value, sDataDevolucaoTermino) : i += 1
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_receita_faturamento_devolucao", oSqlParameter)
    ...
    Public Sub CancelaTitulo(ByVal lCodigoTituloCapa As Long, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = StatusTitulo.Cancelado : i += 1
    ...
    Public Sub AtualizarTitulo(ByVal lCodigoTituloCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_financeiro_titulo_valor_devolvido", oSqlParameter)
    ...
    Public Sub GerarCreditoTitulo(ByVal lCodigoTituloCapa As Long, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_financeiro_titulo_credito", oSqlParameter)
    ...
    Public Sub GerarCreditoParcela(ByVal lCodigoTituloCapa As Long, _
