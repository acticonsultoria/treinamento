...
Public Class clsUsrFinReceitaLancamento
...
#Region "::: VARIAVEIS :::"
    ...
    Private lCodigoReceitaCapa As Long
...
#Region "::: PROPERTIE :::"
    ...
    Public Property CodigoReceitaCapa() As Long
        Get
            Return lCodigoReceitaCapa
        End Get
        Set(ByVal value As Long)
            lCodigoReceitaCapa = value
        End Set
    End Property
...
#Region "::: TÍTULO :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            oSqlParameter(i).Value = "R" : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            'Seta Código
            lCodigoReceitaCapa = oSqlParameter(i).Value
    ...
    Public Sub Update()
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.BigInt
            oSqlParameter(i).Value = lCodigoReceitaCapa
    ...
    Public Sub LoadGridLavalpa(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_titulo_lavalpa", oSqlParameter)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_titulo", oSqlParameter)
    ...
    Public Function ValidaReceitaCapa(ByVal lCodigoReceitaCapa As Long, _
                                      ByVal sNumeroDocumento As String, _
                                      ByVal sSerie As String, _
        ...
        Try
            ...
            'Seta Retorno da Função
            ValidaReceitaCapa = IIf(iReturn > 0, False, True)
    ...
    Public Sub LoadDadosFinanceiro(ByVal lCodigoTituloCapa As Long, _
                                   ByVal txtNumeroDocumento As EditBox, _
                                   ByVal txtParceiroNegocio As EditBox, _
                                   ByVal txtValorOriginal As NumericEditBox)
        ...
        Try
            ...
            While oSqlDataReader.Read
                ...
                txtValorOriginal.Value = oSqlDataReader.Item("valor")
    ...
    Public Sub InsertPagamentoCartaoTemp(ByVal sCodigoConsultora As String, _
        ...
        Try
            ...
            'Seta Parametros - Valor Parcelaw
            oSqlParameter(i) = New SqlParameter
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_financeiro_importacao_pagamento_cartao_temp", oSqlParameter)
    ...
    Public Sub InsertPagamentoAntecipadoTemp(ByVal sCodigoConsultora As String,
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_financeiro_importacao_pagamento_antecipado_temp", oSqlParameter)
    ...
    Public Sub LoadGridPagamentoCartao(ByVal oGrid As GridEX)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_importacao_pagamento_cartao", oSqlParameter)
    ...
    Public Sub LoadGridPagamentoAntecipado(ByVal oGrid As GridEX)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_importacao_pagamento_antecipado", oSqlParameter)
    ...
    Public Sub InsertPagamentoCartao(ByVal sCodigos As String)
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Value = sCodigos : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_integracao_importacao_pagamento_cartao_credito", oSqlParameter)
    ...
    Public Sub InsertPagamentoAntecipado(ByVal sCodigos As String)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_integracao_importacao_pagamento_antecipado", oSqlParameter)
    ...
    Public Sub InsertPagamentoCreditoTemp(ByVal sCodigoConsultora As String, _
                                         ByVal sValorNF As String, _
                                         ByVal sValorPago As String, _
                                         ByVal sNF As String, _
                                         ByVal sData As String, _
                                         ByVal sSemana As String, _
                                         ByVal sValorAberto As String, _
        ...
        Try
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "valor_nf"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = sValorNF : i += 1

            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "valor_pago"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = sValorPago : i += 1
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "valor_aberto"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = sValorAberto

            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_financeiro_importacao_pagamento_credito_temp", oSqlParameter)
    ...
    Public Sub LoadGridPagamentoCredito(ByVal oGrid As GridEX)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_importacao_pagamento_credito", oSqlParameter)
    ...
    Public Sub InsertPagamentoCredito(ByVal sCodigos As String)
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_integracao_importacao_pagamento_credito", oSqlParameter)
    ...
    Public Sub UpdateVinculoNF(ByVal iCodigoTituloCapa As Integer, _
                               ByVal iCodigoNFSe As Integer)
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iCodigoNFSe : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_financeiro_receita_nota_fiscal", oSqlParameter)
...
#Region "::: PARCELA :::"
    ...
    Public Sub GerarParcela(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Limpa Grid
            For Each oRow As GridEXRow In oGrid.GetDataRows
                If oRow.Cells("pago").Value = False Then
                    oRow.Delete()
                Else
                    dValor = dValor - oRow.Cells("valor").Value
                End If
            Next
            ...
            If dValor > 0 Then
                ...
                For Each oRow As GridEXRow In oGrid.GetDataRows
                    ...
                    oDataRow("valor_pago") = oRow.Cells("valor").Value
                ...
                For i = 1 To iNumeroParcela
                    Dim oDataRow As DataRow = oDataTable.NewRow
                    oDataRow("pago") = False
                    oDataRow("data_vencimento") = CDate(DateAdd(DateInterval.Day, i * iIntervaloParcela, CDate(sData)))
...
#Region "::: VINCULAR CHEQUE :::"

    Public Sub LoadGridCheque(ByVal oGrid As GridEX)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_titulo_cheque_vincular", oSqlParameter)
    ...
    Public Sub InsertCheque(ByVal sNumeroCheque As String, _
                            ByVal iCodigoCliente As Integer, _
                            ByVal sData As String, _
                            ByVal sDataPreDatado As String, _
                            ByVal dValorCheque As Double, _
                            ByVal dValorBaixar As Double, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dValorCheque : i += 1

            'Seta Parametros - Valor Baixar
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "valor_baixar"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Float
            oSqlParameter(i).Value = dValorBaixar

            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_financeiro_titulo_cheque_tmp", oSqlParameter)
    ...
    Public Sub DeleteCheque()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_financeiro_titulo_cheque_tmp", oSqlParameter)
