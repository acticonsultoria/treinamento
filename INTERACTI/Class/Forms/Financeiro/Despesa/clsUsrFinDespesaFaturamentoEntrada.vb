...
Public Class clsUsrFinDespesaFaturamentoEntrada
...
#Region "::: NOTA FISCAL :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
                        ...
                        ByVal iTipoNotaFiscal As Integer)
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_despesa_entrada_nota_fiscal", oSqlParameter)
