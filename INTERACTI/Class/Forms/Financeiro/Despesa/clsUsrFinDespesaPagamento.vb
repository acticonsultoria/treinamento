...
Public Class clsUsrFinDespesaPagamento
        ...
        Try
            ...
            For Each oRowParcela In grdParcela.GetDataRows
                ...
                For Each oRowPagamento In grdPagamento.GetDataRows
                    ...
                    ''Seta Parametros - Nº Parcela Cartão Crédito
                    'oSqlParameter(i) = New SqlParameter
                    'oSqlParameter(i).ParameterName = "numero_parcelas_cartao"
                    'oSqlParameter(i).Direction = ParameterDirection.Input
                    'oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
                    'oSqlParameter(i).Value = oRowPagamento.Cells("numero_parcela_cartao_credito").Value : i += 1
...
#Region "::: ADIANTAMENTO :::"
    ...
    Public Sub InsertPagamentoAdiantamento(ByVal sContaBancaria As String, _
        ...
        Try
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Bit
            If IsDBNull(IIf(iPreDatado = -1, DBNull.Value, iPreDatado)) Then
                oSqlParameter(i).Value = DBNull.Value : i += 1
            Else
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = IIf(iCodigoTituloParcelaPagamentoReceita = -1, DBNull.Value, iCodigoTituloParcelaPagamentoReceita) : i += 1
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = IIf(iNumeroParcelaReceita = -1, DBNull.Value, iNumeroParcelaReceita) : i += 1
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = IIf(iCodigoCartaoCredito = -1, DBNull.Value, iCodigoCartaoCredito) : i += 1
            ...
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            oSqlParameter(i).Value = IIf(iNumeroParcelaCartaoCredito = -1, DBNull.Value, iNumeroParcelaCartaoCredito) : i += 1
