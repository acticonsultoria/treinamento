...
Public Class clsUsrFinControleAdiantamento
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_financeiro_titulo_controle_adiantamento", oSqlParameter)
            ...
            oChildren(0) = oDataSet.Tables(1).Columns("codigo_parceiro_negocio")
            oChildren(1) = oDataSet.Tables(1).Columns("tipo_titulo")
            oParent(0) = oDataSet.Tables(0).Columns("codigo_parceiro_negocio")
            oParent(1) = oDataSet.Tables(0).Columns("tipo_titulo")
