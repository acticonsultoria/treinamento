...
Public Class clsUsrCadMateriaPrima
...
#Region "::: VARIAVEIS :::"
    ...
    Private dValorKilo As Double
    Private iCodigoMoeda As Double
...
#Region "::: PROPERTIE :::"
    ...
    Public Property ValorKilo() As Double
        Get
            Return dValorKilo
        End Get
        Set(ByVal value As Double)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_mp", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            oSqlParameter(i).Value = dDensidade : i += 1
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_mp", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_mp", oSqlParameter)
    ...
    Public Function ValidaCodigo(ByVal iCodigo As Integer, _
        ...
        Try
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_mp", oSqlParameter), Integer)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_mp", oSqlParameter)
