...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_box", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_box", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_box", oSqlParameter)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_box", oSqlParameter)
    ...
    Public Sub LoadDadosBox(ByVal iCodigo As Integer, _
