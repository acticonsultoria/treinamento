...
Public Class clsUsrCadGrupoOperacao
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert(ByVal sDescricao As String, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_grupo_operacao", oSqlParameter)
    ...
    Public Sub Update(ByVal iCodigo As Integer, _
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_grupo_operacao", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_grupo_operacao", oSqlParameter)
    ...
    Public Function ValidaDescricao(ByVal iCodigo As Integer, _
        ...
        Try
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_grupo_operacao", oSqlParameter), Integer)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_grupo_operacao", oSqlParameter)
