...
Public Class clsUsrCadDocumento
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            oSqlParameter(i).Value = iCodigoTipoDocumento : i += 1 : ReDim Preserve oSqlParameter(i)
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_documento", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_documento", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_documento", oSqlParameter)
    ...
    Public Function ValidaDescricao(ByVal iCodigo As Integer, _
        ...
        Try
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_documento", oSqlParameter), Integer)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX,
        ...
        Try
            ...
            'Seta Parametros - Código Tipo de Documento
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_tipo_documento"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_documento", oSqlParameter)
    ...
    Public Sub LoadDados(ByVal lCodigo As Integer,
                         ...
                         ByVal cboTipoDocumento As UIComboBox,
