...
#Region "::: VARIAVEIS :::"
    ...
    Private iNumeroPeriodos As Integer
...
#Region "::: PROPERTIE :::"
    ...
    Public Property NumeroPeriodos() As Integer
        Get
            Return iNumeroPeriodos
        End Get
        Set(ByVal value As Integer)
            iNumeroPeriodos = value
        End Set
    End Property
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            oSqlParameter(i).ParameterName = "codigo_evento"
            ...
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "numero_periodos"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.Int
            oSqlParameter(i).Value = iNumeroPeriodos : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_evento", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_evento", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_evento", oSqlParameter)
    ...
    Public Function ValidaCodigo(ByVal iCodigo As Integer, _
                                 ByVal sCodigoEvento As String) As Boolean
        ...
        Try
            ...
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 100
            oSqlParameter(i).Value = sCodigoEvento : i += 1
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_evento", oSqlParameter), Integer)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
                        ByVal sCodigoEvento As String, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_evento", oSqlParameter)
