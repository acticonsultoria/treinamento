...
Public Class clsUsrCadCondicaoPagamento
...
#Region "::: CONDIÇÃO DE PAGAMENTO :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            'Seta Parametros - Intervalo entre as Parcelas
            oSqlParameter(i) = New SqlParameter
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_condicao_pagamento", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_condicao_pagamento", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_condicao_pagamento", oSqlParameter)
    ...
    Public Function ValidaDescricao(ByVal iCodigo As Integer, _
        ...
        Try
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_condicao_pagamento", oSqlParameter), Integer)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX,
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_condicao_pagamento", oSqlParameter)

            'Configura DataMember
            Call ConfigurarDataMemberGrid(oGrid)

            oDataSet.Relations.Add(oDataSet.Tables(1).TableName, oDataSet.Tables(0).Columns("codigo"), oDataSet.Tables(1).Columns("codigo_condicao_pagamento"))
    ...
    Public Sub LoadDados(ByVal lCodigo As Integer,
                         ByVal txtDescricaoFiltro As MaskedEditBox,
                         ByVal txtNumeroParcela As NumericEditBox,
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_condicao_pagamento_dados", oSqlParameter)

            While oSqlDataReader.Read

                'Seta Controles
                txtDescricaoFiltro.Text = oSqlDataReader.Item("descricao")
...
#Region "::: PARCELA :::"
    ...
    Public Sub DeleteParcela()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_condicao_pagamento_parcela", oSqlParameter)
    ...
    Public Sub InsertParcela(ByVal oGrid As GridEX)
        ...
        Try
            ...
            For Each oRow In oGrid.GetDataRows
                ...
                'Seta Parametros - Dia Fixo
                oSqlParameter(i) = New SqlParameter
                oSqlParameter(i).ParameterName = "dia_fixo"
                oSqlParameter(i).Direction = ParameterDirection.Input
                oSqlParameter(i).SqlDbType = SqlDbType.SmallInt
                oSqlParameter(i).Value = oRow.Cells("dia_fixo").Value : i += 1
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_condicao_pagamento_parcela", oSqlParameter)
    ...
    Public Sub LoadGridParcela(ByVal oGrid As GridEX, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_condicao_pagamento_parcela", oSqlParameter)
