...
Public Class clsUsrCadEstampa

#Region "::: VARIAVEIS :::"

    'Variaveis da Classe
    Private sCodigoEstampa As String
...
#Region "::: PROPERTIE :::"
    ...
    Public Property CodigoEstampa() As String
        Get
            Return sCodigoEstampa
        End Get
        Set(ByVal value As String)
            sCodigoEstampa = value
        End Set
    End Property
    ...
    Public Property PictureFoto() As PictureBox
        Get
            Return picFoto
        End Get
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            'Seta Parametros - Código Estampa
            oSqlParameter(i) = New SqlParameter
            oSqlParameter(i).ParameterName = "codigo_estampa"
            oSqlParameter(i).Direction = ParameterDirection.Input
            oSqlParameter(i).SqlDbType = SqlDbType.VarChar
            oSqlParameter(i).Size = 20
            oSqlParameter(i).Value = sCodigoEstampa : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_estampa", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_estampa", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_estampa", oSqlParameter)
    ...
    Public Sub LoadControles(ByVal iCodigo As Integer, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_estampa_dados", oSqlParameter)

            If oSqlDataReader.HasRows Then

                While oSqlDataReader.Read

                    txtCodigo.Text = oSqlDataReader.Item("codigo_estampa")
    ...
    Public Function ValidaCodigo(ByVal iCodigo As Integer, _
                                 ByVal sCodigoEstampa As String) As Boolean
        ...
        Try
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_estampa", oSqlParameter), Integer)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
                        ByVal sCodigoEstampa As String, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_estampa", oSqlParameter)
