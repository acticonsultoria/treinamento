...
Public Class clsUsrCadPlantaFabrica

#Region "::: VARIAVEIS :::"

    'Variaveis da Classe
    Private sCodigoPlanta As String
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert()
        ...
        Try
            ...
            oSqlParameter(i).Value = sCodigoPlanta : i += 1
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_planta", oSqlParameter)
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_planta", oSqlParameter)
    ...
    Public Sub Editar(ByVal iCodigo As Integer, _
                      ByVal txtCodigoPlanta As MaskedEditBox, _
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_planta_dados", oSqlParameter)

            If oSqlDataReader.HasRows Then

                While oSqlDataReader.Read

                    txtCodigoPlanta.Text = oSqlDataReader.Item("codigo_planta")
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_planta", oSqlParameter)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX, _
                        ByVal sCodigoPlanta As String, _
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_planta", oSqlParameter)
    ...
    Public Function ValidaCodigo(ByVal iCodigo As Integer, _
                                 ByVal sCodigoPlanta As String) As Boolean
        ...
        Try
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_planta", oSqlParameter), Integer)
