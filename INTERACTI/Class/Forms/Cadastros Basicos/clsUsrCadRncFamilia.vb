...
Public Class clsUsrCadRncFamilia
...
#Region "::: FUNCTION / SUB :::"
    ...
    Public Sub Insert(ByVal sDescricao As String,
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_insert_cadastro_basico_rnc_familia", oSqlParameter)
    ...
    Public Sub Update(ByVal iCodigo As Integer,
        ...
        Try
            ...
            'Executa Query
            ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_update_cadastro_basico_rnc_familia", oSqlParameter)
    ...
    Public Sub Delete()
        ...
        Try
            ...
            For Each oRow As GridEXRow In gSelecaoRow
                ...
                'Executa Query
                ExecuteNonQuery(goDatabase.sConnection, CommandType.StoredProcedure, "sp_delete_cadastro_basico_rnc_familia", oSqlParameter)
    ...
    Public Function ValidaDescricao(ByVal iCodigo As Integer,
        ...
        Try
            ...
            'Executa Query
            iReturn = CType(ExecuteScalar(goDatabase.sConnection, CommandType.StoredProcedure, "sp_validate_cadastro_basico_rnc_familia", oSqlParameter), Integer)
    ...
    Public Sub LoadGrid(ByVal oGrid As GridEX,
        ...
        Try
            ...
            'Executa Query
            oDataSet = ExecuteDataset(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_rnc_familia", oSqlParameter)
    ...
    Public Sub LoadDados(ByVal iCodigo As Integer,
                         ByVal sDescricao As MaskedEditBox,
        ...
        Try
            ...
            'Executa Query
            oSqlDataReader = ExecuteReader(goDatabase.sConnection, CommandType.StoredProcedure, "sp_select_cadastro_basico_rnc_familia_dados", oSqlParameter)

            While oSqlDataReader.Read

                sDescricao.Text = oSqlDataReader("descricao")
