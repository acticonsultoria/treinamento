...
Public Class usrImpII

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsImpII As New clsUsrImpII

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrImpII_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrImpII_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrImpII_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.ImpostoRegraII
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.ImpostoRegraII)
    ...
    Private Sub btnFormula_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProduto.Click, _
                                                                                                     ...
                                                                                                     btnC.Click, _
                                                                                                     btnCE.Click, btnAliquotaCOFINS.Click
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrImpII_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.ImpostoRegraII, gcDelete)
            btnNovo1.Enabled = VerificaDireito(Formulario.ImpostoRegraII, gcInsert)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsImpII.CFOP = cboCFOP.SelectedValue
            oClsImpII.FormulaII = txtFormula.Text.Trim
            oClsImpII.Codigo = IIf(IsNumeric(cboCFOP.Tag), cboCFOP.Tag, 0)
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.ImpostoRegraII, gcUpdate) = True Then

                'Limpa Grid
                Call Novo()

                'Carrega Formulário
                Call oClsImpII.LoadControles(grdListagem.CurrentRow.Cells("codigo").Value, _
                                             cboCFOP, _
                                             txtFormula)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsImpII.LoadGrid(grdListagem, _
                               IIf(cboCFOPFiltro.SelectedIndex = -1, -1, cboCFOPFiltro.SelectedValue))
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Valida Dados
            If oClsImpII.ValidaCFOPCST(cboCFOP.SelectedValue, _
                                       IIf(IsNumeric(cboCFOP.Tag), cboCFOP.Tag, 0)) = False Then
                frmMain.errInfo.SetError(lblCFOP, "Este CFOP: " & cboCFOP.Text & " já está associado a outro Registro.")
                cboCFOP.Focus()
                Exit Function
            End If

            'Caso tenha Aba ICMS
            If tabII.Contains(pagICMS) Then
