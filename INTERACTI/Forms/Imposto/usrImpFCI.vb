...
Public Class usrImpFCI

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsImpRegra As New clsusrImpFCI

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrImpFCI_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrImpFCI_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.ImpostoFCI
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.ImpostoFCI)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrImpFCI_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.ImpostoFCI, gcPrint)
            ...
            dtpDataEmissaoFCIInicioFiltro.Value = Now.Date : dtpDataEmissaoFCIInicioFiltro.Checked = False
            dtpDataEmissaoFCITerminoFiltro.Value = Now.Date : dtpDataEmissaoFCITerminoFiltro.Checked = False
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            oClsImpRegra.LoadGrid(grdListagem, _
                                  IIf(IsNumeric(txtNotaFiscalFiltro.Text.Trim) = False, -1, txtNotaFiscalFiltro.Text), _
                                  ...
                                  txtNumeroFCIFiltro.Text.Trim, _
                                  txtNumeroProtocoloFiltro.Text.Trim, _
                                  IIf(dtpDataEmissaoFCIInicioFiltro.Checked = False, "", dtpDataEmissaoFCIInicioFiltro.Value), _
                                  IIf(dtpDataEmissaoFCITerminoFiltro.Checked = False, "", dtpDataEmissaoFCITerminoFiltro.Value))
