...
Public Class usrImpPIS

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsImpPIS As New clsUsrImpPIS

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrImpPIS_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrImpPIS_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrImpPIS_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.ImpostoRegraPIS
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.ImpostoRegraPIS)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrImpPIS_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.ImpostoRegraPIS, gcDelete)
            btnNovo1.Enabled = VerificaDireito(Formulario.ImpostoRegraPIS, gcInsert)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.ImpostoRegraPIS, gcPrint)
            ...
            oComboBox(0) = cboCFOPFiltro : oComboBox(1) = cboCFOP
            Call LoadCombo(oComboBox, "sp_select_combo_cadastro_basico_cfop " & goUsuario.iEmpresa)
            oComboBox(0) = cboSituacaoTributariaPISFiltro : oComboBox(1) = cboSituacaoTributariaPIS
            Call LoadCombo(oComboBox, "sp_select_combo_static_situacao_tributaria_pis")
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsImpPIS.CFOP = cboCFOP.SelectedValue
            oClsImpPIS.CST = cboSituacaoTributariaPIS.SelectedValue
            oClsImpPIS.FormulaPIS = txtFormula.Text.Trim
            oClsImpPIS.FormulaPISST = ""
            oClsImpPIS.Codigo = IIf(IsNumeric(cboCFOP.Tag), cboCFOP.Tag, 0)
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.ImpostoRegraPIS, gcUpdate) = True Then

                'Limpa Grid
                Call Novo()

                'Carrega Formulário
                Call oClsImpPIS.LoadControles(grdListagem.CurrentRow.Cells("codigo").Value, _
                                               cboCFOP, _
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            Call oClsImpPIS.LoadGrid(grdListagem, _
                                     IIf(cboCFOPFiltro.SelectedIndex = -1, -1, cboCFOPFiltro.SelectedValue), _
                                     IIf(cboSituacaoTributariaPISFiltro.SelectedIndex = -1, "", cboSituacaoTributariaPISFiltro.SelectedValue))
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Valida Dados
            If oClsImpPIS.ValidaCFOPCST(cboCFOP.SelectedValue, _
                                         cboSituacaoTributariaPIS.Text, _
                                         IIf(IsNumeric(cboCFOP.Tag), cboCFOP.Tag, 0)) = False Then
                frmMain.errInfo.SetError(lblSituacaoTributariaPIS, "Este CFOP: " & cboCFOP.Text & " e CST: " & cboSituacaoTributariaPIS.Text & " já está associado a outro Registro.")
                cboSituacaoTributariaPIS.Focus()
                Exit Function
            End If

            'Caso tenha Aba ICMS
            If tabPIS.Contains(pagICMS) Then
