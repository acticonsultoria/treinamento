...
Public Class usrCadGrupoOperacao

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsUsrCadGrupoOperacao As New clsUsrCadGrupoOperacao
...
#Region "::: FUNCTION / SUB :::"
        ...
        Try
            ...
            If VerificaSelecaoRow(grdListagem) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro" & IIf(gSelecaoRow.Count = 1, "?", "s?"), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    'Exclui Registro
                    oClsUsrCadGrupoOperacao.Delete()
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oClsUsrCadGrupoOperacao.Update(btnSalvar.Tag, _
            ...
            Else
                ...
                oClsUsrCadGrupoOperacao.Insert(txtDescricao.Text.Trim, _
                                             cboAtivo.SelectedValue)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrCadGrupoOperacao.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oClsUsrCadGrupoOperacao.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
