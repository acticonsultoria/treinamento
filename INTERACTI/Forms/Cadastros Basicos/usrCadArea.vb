...
Public Class usrCadArea

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadArea As New clsusrCadArea
...
#Region "::: FUNCTION / SUB :::"
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoArea, gcUpdate) = True Then
                ...
                With grdListagem.CurrentRow.Cells
                    ...
                    txtCodigo.Text = .Item("codigo_area").Value
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros            
            oClsCadArea.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadArea.CodigoArea = txtCodigo.Text.Trim
            oClsCadArea.Descricao = txtDescricao.Text.Trim
            oClsCadArea.Ativo = cboAtivo.SelectedValue
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadArea.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadArea.ValidaCodigo(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
