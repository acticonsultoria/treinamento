Public Class usrCadClasse

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadClasse As New clsusrCadClasse
...
#Region "::: CONTROLES :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.CadastroBasicoClasse
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.CadastroBasicoClasse)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.CadastroBasicoClasse)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.CadastroBasicoClasse, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.CadastroBasicoClasse, gcDelete)
            btnNovo1.Enabled = VerificaDireito(Formulario.CadastroBasicoClasse, gcInsert)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.CadastroBasicoClasse, gcPrint)
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoClasse, gcUpdate) = True Then
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros            
            oClsCadClasse.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadClasse.CodigoClasse = txtCodigo.Text.Trim
            oClsCadClasse.Descricao = txtDescricao.Text.Trim
            oClsCadClasse.Ativo = cboAtivo.SelectedValue

            'Verifica o Tipo de Operação
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadClasse.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadClasse.Insert()
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadClasse.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadClasse.ValidaCodigo(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
