...
Public Class usrCadBanco

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadBanco As New clsUsrCadBanco
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadBanco.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadBanco.CodigoBanco = txtCodigoBanco.Text.Trim
            oClsCadBanco.Descricao = txtDescricao.Text.Trim
            oClsCadBanco.Ativo = cboAtivo.SelectedValue
            ...
            Else
                ...
                btnSalvar.Tag = oClsCadBanco.Codigo
            End If
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadBanco.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If ValidaCampo(txtCodigoBanco, lblCodigoBanco, TipoCampo.texto) = False Then
                Exit Function
            End If

            'Verifica se a CodigoBanco preenchida é válida
            If oClsCadBanco.ValidaCodigoBanco(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
                                              txtCodigoBanco.Text.Trim) = False Then
                frmMain.errInfo.SetError(lblCodigoBanco, "Este Código: " & txtCodigoBanco.Text & " já está associado a outro Registro.")
                txtCodigoBanco.Focus()
                Exit Function
            End If
