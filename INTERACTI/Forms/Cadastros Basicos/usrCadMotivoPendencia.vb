...
Public Class usrCadMotivoPendencia

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadMotivoPendencia As New clsusrMotivoPendencia
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCadArea_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Novo()
        ...
        Try
            ...
            oClsCadMotivoPendencia.LoadCodigo(txtCodigo)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadMotivoPendencia.Update(txtDescricao.Text, cboAtivo.SelectedValue, txtSolucao.Text, btnSalvar.Tag)
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadMotivoPendencia.Insert(txtDescricao.Text, cboAtivo.SelectedValue, txtSolucao.Text)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadMotivoPendencia.LoadGrid(grdListagem, _
