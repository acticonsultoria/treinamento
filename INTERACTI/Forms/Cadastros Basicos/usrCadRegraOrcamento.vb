...
Public Class usrCadRegraOrcamento

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsUsrCadRegraOrcamento As New clsUsrCadRegraOrcamento
...
#Region "::: CONTROLES :::"
    ...
    Private Sub LostFocus_ICMS(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPorcentagemReducaoBCICMS.LostFocus, _
                                                                                            txtAliquotaICMSPorcentagem.LostFocus

        Try

            If txtPorcentagemReducaoBCICMS.Value > 0 Then
                txtAliquotaICMSReduzido.Value = Math.Round((1 - txtPorcentagemReducaoBCICMS.Value) / (0.01 / txtAliquotaICMSPorcentagem.Value) / 100.0, 3)
            Else
                txtAliquotaICMSReduzido.Value = txtAliquotaICMSPorcentagem.Value
            End If
...
#Region "::: FUNCTION / SUB :::"
        ...
        Try
            ...
            If VerificaDireito(iFormulario, gcUpdate) = True Then
                ...
                With grdListagem.CurrentRow.Cells
                    ...
                    txtPorcentagemReducaoBCICMS.Value = .Item("aliquota_reducao_base_calculo_icms").Value
                    txtAliquotaICMSPorcentagem.Value = .Item("aliquota_icms").Value
                    txtAliquotaICMSReduzido.Value = .Item("aliquota_icms_reduzido").Value
                    txtAliquotaPISPorcentagem.Value = .Item("aliquota_pis").Value
                    txtAliquotaCOFINSPorcentagem.Value = .Item("aliquota_cofins").Value
                    txtAliquotaISSPorcentagem.Value = .Item("aliquota_iss").Value
                    txtAliquotaIR.Value = .Item("aliquota_ir").Value
                    txtAliquotaCSLL.Value = .Item("aliquota_csll").Value
        ...
        Try
            ...
            If VerificaSelecaoRow(grdListagem) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro" & IIf(gSelecaoRow.Count = 1, "?", "s?"), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    'Exclui Registro
                    oClsUsrCadRegraOrcamento.Delete()
    ...
    Private Sub Novo()
        ...
        Try
            ...
            LimparCamposGroupBox(grpImposto)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oClsUsrCadRegraOrcamento.Update(btnSalvar.Tag, _
                                                txtDescricao.Text.Trim, _
                                                cboAtivo.SelectedValue, _
                                                txtPorcentagemReducaoBCICMS.Value, _
                                                txtAliquotaICMSPorcentagem.Value, _
                                                txtAliquotaICMSReduzido.Value, _
                                                txtAliquotaPISPorcentagem.Value, _
                                                txtAliquotaCOFINSPorcentagem.Value, _
                                                txtAliquotaISSPorcentagem.Value, _
            ...
            Else
                ...
                oClsUsrCadRegraOrcamento.Insert(txtDescricao.Text.Trim, _
                                                cboAtivo.SelectedValue, _
                                                txtPorcentagemReducaoBCICMS.Value, _
                                                txtAliquotaICMSPorcentagem.Value, _
                                                txtAliquotaICMSReduzido.Value, _
                ...
                btnSalvar.Tag = oClsUsrCadRegraOrcamento.Codigo
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrCadRegraOrcamento.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oClsUsrCadRegraOrcamento.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
