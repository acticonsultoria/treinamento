...
Public Class usrCadMeta

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadMeta As New clsUsrCadMeta
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Carrega Combo         
            LoadComboSimNao(cboAtivoFiltro)
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If grdListagem.GetValue("ativo") = False Then
                frmMain.Informacao("Não é possível editar metas de períodos anteriores.", Color.Red)
                Exit Sub
            End If
            ...
            If VerificaDireito(iFormulario, gcUpdate) = True Then
                ...
                oClsCadMeta.LoadDados(iCodigo:=btnSalvar.Tag,
                                      txtDescricao:=txtDescricao,
                                      txtFaturamentoMensal:=txtFaturamentoMensal,
                                      dtpDataInicio:=dtpDataInicio,
                                      cboAtivo:=cboAtivo)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oClsCadMeta.Update(iCodigo:=btnSalvar.Tag,
                                   sDescricao:=txtDescricao.Text.Trim,
                                   dFaturamentoMensal:=txtFaturamentoMensal.Text.Trim,
                                   sDataInicio:=dtpDataInicio.Value,
                                   bAtivo:=IIf(cboAtivo.SelectedIndex = -1, 0, cboAtivo.SelectedValue))

                frmMain.Informacao(Mensagem.RegistroAlterado)

            Else

                oClsCadMeta.Insert(sDescricao:=txtDescricao.Text.Trim,
                                   dFaturamentoMensal:=txtFaturamentoMensal.Text.Trim,
                                   sDataInicio:=dtpDataInicio.Value,
                                   bAtivo:=IIf(cboAtivo.SelectedIndex = -1, 0, cboAtivo.SelectedValue))
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadMeta.LoadGrid(grdListagem,
                                 sDescricao:=txtDescricaoFiltro.Text.Trim,
                                 bAtivo:=IIf(cboAtivoFiltro.SelectedIndex = -1, -1, cboAtivoFiltro.SelectedValue),
                                 sDataInicio:=IIf(dtpDataInicioFiltro.Checked = True, dtpDataInicioFiltro.Value, ""),
                                 sDataFim:=IIf(dtpDataFimFiltro.Checked = True, dtpDataFimFiltro.Value, ""))
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oClsCadMeta.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0),
