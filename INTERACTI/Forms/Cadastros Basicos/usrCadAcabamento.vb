...
Public Class usrCadAcabamento

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadAcabamento As New clsUsrCadAcabamento
...
#Region "::: FUNCTION / SUB :::"
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoArea, gcUpdate) = True Then
                ...
                With grdListagem.CurrentRow.Cells
                    ...
                    txtCodigo.Text = .Item("codigo_acabamento").Value
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadAcabamento.Update(txtCodigo.Text, _
                                           txtDescricao.Text, _
                                           cboAtivo.SelectedValue, _
                                           btnSalvar.Tag)
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadAcabamento.Insert(txtCodigo.Text, _
                                           txtDescricao.Text, _
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadAcabamento.LoadGrid(grdListagem, _
