...
Public Class usrCadFamilia

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsUsrCadFamilia As New clsUsrCadFamilia
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oClsUsrCadFamilia.Update(btnSalvar.Tag, _
            ...
            Else
                ...
                oClsUsrCadFamilia.Insert(txtDescricao.Text.Trim, _
                                             cboAtivo.SelectedValue)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrCadFamilia.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oClsUsrCadFamilia.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
