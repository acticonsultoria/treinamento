...
Public Class frmCadParceiroNogocioHistorico
...
#Region "::: CONTROLES :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            'Configura Grid
            Call ConfiguraGrid(grdHistorico, Formulario.FinanceiroDespesaLancamento)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            'Carrega Controles
            txtParceiroNegocio.Text = oGrid.CurrentRow.Cells("razao_social").Value
            txtUsuario.Text = goUsuario.sNome

            'Configura Grid
            Call ConfiguraGrid(grdHistorico, Formulario.FinanceiroDespesaLancamento)
            oClsUsrCadParceiroNegocio.LoadGridHistorico(grdHistorico, iCodigoParceiroNegocio)
...
#End Region
    ...
    Private Sub btnInserirHitorico_Click(sender As Object, e As EventArgs) Handles btnInserirHitorico.Click
        Try
            Dim sHistorico As String = ""

            sHistorico = InputBox("Digite o histórico:").ToUpper

            If sHistorico = "" Then
                Exit Sub
            Else
                oClsUsrCadParceiroNegocio.InsertHistorico(iCodigoParceiroNegocio, sHistorico)
                oClsUsrCadParceiroNegocio.LoadGridHistorico(grdHistorico, iCodigoParceiroNegocio)
            End If
        Catch ex As Exception
    ...
    Private Sub btnBloquearCliente_Click(sender As Object, e As EventArgs) Handles btnBloquearCliente.Click
        Try
            Dim sJustificativa As String = ""

            sJustificativa = InputBox("Digite a justificativa:").ToUpper

            If sJustificativa = "" Then
                Exit Sub
            Else
                oClsUsrCadParceiroNegocio.UpdateBloqueio(iCodigoParceiroNegocio, sJustificativa)
                oClsUsrCadParceiroNegocio.LoadGridHistorico(grdHistorico, iCodigoParceiroNegocio)
            End If
        Catch ex As Exception
            Call TratamentoErro(ex.Message, Me.Parent.Text)
