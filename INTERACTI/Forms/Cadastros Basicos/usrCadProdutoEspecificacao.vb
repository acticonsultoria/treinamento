...
Public Class usrCadProdutoEspecificacao

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadProdutoEspecificacao As New clsUsrCadProdutoEspecificacao
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub usrCadProdutoEspecificacao_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) 
        ...
        Try
            ...
            Select Case e.KeyCode
                ...
                Case Keys.F5
                    Select Case sender.Name
                        Case "cboCliente", "cboClienteFiltro"
                            Dim oComboBox(1) As UIComboBox
                            oComboBox(0) = cboCliente : oComboBox(1) = cboClienteFiltro
                            Call LoadCombo(oComboBox, "sp_select_combo_cadastro_basico_cliente " & goUsuario.iEmpresa, False)
    ...
    Private Sub usrCadProdutoEspecificacao_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: ESPECIFICAÇÃO TÉCNICA :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.CadastroBasicoProdutoEspecificacao
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.CadastroBasicoProdutoEspecificacao)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.CadastroBasicoProdutoEspecificacao)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.CadastroBasicoProdutoEspecificacao, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: ARQUIVO :::"
    ...
    Private Sub btnConfigurarGridArquivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGridArquivo.Click
        ...
        Try
            ...
            'Configura Grid
            Call ConfiguraGrid(grdArquivo, Formulario.CadastroBasicoProdutoEspecificacao)
            ...
            If Validacao() = True Then
                ...
                If ValidacaoArquivo() = True Then
                    ...
                    If IsNumeric(btnInserirArquivo.Tag) = False Then
                        ...
                        'Insere Arquivo
                        Call InsertArquivoBD("tb_cad_produto_especificacao", _
                    ...
                    Else
                        ...
                        'Atualiza Arquivo
                        Call UpdateArquivoBD("tb_cad_produto_especificacao", _
                                             txtDescricaoArquivo.Text.Trim, _
                                             txtRevisaoArquivo.Text.Trim, _
                    ...
                    'Carrega Grid
                    Call LoadGridArquivoBD(grdArquivo, "tb_cad_produto_especificacao", btnSalvar.Tag)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrCadProdutoEspecificacao_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoEspecificacao, gcDelete)            
            btnNovo1.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoEspecificacao, gcInsert)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoEspecificacao, gcPrint)
            btnExcelGridArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoEspecificacao, gcPrint)
            btnExcluirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoEspecificacao, gcDelete)
            btnInserirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoEspecificacao, gcInsert)
...
#Region "::: ESPECIFICAÇÃO TÉCNICA :::"
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoProdutoEspecificacao, gcUpdate) = True Then

                With grdListagem.CurrentRow.Cells

                    'Seta Controles
                    txtCodigo.Text = .Item("codigo_especificacao").Value
                ...
                Call LoadGridArquivoBD(grdArquivo, "tb_cad_produto_especificacao", grdListagem.CurrentRow.Cells("codigo").Value)
        ...
        Try
            ...
            If VerificaSelecaoRow(grdListagem) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro” & iif(gSelecaoRow.Count = 1, “?", “s?”), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    'Exclui Registro
                    oClsCadProdutoEspecificacao.Delete()
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadProdutoEspecificacao.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadProdutoEspecificacao.CodigoEspecificacao = txtCodigo.Text.Trim
            oClsCadProdutoEspecificacao.Descricao = txtDescricao.Text.Trim
            oClsCadProdutoEspecificacao.CodigoCliente = IIf(cboCliente.SelectedIndex = -1, -1, cboCliente.SelectedValue)
            oClsCadProdutoEspecificacao.Ativo = cboAtivo.SelectedValue

            'Verifica o Tipo de Operação
            If IsNumeric(btnSalvar.Tag) Then
                oClsCadProdutoEspecificacao.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadProdutoEspecificacao.Insert()
                btnSalvar.Tag = oClsCadProdutoEspecificacao.Codigo
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadProdutoEspecificacao.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadProdutoEspecificacao.ValidaEspecificacaoProduto(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
                                                                      txtCodigo.Text.Trim, _
                                                                      IIf(cboCliente.SelectedIndex = -1, -1, cboCliente.SelectedValue)) = False Then
                frmMain.errInfo.SetError(lblCodigo, "Esta Especificação: " & txtCodigo.Text & " já está associado a outro Registro.")
                txtCodigo.Focus()
                Exit Function
            End If
            ...
            If VerificaSelecaoRow(grdArquivo) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro” & iif(gSelecaoRow.Count = 1, “?", “s?”), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    For Each oRow As GridEXRow In gSelecaoRow
                        ...
                        modFunction.DeleteArquivoBD("tb_cad_produto_especificacao", oRow.Cells("path").Value, btnSalvar.Tag)
