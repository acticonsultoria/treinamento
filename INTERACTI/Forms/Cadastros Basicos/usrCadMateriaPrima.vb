...
Public Class usrCadMateriaPrima

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadMateriaPrima As New clsUsrCadMateriaPrima
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            LoadCombo(cboCategoria, "sp_select_combo_cadastro_basico_categoria_mp " & goUsuario.iEmpresa)
            LoadCombo(cboCategoriaFiltro, "sp_select_combo_cadastro_basico_categoria_mp " & goUsuario.iEmpresa)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros            
            oClsCadMateriaPrima.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadMateriaPrima.Descricao = txtDescricao.Text.Trim
            oClsCadMateriaPrima.CodigoCategoria = cboCategoria.SelectedValue
            oClsCadMateriaPrima.Ativo = cboAtivo.SelectedValue
            oClsCadMateriaPrima.Densidade = txtDensidade.Value
            oClsCadMateriaPrima.ValorKilo = txtValorKilo.Value
            oClsCadMateriaPrima.CodigoMoeda = cboMoeda.SelectedValue

            'Verifica o Tipo de Operação
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadMateriaPrima.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadMateriaPrima.Insert()
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadMateriaPrima.LoadGrid(grdListagem, _
                                 txtDescricaoFiltro.Text.Trim, _
                                 cboCategoriaFiltro.SelectedValue)
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadMateriaPrima.ValidaCodigo(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
                                        txtDescricao.Text.Trim) = False Then
                frmMain.errInfo.SetError(lblDescricao, "Este Código: " & txtDescricao.Text & " já está associado a outro Registro.")
                txtDescricao.Focus()
                Exit Function
            End If
