...
Public Class frmCadProdutoQualidadeImportar
...
#Region "::: CONTROLES :::"
    ...
    Private Sub cboGrupoCaracteristica_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboGrupoCaracteristica.SelectedIndexChanged
        Try

            Dim oClsUsrCadQualidadeCaracteristicaInspecionar As New clsUsrCadQualidadeCaracteristicaInspecionar
            oClsUsrCadQualidadeCaracteristicaInspecionar.LoadGridGrupo(grdListagem, IIf(cboGrupoCaracteristica.SelectedIndex = -1, 0, cboGrupoCaracteristica.SelectedValue))
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            Call LoadCombo(cboGrupoCaracteristica, "sp_select_combo_cadastro_basico_grupo_caracteristicas_inspecionar " & goUsuario.iEmpresa)
    ...
    Private Sub Importar()
        Try
            ...
            For Each oRow In grdListagem.GetRows
                'Insere Registro
                Call oClsCadProduto.InsertQualidade(lCodigoItem, _
