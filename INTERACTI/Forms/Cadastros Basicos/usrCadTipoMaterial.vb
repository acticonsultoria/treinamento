...
Public Class usrCadTipoMaterial

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadTipoMaterial As New clsUsrCadTipoMaterial
...
#Region "::: FUNCTION / SUB :::"
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoArea, gcUpdate) = True Then
                ...
                With grdListagem.CurrentRow.Cells
                    ...
                    txtCodigo.Text = .Item("codigo_material").Value
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadTipoMaterial.Update(txtCodigo.Text, _
                                           txtDescricao.Text, _
                                           cboAtivo.SelectedValue, _
                                           btnSalvar.Tag)
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadTipoMaterial.Insert(txtCodigo.Text, _
                                           txtDescricao.Text, _
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadTipoMaterial.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If ValidaCampo(txtDescricao, lblCodigo, TipoCampo.texto) = False Then
                Exit Function
            End If
