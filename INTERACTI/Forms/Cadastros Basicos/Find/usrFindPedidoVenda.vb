...
Public Class usrFindPedidoVenda

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsVenProduto As New clsUsrVenPedido
            ...
            Select Case e.KeyCode
                ...
                Case Keys.Enter
                    If Not grdFind.CurrentRow Is Nothing Then
                        If IsNothing(oComboBoxFind) = False Then oComboBoxFind.SelectedValue = grdFind.CurrentRow.Cells("codigo_pedido").Value
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            'Configura Grid
            Call oClsVenProduto.LoadGridFind(grdFind)
