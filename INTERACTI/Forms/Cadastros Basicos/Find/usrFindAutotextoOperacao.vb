...
Public Class usrFindAutotextoOperacao
...
#Region "::: CONTROLES :::"
    ...
    Private Sub grdFind_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs)

        Try

            'Atualiza Grid
            Call UpdateConfiguraGrid(grdFind.Name,
    ...
    Private Sub grdFind_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs)

        Try

            'Atualiza Grid
            Call UpdateConfiguraGrid(grdFind,
                                     Formulario.CadastroBasicoAutotexto)
    ...
    Private Sub grdFind_GroupsChanging(sender As Object, e As GroupsChangingEventArgs)

        Try

            'Atualiza Grid
            Call UpdateConfiguraGridGrupo(grdFind.Name,
                                          Formulario.CadastroBasicoAutotexto,
                                          e.Group.Column.Key,
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            'Configura Grid
            Call oClsCadAutotextoOperacao.LoadGrid(grdFind, -1, "")
    ...
    Private Sub grdFind_RowDoubleClick(sender As Object, e As RowActionEventArgs) Handles grdFind.RowDoubleClick
        Try
            If IsNothing(oEditBoxFind) = False Then oEditBoxFind.Text &= IIf(oEditBoxFind.Text.Trim = "", "", vbCrLf) & grdFind.CurrentRow.Cells.Item("autotexto").Value
