...
Public Class frmFindParceiroNegocio
...
#Region "::: CONTROLES :::"
    ...
    Private Sub frmFindParceiroNegocio_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
            ...
            Select Case e.KeyCode
                ...
                Case Keys.Enter 
                    If Not grdFind.CurrentRow Is Nothing Then
                        If isNothing(oMaskedEditBoxFind) = False Then oMaskedEditBoxFind.Text = grdFind.CurrentRow.Cells("razao_social").Value
                        If isNothing(oEditBoxFind) = False Then oEditBoxFind.Text = grdFind.CurrentRow.Cells("razao_social").Value
    ...
    Private Sub frmFindParceiroNegocio_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf frmFindParceiroNegocio_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Seta Tamanho / Posição do Formulário
            Me.Size = frmMain.tlpMain.Size : Me.Location = New Point(0, 23)

            'Verifica se foi enviado a Query
            If sQuery = "" Then
                'Configura Grid
                Call oClsCadParceiroNegocio.LoadGridFind(grdFind, _
                                                         iCodigoTipoParceiroNegocio)
            Else
                'Configura Grid
                Call oClsCadParceiroNegocio.LoadGridFind(grdFind, _
                                                         sQuery)
            ...
            'Seta Focu
            grdFind.Focus()
            grdFind.CurrentColumn = grdFind.RootTable.Columns.Item(LoadDescricao("sp_select_configuracao_interacti_combo_parceiro_negocio " & goUsuario.iEmpresa))
