...
Public Class usrCadOutrasCobrancas

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadOutrasCobrancas As New clsUsrCadOutrasCobrancas

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrCadOutrasCobrancas_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrCadOutrasCobrancas_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCadOutrasCobrancas_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrCadOutrasCobrancas_KeyDown))
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros            
            oClsCadOutrasCobrancas.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadOutrasCobrancas.Valor = txtValor.Value
            oClsCadOutrasCobrancas.Descricao = txtDescricao.Text.Trim
            oClsCadOutrasCobrancas.Ativo = cboAtivo.SelectedValue

            'Verifica o Tipo de Operação
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadOutrasCobrancas.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadOutrasCobrancas.Insert()
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadOutrasCobrancas.LoadGrid(grdListagem, _
