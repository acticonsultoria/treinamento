...
Public Class usrCadRncProcesso

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oclsUsrCadRncProcesso As New clsUsrCadRncProcesso
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oclsUsrCadRncProcesso.Update(btnSalvar.Tag, _
            ...
            Else
                ...
                oclsUsrCadRncProcesso.Insert(txtDescricao.Text.Trim, _
                                             cboAtivo.SelectedValue)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oclsUsrCadRncProcesso.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oclsUsrCadRncProcesso.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
