...
Public Class usrCadProdutoFolhaOperacao

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadProdutoFolhaOperacao As New clsUsrCadProdutoFolhaOperacao
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub usrCadProdutoFolhaOperacao_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrCadProdutoFolhaOperacao_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FOLHA DE OPERAÇÃO :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.CadastroBasicoProdutoFolhaOperacao
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.CadastroBasicoProdutoFolhaOperacao)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.CadastroBasicoProdutoFolhaOperacao)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.CadastroBasicoProdutoFolhaOperacao, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: ARQUIVO :::"
    ...
    Private Sub btnConfigurarGridArquivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGridArquivo.Click
        ...
        Try
            ...
            'Configura Grid
            Call ConfiguraGrid(grdArquivo, Formulario.CadastroBasicoProdutoFolhaOperacao)
            ...
            If Validacao() = True Then
                ...
                If ValidacaoArquivo() = True Then
                    ...
                    If IsNumeric(btnInserirArquivo.Tag) = False Then
                        ...
                        'Insere Arquivo
                        Call InsertArquivoBD("tb_cad_produto_folha_operacao", _
                    ...
                    Else
                        ...
                        'Atualiza Arquivo
                        Call UpdateArquivoBD("tb_cad_produto_folha_operacao", _
                                             txtDescricaoArquivo.Text.Trim, _
                                             txtRevisaoArquivo.Text.Trim, _
                    ...
                    'Carrega Grid
                    Call LoadGridArquivoBD(grdArquivo, "tb_cad_produto_folha_operacao", btnSalvar.Tag)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrCadProdutoFolhaOperacao_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoFolhaOperacao, gcDelete)
            btnNovo1.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoFolhaOperacao, gcInsert)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoFolhaOperacao, gcPrint)
            btnExcelGridArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoFolhaOperacao, gcPrint)
            btnExcluirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoFolhaOperacao, gcDelete)
            btnInserirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoFolhaOperacao, gcInsert)
...
#Region "::: FOLHA DE OPERAÇÃO :::"
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoProdutoFolhaOperacao, gcUpdate) = True Then

                With grdListagem.CurrentRow.Cells

                    'Seta Controles
                    txtCodigo.Text = .Item("codigo_FolhaOperacao").Value
                ...
                Call LoadGridArquivoBD(grdArquivo, "tb_cad_produto_folha_operacao", grdListagem.CurrentRow.Cells("codigo").Value)
        ...
        Try
            ...
            If VerificaSelecaoRow(grdListagem) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro” & iif(gSelecaoRow.Count = 1, “?", “s?”), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    'Exclui Registro
                    oClsCadProdutoFolhaOperacao.Delete()
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadProdutoFolhaOperacao.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadProdutoFolhaOperacao.CodigoFolhaOperacao = txtCodigo.Text.Trim
            oClsCadProdutoFolhaOperacao.Descricao = txtDescricao.Text.Trim
            oClsCadProdutoFolhaOperacao.CodigoCliente = IIf(cboCliente.SelectedIndex = -1, -1, cboCliente.SelectedValue)
            oClsCadProdutoFolhaOperacao.Ativo = cboAtivo.SelectedValue

            'Verifica o Tipo de Operação
            If IsNumeric(btnSalvar.Tag) Then
                oClsCadProdutoFolhaOperacao.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadProdutoFolhaOperacao.Insert()
                btnSalvar.Tag = oClsCadProdutoFolhaOperacao.Codigo
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadProdutoFolhaOperacao.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadProdutoFolhaOperacao.ValidaFolhaOperacaoProduto(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
            ...
            If VerificaSelecaoRow(grdArquivo) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro” & iif(gSelecaoRow.Count = 1, “?", “s?”), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    For Each oRow As GridEXRow In gSelecaoRow
                        ...
                        modFunction.DeleteArquivoBD("tb_cad_produto_folha_operacao", oRow.Cells("path").Value, btnSalvar.Tag)
