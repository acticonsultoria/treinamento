...
Public Class frmCadParceiroNegocioSociosInativar
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            oClsCadParceiroNegocio.UpdateSocioInativacao(iCodigo, iCodigoParceiroNegocio, _
                                                         chkMorte.Checked, chkExclusao.Checked, chkCessaoQuotas.Checked, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If chkCessaoQuotas.Checked = False And chkExclusao.Checked = False And chkMorte.Checked = False Then
                MsgBox("Favor selecionar um dos motivos.", MsgBoxStyle.OkOnly, "Validação")
                Exit Function
            End If

            If ValidaCampo(txtNumeroRegistro, lblNumeroRegistro, TipoCampo.texto) = False Then
                Exit Function
            End If
