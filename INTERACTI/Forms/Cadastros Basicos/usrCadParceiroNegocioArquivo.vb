...
Public Class usrCadParceiroNegocioArquivo
        ...
        Try
           ...
           Call LoadCombo(cboTipoArquivo, "sp_select_combo_cadastro_basico_tipo_arquivo " & goUsuario.iEmpresa)
            ...
            If Me.Tag.ToString.Contains("CODIGO:") Then
                ...
                Call LoadGridArquivoBD(grdArquivo, "tb_cad_parceiro_negocio", iCodigoParceiroNegocio)
            ...
            If VerificaSelecaoRow(grdArquivo) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro" & iif(gSelecaoRow.Count = 1, "?", "s?"), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    For Each oRow As GridEXRow In gSelecaoRow
                        modFunction.DeleteArquivoBD("tb_cad_parceiro_negocio", oRow.Cells("path").Value, iCodigoParceiroNegocio)
                    Next
...
#End Region
    ...
    Private Sub btnCadastrarTipoArquivo_Click(sender As Object, e As EventArgs) Handles btnCadastrarTipoArquivo.Click
        Try
