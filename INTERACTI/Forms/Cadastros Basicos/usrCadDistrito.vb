...
Public Class usrCadDistrito

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadDistrito As New clsUsrCadDistrito
...
#Region "::: DADOS GERAIS :::"
    Dim oClsCadGrupoConsultora As Object
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call LoadCombo(cboEmpresaria, "sp_select_combo_cadastro_basico_parceiro_negocio_distrito " & goUsuario.iEmpresa)
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoBanco, gcUpdate) = True Then
                ...
                cboEmpresaria.SelectedValue = grdListagem.CurrentRow.Cells("codigo_empresaria").Value

                Call LoadCombo(cboEmpresaria, "sp_select_combo_cadastro_basico_parceiro_negocio_distrito " & goUsuario.iEmpresa & ", " & txtCodigo.Text)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadDistrito.Codigo = txtCodigo.Text
            oClsCadDistrito.Descricao = txtDescricao.Text.Trim
            oClsCadDistrito.Ativo = cboAtivo.SelectedValue
            oClsCadDistrito.CodigoEmpresaria = IIf(cboEmpresaria.SelectedIndex = -1, -1, cboEmpresaria.SelectedValue)

            'Verifica o Tipo de Operação
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadDistrito.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadDistrito.Insert()
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadDistrito.LoadGrid(grdListagem, _
        ...
        Try
            ...
            If oArquivoExcel.ShowDialog = DialogResult.OK Then
                ...
                For i = 2 To oApplicationClass.Rows.Count
                    ...
                    If oApplicationClass.Range("C" & i).Value Is Nothing Then
                        Exit For
                    End If

                    oClsCadDistrito.Codigo = oApplicationClass.Range("C" & i).Value
                    oClsCadDistrito.Descricao = oApplicationClass.Range("D" & i).Value
                    oClsCadDistrito.Ativo = True
