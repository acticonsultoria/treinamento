Public Class usrCadRncFamilia

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadRncFamilia As New clsUsrCadRncFamilia
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCadRncFamilia_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrCadRncFamilia_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCadRncFamilia_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrCadRncFamilia_KeyDown))
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(iFormulario, gcUpdate) = True Then
                ...
                oClsCadRncFamilia.LoadDados(iCodigo:=btnSalvar.Tag, _
                                         sDescricao:=txtDescricao, _
                                         cboAtivo:=cboAtivo)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oClsCadRncFamilia.Update(iCodigo:=btnSalvar.Tag, _
            ...
            Else
                ...
                oClsCadRncFamilia.Insert(sDescricao:=txtDescricao.Text.Trim, _
                                         bAtivo:=cboAtivo.SelectedValue)

                frmMain.Informacao(Mensagem.RegistroInserido)
                btnSalvar.Tag = oClsCadRncFamilia.Codigo
            End If
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadRncFamilia.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oClsCadRncFamilia.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
                                                   txtDescricao.Text.Trim) = False Then
                frmMain.errInfo.SetError(lblDescricao, "Esta descrição: " & txtDescricao.Text & " já está associada a outro Registro.")
                txtDescricao.Focus()
                Exit Function
            End If
