...
Public Class usrCadControleRelacionamento

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadControleRelacionamento As New clsUsrCadControleRelacionamento
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCadControleRelacionamento_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCadControleRelacionamento_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        ...
        Try
            ...
            'Exclui Registros
            Call oClsCadControleRelacionamento.Delete(cboControlePai.SelectedValue, _
                                                      oCurrentRow.Cells("codigo").Value)

            'Insere Registros
            Call oClsCadControleRelacionamento.Insert(cboControlePai.SelectedValue, _
    ...
    Private Sub cboControlePai_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboControlePai.SelectedIndexChanged
        ...
        Try
            ...
            Else
                'Carrega Grid
                Call oClsCadControleRelacionamento.LoadGrid(grdPai, cboControlePai.SelectedValue)
            End If
    ...
    Private Sub cboControleFilho_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboControleFilho.SelectedIndexChanged
        ...
        Try
            ...
            Else
                'Carrega Grid
                Call oClsCadControleRelacionamento.LoadGrid(grdFilho, cboControleFilho.SelectedValue, cboControlePai.SelectedValue, oCurrentRow.Cells("codigo").Value)
            End If
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnSalvar.Enabled = VerificaDireito(Formulario.CadastroBasicoControleVinculado, gcDelete)
            ...
            'Configura Grid
            Call ConfiguraGrid(grdPai, Formulario.CadastroBasicoControleVinculado)
            Call ConfiguraGrid(grdFilho, Formulario.CadastroBasicoControleVinculado)
