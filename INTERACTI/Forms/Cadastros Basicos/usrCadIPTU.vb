...
Public Class usrCadIPTU

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadIPTU As New clsUsrCadIPTU

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrCadIPTU_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrCadIPTU_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCadIPTU_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrCadIPTU_KeyDown))
    ...
    Private Sub Editar(ByVal lCodigo As Long)
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoArea, gcUpdate) = True Then
                ...
                oClsCadIPTU.LoadDadosGalpao(lCodigo, _
                                            txtDescricao, _
                                            cboAtivo, _
                                            txtValorTotalIPTU, _
                                            txtValorM2IPTU)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros            
            oClsCadIPTU.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadIPTU.Descricao = txtDescricao.Text.Trim
            oClsCadIPTU.Ativo = cboAtivo.SelectedValue
            oClsCadIPTU.ValorTotalIPTU = txtValorTotalIPTU.Value
            oClsCadIPTU.ValorM2 = txtValorM2IPTU.Value
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadIPTU.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Verifica se foi Preenchido o Campo - Descrição
            If ValidaCampo(txtValorTotalIPTU, lblValorTotalIPTU, TipoCampo.texto) = False Then
                Exit Function
            End If

            'Verifica se foi Preenchido o Campo - Descrição
            If ValidaCampo(txtValorM2IPTU, lblValorM2IPTU, TipoCampo.texto) = False Then
                Exit Function
            End If
