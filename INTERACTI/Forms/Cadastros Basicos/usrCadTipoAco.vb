...
Public Class usrCadTipoAco

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsUsrCadTipoAco As New clsUsrCadTipoAco
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oClsUsrCadTipoAco.Update(btnSalvar.Tag, _
            ...
            Else
                ...
                oClsUsrCadTipoAco.Insert(txtDescricao.Text.Trim, _
                                         txtDensidade.Value, _
                                         cboAtivo.SelectedValue)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrCadTipoAco.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oClsUsrCadTipoAco.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
