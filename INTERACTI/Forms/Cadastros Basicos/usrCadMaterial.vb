...
Public Class usrCadMaterial

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsUsrCadMaterial As New clsUsrCadMaterial
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If IsNumeric(btnSalvar.Tag) Then
                ...
                oClsUsrCadMaterial.Update(btnSalvar.Tag, _
                                             txtDescricao.Text.Trim, _
                                             txtDensidade.Value, _
            ...
            Else
                ...
                oClsUsrCadMaterial.Insert(txtDescricao.Text.Trim, _
                                             txtDensidade.Value, _
                                             cboAtivo.SelectedValue)

                frmMain.Informacao(Mensagem.RegistroInserido)
                btnSalvar.Tag = oClsUsrCadMaterial.Codigo
            End If
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrCadMaterial.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Passa Parametros
            If oClsUsrCadMaterial.ValidaDescricao(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
