...
Public Class usrCadGrupoConsultora

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadGrupoConsultora As New clsUsrCadGrupoConsultora
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub btnImportarCSV_Click(sender As Object, e As EventArgs) Handles btnImportarCSV.Click
        Try
            ...
            oArquivoExcel.Filter = "Arquivos|*.xls;*.xlsx;*.csv;*.txt"
            oArquivoExcel.InitialDirectory = "c:\\"

            'Verifica se foi Selecionado algum Arquivo
            If oArquivoExcel.ShowDialog = DialogResult.OK Then

                oClsCadGrupoConsultora.ImportarArquivo(oArquivoExcel.FileName)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.CadastroBasicoBanco, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.CadastroBasicoBanco, gcDelete)
            btnNovo1.Enabled = VerificaDireito(Formulario.CadastroBasicoBanco, gcInsert)
            btnNovo.Enabled = VerificaDireito(Formulario.CadastroBasicoBanco, gcInsert)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.CadastroBasicoBanco, gcPrint)
            txtCodigo.Enabled = True
            'Desabilita Aba
            tabMain.TabPages.Remove(pagDados)

            Call LoadCombo(cboLider, "sp_select_combo_cadastro_basico_parceiro_negocio_grupo " & goUsuario.iEmpresa)
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoBanco, gcUpdate) = True Then
                ...
                'Seta Controles
                txtCodigo.Text = grdListagem.CurrentRow.Cells("codigo").Value
                ...
                cboLider.SelectedValue = grdListagem.CurrentRow.Cells("codigo_lider").Value
                txtDistrito.Text = grdListagem.CurrentRow.Cells("distrito").Value
                txtSeamanaNomeacao.Text = grdListagem.CurrentRow.Cells("semana_nomeacao").Value
                btnSalvar.Tag = grdListagem.CurrentRow.Cells("codigo").Value

                Call LoadCombo(cboLider, "sp_select_combo_cadastro_basico_parceiro_negocio_grupo " & goUsuario.iEmpresa & ", " & txtCodigo.Text)
    ...
    Private Sub Novo()
        ...
        Try
            ...
            txtCodigo.Enabled = True
            txtDistrito.Text = ""
            cboLider.SelectedIndex = -1
            txtSeamanaNomeacao.Text = ""
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadGrupoConsultora.Codigo = txtCodigo.Text
            oClsCadGrupoConsultora.Descricao = txtDescricao.Text.Trim
            oClsCadGrupoConsultora.Ativo = cboAtivo.SelectedValue
            oClsCadGrupoConsultora.CodigoLider = IIf(cboLider.SelectedIndex = -1, -1, cboLider.SelectedValue)
            oClsCadGrupoConsultora.Distrito = txtDistrito.Text
            oClsCadGrupoConsultora.SemanaNomeacao = txtSeamanaNomeacao.Text

            'Verifica o Tipo de Operação
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadGrupoConsultora.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadGrupoConsultora.Insert()
                frmMain.Informacao(Mensagem.RegistroInserido)
            End If
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadGrupoConsultora.LoadGrid(grdListagem, _
                                  txtCodigoBancoFiltro.Text.Trim, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            'Verifica se foi Preenchido o Campo - CodigoBanco
            If ValidaCampo(txtCodigo, lblCodigoBanco, TipoCampo.texto) = False Then
                Exit Function
            End If

            'Verifica se a CodigoBanco preenchida é válida
            'If oClsCadGrupoConsultora.ValidaCodigo(txtCodigo.Text.Trim) = False Then
            '    frmMain.errInfo.SetError(lblCodigoBanco, "Este Código: " & txtCodigo.Text & " já está associado a outro Registro.")
            '    txtCodigo.Focus()
            '    Exit Function
            'End If
        ...
        Try
            ...
            If oArquivoExcel.ShowDialog = DialogResult.OK Then
                ...
                For i = 2 To oApplicationClass.Rows.Count
                    ...
                    oClsCadGrupoConsultora.Codigo = oApplicationClass.Range("A" & i).Value
                    oClsCadGrupoConsultora.Descricao = oApplicationClass.Range("B" & i).Value
                    oClsCadGrupoConsultora.Ativo = True
