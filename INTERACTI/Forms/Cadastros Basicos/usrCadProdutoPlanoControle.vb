...
Public Class usrCadProdutoPlanoControle

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadProdutoPlanoControle As New clsUsrCadProdutoPlanoControle
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub usrCadProdutoPlanoControle_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrCadProdutoPlanoControle_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: PLANO DE CONTROLE :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.CadastroBasicoProdutoPlanoControle
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.CadastroBasicoProdutoPlanoControle)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.CadastroBasicoProdutoPlanoControle)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.CadastroBasicoProdutoPlanoControle, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: ARQUIVO :::"
    ...
    Private Sub btnConfigurarGridArquivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGridArquivo.Click
        ...
        Try
            ...
            'Configura Grid
            Call ConfiguraGrid(grdArquivo, Formulario.CadastroBasicoProdutoPlanoControle)
            ...
            If Validacao() = True Then
                ...
                If ValidacaoArquivo() = True Then
                    ...
                    If IsNumeric(btnInserirArquivo.Tag) = False Then
                        ...
                        'Insere Arquivo
                        Call InsertArquivoBD("tb_cad_produto_plano_controle", _
                    ...
                    Else
                        ...
                        'Atualiza Arquivo
                        Call UpdateArquivoBD("tb_cad_produto_plano_controle", _
                                             txtDescricaoArquivo.Text.Trim, _
                                             txtRevisaoArquivo.Text.Trim, _
                    ...
                    'Carrega Grid
                    Call LoadGridArquivoBD(grdArquivo, "tb_cad_produto_plano_controle", btnSalvar.Tag)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrCadProdutoPlanoControle_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoPlanoControle, gcDelete)
            btnNovo1.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoPlanoControle, gcInsert)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoPlanoControle, gcPrint)
            btnExcelGridArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoPlanoControle, gcPrint)
            btnExcluirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoPlanoControle, gcDelete)
            btnInserirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoProdutoPlanoControle, gcInsert)
...
#Region "::: PLANO DE CONTROLE :::"
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoProdutoPlanoControle, gcUpdate) = True Then

                With grdListagem.CurrentRow.Cells

                    'Seta Controles
                    txtCodigo.Text = .Item("codigo_plano_controle").Value
                ...
                Call LoadGridArquivoBD(grdArquivo, "tb_cad_produto_plano_controle", grdListagem.CurrentRow.Cells("codigo").Value)
        ...
        Try
            ...
            If VerificaSelecaoRow(grdListagem) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro” & iif(gSelecaoRow.Count = 1, “?", “s?”), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    'Exclui Registro
                    oClsCadProdutoPlanoControle.Delete()
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadProdutoPlanoControle.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadProdutoPlanoControle.CodigoPlanoControle = txtCodigo.Text.Trim
            oClsCadProdutoPlanoControle.Descricao = txtDescricao.Text.Trim
            oClsCadProdutoPlanoControle.CodigoCliente = IIf(cboCliente.SelectedIndex = -1, -1, cboCliente.SelectedValue)
            oClsCadProdutoPlanoControle.Ativo = cboAtivo.SelectedValue

            'Verifica o Tipo de Operação
            If IsNumeric(btnSalvar.Tag) Then
                oClsCadProdutoPlanoControle.Update()
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadProdutoPlanoControle.Insert()
                btnSalvar.Tag = oClsCadProdutoPlanoControle.Codigo
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadProdutoPlanoControle.LoadGrid(grdListagem, _
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadProdutoPlanoControle.ValidaPlanoControleProduto(IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0), _
            ...
            If VerificaSelecaoRow(grdArquivo) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro” & iif(gSelecaoRow.Count = 1, “?", “s?”), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    For Each oRow As GridEXRow In gSelecaoRow
                        ...
                        modFunction.DeleteArquivoBD("tb_cad_produto_plano_controle", oRow.Cells("path").Value, btnSalvar.Tag)
