...
Public Class usrCadFormato

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadFormato As New clsUsrCadFormato
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadFormato.Update(txtCodigo.Text, _
                                           txtDescricao.Text, _
                                           cboAtivo.SelectedValue, _
                                           btnSalvar.Tag)
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadFormato.Insert(txtCodigo.Text, _
                                           txtDescricao.Text, _
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadFormato.LoadGrid(grdListagem, _
