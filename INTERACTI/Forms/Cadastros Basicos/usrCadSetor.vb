...
Public Class usrCadSetor

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadSetor As New clsUsrCadSetor
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub Editar()
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoBanco, gcUpdate) = True Then
                ...
                'Seta Controles
                txtCodigo.Text = grdListagem.CurrentRow.Cells("codigo_setor").Value
                txtValorFrete.Value = grdListagem.CurrentRow.Cells("valor_frete").Value
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            If Len(btnSalvar.Tag) > 0 Then
                oClsCadSetor.Update(btnSalvar.Tag, txtCodigo.Text, cboAtivo.SelectedValue, txtValorFrete.Value)
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                oClsCadSetor.Insert(txtCodigo.Text, cboAtivo.SelectedValue, txtValorFrete.Value)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadSetor.LoadGrid(grdListagem, txtCodigoBancoFiltro.Text)
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadSetor.ValidaCodigo(txtCodigo.Text.Trim, IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, -1)) = False Then
