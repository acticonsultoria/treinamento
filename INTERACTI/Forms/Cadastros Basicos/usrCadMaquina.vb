...
Public Class usrCadMaquina

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsCadMaquina As New clsUsrCadMaquina
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub usrCadMaquina_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: TURNO :::"
    ...
    Private Sub btnExcelGridTurno_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcelGridTurno.Click

        Try

            'Exporta Grid para Excel
            Call ExportExcel(grdTurno)
    ...
    Private Sub grdTurno_RowCheckStateChanged(sender As Object, e As RowCheckStateChangeEventArgs) Handles grdTurno.RowCheckStateChanged
...
#Region "::: ARQUIVO :::"
    ...
    Private Sub btnConfigurarGridArquivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGridArquivo.Click
        ...
        Try
            ...
            'Configura Grid
            Call ConfiguraGrid(grdArquivo, Formulario.CadastroBasicoMaquinaEquipamento)
            ...
            If Validacao() = True Then
                ...
                If ValidacaoArquivo() = True Then
                    ...
                    If IsNumeric(btnInserirArquivo.Tag) = False Then
                        ...
                        'Insere Arquivo
                        Call InsertArquivoBD("tb_cad_maquina", _
                    ...
                    Else
                        ...
                        'Atualiza Arquivo
                        Call UpdateArquivoBD("tb_cad_maquina", _
                                             txtDescricaoArquivo.Text.Trim, _
                                             txtRevisaoArquivo.Text.Trim, _
                    ...
                    'Carrega Grid
                    Call LoadGridArquivoBD(grdArquivo, "tb_cad_maquina", btnSalvar.Tag)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrCadMaquina_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcDelete)
            btnNovo1.Enabled = VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcInsert)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcPrint)
            btnExcelGridArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcPrint)
            btnExcelGridTurno.Enabled = VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcPrint)
            btnExcluirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcDelete)
            btnInserirArquivo.Enabled = VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcInsert)
            ...
            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.CadastroBasicoMaquinaEquipamento)
            Call ConfiguraGrid(grdTurno, Formulario.CadastroBasicoMaquinaEquipamento)
            Call ConfiguraGrid(grdArquivo, Formulario.CadastroBasicoMaquinaEquipamento)
...
#Region "::: MÁQUINA :::"
        ...
        Try
            ...
            If VerificaDireito(Formulario.CadastroBasicoMaquinaEquipamento, gcUpdate) = True Then
                ...
                With grdListagem.CurrentRow.Cells
                    ...
                    'Carrega Controles
                    txtCodigo.Text = .Item("codigo_maquina").Value
                    btnSalvar.Tag = .Item("codigo").Value
                    txtDescricao.Text = .Item("descricao").Value
                    txtLocal.Text = .Item("local").Value
                    txtPrecoVendaHoraMaquina.Value = .Item("preco_venda_hora_maquina").Value
                    cboAtivo.SelectedValue = .Item("ativo").Value

                    'Carrega Grid - Turno
                    Call oClsCadMaquina.LoadGridTurno(grdTurno, .Item("codigo").Value)

                    'Carrega Grid - Arquivo
                    Call modFunction.LoadGridArquivoBD(grdArquivo, "tb_cad_maquina", .Item("codigo").Value)
    ...
    Private Sub Novo()
        ...
        Try
            ...
            txtDescricao.Text = ""
            txtLocal.Text = ""
            txtPrecoVendaHoraMaquina.Value = 0
            ...
            'Limpa Controles - Turno
            Call oClsCadMaquina.LoadGridTurno(grdTurno, -1)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCadMaquina.Codigo = IIf(IsNumeric(btnSalvar.Tag), btnSalvar.Tag, 0)
            oClsCadMaquina.CodigoMaquina = txtCodigo.Text.Trim
            oClsCadMaquina.Descricao = txtDescricao.Text.Trim
            oClsCadMaquina.Local = txtLocal.Text.Trim
            oClsCadMaquina.PrecoVendaHoraMaquina = txtPrecoVendaHoraMaquina.Value
            oClsCadMaquina.Ativo = cboAtivo.SelectedValue

            'Verifica o Tipo de Operação
            If IsNumeric(btnSalvar.Tag) Then
                Call oClsCadMaquina.Update()
                Call oClsCadMaquina.DeleteTurno()
                Call oClsCadMaquina.InsertTurno(grdTurno)
                frmMain.Informacao(Mensagem.RegistroAlterado)
            Else
                Call oClsCadMaquina.Insert()
                Call oClsCadMaquina.InsertTurno(grdTurno)
                frmMain.Informacao(Mensagem.RegistroInserido)
                btnSalvar.Tag = oClsCadMaquina.Codigo
            End If
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            Call oClsCadMaquina.LoadGrid(grdListagem, _
                                         txtCodigoFiltro.Text.Trim, _
                                         txtDescricaoFiltro.Text.Trim, _
                                         txtLocalFiltro.Text.Trim)
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If oClsCadMaquina.ValidaCodigo(txtCodigo.Text.Trim, _
            ...
            'Verifica se foi Inserido Algum Arquivo na Grid
            ...
            If VerificaSelecaoRow(grdArquivo) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro" & iif(gSelecaoRow.Count = 1, "?", "s?"), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    For Each oRow As GridEXRow In gSelecaoRow
                        modFunction.DeleteArquivoBD("tb_cad_maquina", oRow.Cells("path").Value, btnSalvar.Tag)
                    Next
