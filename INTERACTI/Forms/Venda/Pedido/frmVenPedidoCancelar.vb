...
Public Class frmVenPedidoCancelar
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub CancelarPedidoVenda()
        ...
        Try
            ...
            If MsgBox("Deseja Cancelar o(s) Pedido(s) de Venda?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Text) = MsgBoxResult.Yes Then

                'Seta Cursor do Mouse
                Cursor.Current = Cursors.WaitCursor

                'Cancela Pedido de Venda
                Call oClsVenPedido.Cancelar(IIf(cboJustificativaCancelamento.SelectedIndex = -1, -1, cboJustificativaCancelamento.SelectedValue), _
