...
Public Class frmVenPedidoItemDesmembrarEntrega
...
#Region "::: CONTROLES :::"
    ...
    Private Sub frmVenPedidoItemDesmembrarEntrega_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If txtNumeroEntrega.Value > 0 Then
                ...
                For Each oRow As GridEXRow In grdEntrega.GetDataRows
                    ...
                    If oRow.Cells("nota_fiscal").Value <> "" Then
                        Dim oDataRow As DataRow = oDataTable.NewRow
                        dDataEntrega = oRow.Cells("prazo_entrega").Value
                        oDataRow("nota_fiscal") = oRow.Cells("nota_fiscal").Value
    ...
    Private Sub grdEntrega_CellUpdated(sender As Object, e As ColumnActionEventArgs) Handles grdEntrega.CellUpdated

        Try

            If grdEntrega.CurrentRow.Cells("nota_fiscal").Value <> "" AndAlso _
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub DesmembrarEntrega()
        ...
        Try
            ...
            For Each oRow As GridEXRow In grdEntrega.GetDataRows
                oPrevisaoEntrega.sNotaFiscal = oRow.Cells("nota_fiscal").Value
    ...
    Private Sub LoadEntrega()
        ...
        Try
            ...
            For Each oPrevisaoEntrega As PrevisaoEntrega In oDataEntrega.Values
                Dim oDataRow As DataRow = oDataTable.NewRow
                oDataRow("nota_fiscal") = oPrevisaoEntrega.sNotaFiscal
