...
Public Class frmVenOrcamentoReprovar
...
#Region "::: CONTROLES :::"
    ...
    Private Sub btnGerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGerar.Click
        ...
        Try
            ...
            If MsgBox("Deseja Reprovar o orçamento?", MsgBoxStyle.Question + MsgBoxStyle.YesNo) <> MsgBoxResult.Yes Then Exit Sub

            oClsUsrVenOrcamentoLegado.UpdateStatusReprovado(lCodigoOrcamento,
