...
Public Class frmEstPickingCancelar
...
#Region "::: CONTROLES :::"
    ...
    Private Sub frmEstPickingCancelar_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub frmEstPickingCancelar_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub CancelarPicking()

        Try

            'Verifica se o Usuário deseja Cancelar o Pedido de Venda
            If MsgBox("Deseja Cancelar o(s) Picking(s) Selecionado(s)?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Text) = MsgBoxResult.Yes Then

                'Seta Cursor do Mouse
                Cursor.Current = Cursors.WaitCursor

                'Cancela Pedido de Venda
                Call oClsEstPicking.Cancelar(txtJustificativa.Text.Trim)
