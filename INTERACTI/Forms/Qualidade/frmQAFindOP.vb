    ...
    Private Sub grdListagem_RowDoubleClick(sender As Object, e As RowActionEventArgs) Handles grdListagem.RowDoubleClick
        Try
            ...
            If grdListagem.CurrentColumn.Key = "selecionar" Then
                ...
                If MsgBox("Deseja abrir um relatório de inspeção para a OP [ " & grdListagem.GetValue("ordem_producao") & "] ? ", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Abrir Relatório de Inspeção") = vbNo Then Exit Sub

                lCodigo = grdListagem.GetValue("codigo")
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub LoadGrid()
        Try
            ...
            oClsUsrQARelatorioInspecao.LoadGridFind(grdListagem, _
                                                    IIf(dtpDataInicio.Checked = True, dtpDataInicio.Value, ""), _
                                                    IIf(dtpDataTermino.Checked = True, dtpDataTermino.Value, ""), _
                                                    txtNumeroOrdemProducao.Text.Trim, _
                                                    txtProduto.Text.Trim, _
