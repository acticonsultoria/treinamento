...
Public Class usrIndFilaInspecaoRecebimento

#Region "::: VÁRIAVEIS :::"

    'Classe
    Private oClsUsrIndFilaInspecaoRecebimento As New clsUsrIndFilaInspecaoRecebimento
...
#Region "::: CONTROLES :::"
    ...
    Private Sub btnExcelHistorico_Click(sender As Object, e As EventArgs) Handles btnExcelHistorico.Click
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            ConfiguraGrid(grdListagem, Formulario.IndicadorFilaInspecao)

            'Configura DateTimePicker
            dtpDataCorte.Value = Today.Date
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            oClsUsrIndFilaInspecaoRecebimento.LoadGridGrafico(grdListagem, _
                                                              chrOTD, _
                                                              dtpDataCorte.Value)
