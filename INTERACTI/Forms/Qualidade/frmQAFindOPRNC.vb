    ...
    Private Sub grdListagem_RowDoubleClick(sender As Object, e As RowActionEventArgs) Handles grdListagem.RowDoubleClick
        Try
            ...
            If grdListagem.CurrentColumn.Key = "selecionar" Then
                ...
                If MsgBox("Deseja abrir um RNC para a OP [ " & grdListagem.GetValue("ordem_producao") & "] ? ", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Abrir Registro de Não Conformidade") = vbNo Then Exit Sub
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub LoadGrid()
        Try
            ...
            oClsUsrQARNC.LoadGridFind(grdListagem,
