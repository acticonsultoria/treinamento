Public Class usrRH000000001

#Region "::: CONTROLES :::"

    Private Sub usrRH000000001_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrRH000000001_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "RH000000001.rpt"
            ...
            'Seta Paramentro - Código Funcionário
            goCrystalReport.sReportParameter(2).sParamenter = "@codigo_funcionario"
            goCrystalReport.sReportParameter(2).sValue = IIf(cboFuncionario.SelectedIndex = -1, -1, cboFuncionario.SelectedValue)
