...
Public Class usrFatReportMagma

    '    'Variáveis da Classe
    Private oClsUsrFatReportMagma As New clsUsrFatReportMagma

#Region "::: CONTROLES :::"

    Private Sub usrFatReportMagma_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.RelatorioMagma
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioMagma)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrFatReportMagma_KeyDown))
            ...
            cboTipoDocumentoFiscal.SelectedValue = 1
            ...
            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.RelatorioMagma, gcPrint)
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioMagma, gcPrint)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioMagma)

            'Seta Focu
            txtSegmentoFiltro.Focus()
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrFatReportMagma.LoadGrid(grdListagem, _
                                           IIf(txtSegmentoFiltro.Text.Trim = "", -1, txtSegmentoFiltro.Text.Trim), _
                                           IIf(txtSetorFiltro.Text.Trim = "", -1, txtSegmentoFiltro.Text.Trim), _
                                           ...
                                           IIf(cboTipoDocumentoFiscal.SelectedIndex = -1, -1, cboTipoDocumentoFiscal.SelectedValue))
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            goCrystalReport.sReportParameter(2).sValue = txtSegmentoFiltro.Text.Trim
            'Seta Paramentro - Setor
            goCrystalReport.sReportParameter(3).sParamenter = "@codigo_setor"
            goCrystalReport.sReportParameter(3).sValue = txtSetorFiltro.Text.Trim
            'Seta Paramentro - Código Cliente
            goCrystalReport.sReportParameter(4).sParamenter = "@codigo_cliente"
            goCrystalReport.sReportParameter(4).sValue = IIf(cboClienteFiltro.SelectedIndex = -1, -1, cboClienteFiltro.SelectedValue)
