Public Class usrFat000000007

#Region "::: CONTROLES :::"

    Private Sub usrFat000000007_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrFat000000007_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioFAT000000007, gcPrint)
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "FAT000000007.rpt"
            ...
            goCrystalReport.sReportParameter(2).sParamenter = "@codigo_tipo_documento_fiscal"
            goCrystalReport.sReportParameter(2).sValue = IIf(cboTipoDocumentoFiscal.SelectedIndex = -1, -1, cboTipoDocumentoFiscal.SelectedValue)
            'Seta Paramentro - Data Início
            goCrystalReport.sReportParameter(3).sParamenter = "@data_inicio"
            goCrystalReport.sReportParameter(3).sValue = IIf(dtpDataInicioFiltro.Checked = False, "NULL", dtpDataInicioFiltro.Value)
            'Seta Paramentro - Data Término
            goCrystalReport.sReportParameter(4).sParamenter = "@data_termino"
            goCrystalReport.sReportParameter(4).sValue = IIf(dtpDataTerminoFiltro.Checked = False, "NULL", dtpDataTerminoFiltro.Value)
