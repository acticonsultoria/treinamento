...
Public Class usrFat000000019

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsFat000000019 As New clsusrFat000000019

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrFat000000019_Load(sender As Object, e As EventArgs) Handles Me.Load

        Call ConfigurarUserControl()

    End Sub

    Private Sub usrFat000000019_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.RelatorioFAT000000019
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioFAT000000019)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.RelatorioFAT000000019)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.RelatorioFAT000000019, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrFat000000019_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Carrega Combo - Status
            cboStatusFiltro.Items.Clear()
            cboStatusFiltro.Items.Add("ABAIXO OU IGUAL A 180 DIAS", 1)
            cboStatusFiltro.Items.Add("ACIMA DE 180 DIAS", 2)

            'Carrega TreeView CFOP
            Dim oClsCadCFOP As New clsUsrCadCFOP
            Call oClsCadCFOP.LoadTreeViewCFOPFaturamento(trvMainFiltro)
            ...
            btnExcelGrid.Enabled = VerificaDireito(Formulario.RelatorioFAT000000019, gcPrint)
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioFAT000000019, gcPrint)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsFat000000019.LoadGrid(grdListagem, _
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'goCrystalReport.sReportParameter(2).sValue = cboStatusFiltro.SelectedValue
            ''Seta Paramentro - Nota Fiscal
            'goCrystalReport.sReportParameter(3).sParamenter = "@mes"
            'goCrystalReport.sReportParameter(3).sValue = cboCFOPFiltro.SelectedValue
