...
Public Class usrFat000000016

#Region "::: VÁRIAVEIS :::"

    'Váriaveis da Classe
    Private oClsFat000000016 As New clsUsrFat000000016

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrFat000000016_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.RelatorioFAT000000016
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioFAT000000016)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.RelatorioFAT000000016)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.RelatorioFAT000000016, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioFAT000000016, gcPrint)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.RelatorioFAT000000016, gcPrint)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            Call oClsFat000000016.LoadGrid(grdListagem, _
