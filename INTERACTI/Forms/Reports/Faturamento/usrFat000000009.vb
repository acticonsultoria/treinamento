Public Class usrFat000000009

#Region "::: CONTROLES :::"

    Private Sub usrFat000000009_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrFat000000009_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioFAT000000009, gcPrint)
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "FAT000000009.rpt"
