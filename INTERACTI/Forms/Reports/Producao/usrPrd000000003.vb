Public Class usrPrd000000003

#Region "::: CONTROLES :::"

    Private Sub usrPrd000000003_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrPrd000000003_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "PRD000000003.rpt"
            ...
            goCrystalReport.sReportParameter(2).sValue = IIf(dtpDataInicioFiltro.Checked = False, "NULL", dtpDataInicioFiltro.Value)
            'Seta Paramentro - Data Término
            goCrystalReport.sReportParameter(3).sParamenter = "@data_termino"
            goCrystalReport.sReportParameter(3).sValue = IIf(dtpDataTerminoFiltro.Checked = False, "NULL", dtpDataTerminoFiltro.Value)
