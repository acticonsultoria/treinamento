Public Class usrFin000000017

#Region "::: CONTROLES :::"

    Private Sub usrFin000000017_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrFin000000017_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Carrega ComboBox
            Call LoadCombo(cboVendedor, "sp_select_combo_cadastro_basico_vendedor " & goUsuario.iEmpresa & ", " & goUsuario.iEmpresa, False)
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "FIN000000017.rpt"
