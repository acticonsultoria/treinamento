...
Public Class usrFin000000014

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsFin000000014 As New clsUsrFin000000014
...
#Region "::: CONTROLES :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.RelatorioFIN000000014
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioFIN000000014)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.RelatorioFIN000000014)
    ...
    Private Sub grdListagem_GroupsChanging(sender As Object, e As GroupsChangingEventArgs) Handles grdListagem.GroupsChanging
        ...
        Try
            ...
            Call UpdateConfiguraGridGrupo(grdListagem.Name, _
                                          Formulario.RelatorioFIN000000014, _
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioFIN000000014, gcPrint)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.RelatorioFIN000000014, gcPrint)
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Váriaveis Locais
            Dim sParceiroNegocio As String = ""

            For Each oRow As GridEXRow In gSelecaoRow
                sParceiroNegocio &= IIf(sParceiroNegocio = "", "", ",") & oRow.Cells("codigo_parceiro_negocio").Value
            Next
            ...
            goCrystalReport.sReportParameter(2).sValue = sParceiroNegocio
            ...
            'Abre Relatório
            frmMain.LoadPageReport("FIN000000014", "Instrução de Protesto", oReport)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Controles
            Call oClsFin000000014.LoadGrid(grdListagem, _
