...
Public Class usrFin000000009

    'Variáveis da Classe
    Private oClsFin000000009 As New clsUsrFin000000009
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrFin000000009_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    ...
    Private Sub usrFin000000009_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            'Seta Parametros
            oForm.Grid = grdListagem
            oForm.NomeFormulario = Formulario.RelatorioFIN000000009
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioFIN000000009)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrFin000000009_KeyDown))
            ...
            'Seta Direito
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioFIN000000009, gcPrint)
            btnExcelListagem.Enabled = VerificaDireito(Formulario.RelatorioFIN000000009, gcPrint)
        ...
        Try
            ...
            If goDatabase.sInitialCatalog = "INTERACTI_NORSUL_PRD" Then
                ...
                If goUsuario.iEmpresa = 4 Then
                    ...
                    'Seta Parametros
                    oClsFin000000009.LoadGridLavalpa(grdListagem, _
                                              ...
                                              IIf(sCodigoContaContabil = "", "", sCodigoContaContabil & ", -1"), _
                ...
                Else
                    ...
                    'Seta Parametros
                    oClsFin000000009.LoadGrid(grdListagem, _
                                              IIf(cboTipo.SelectedIndex = -1, "", cboTipo.SelectedValue), _
                                              IIf(dtpDataEmissaoInicioFiltro.Checked = True, dtpDataEmissaoInicioFiltro.Value, ""), _
                                              IIf(dtpDataEmissaoTerminoFiltro.Checked = True, dtpDataEmissaoTerminoFiltro.Value, ""), _
                                              IIf(dtpDataVencimentoInicioFiltro.Checked = True, dtpDataVencimentoInicioFiltro.Value, ""), _
                                              ...
                                              IIf(dtpDataPagamentoInicioFiltro.Checked = True, dtpDataPagamentoInicioFiltro.Value, ""), _
                                              IIf(dtpDataPagamentoTerminoFiltro.Checked = True, dtpDataPagamentoTerminoFiltro.Value, ""), _
                                              IIf(sCodigoContaContabil = "", "", sCodigoContaContabil & ", -1"))
        ...
        Try
            ...
            If goDatabase.sInitialCatalog = "INTERACTI_NORSUL_PRD" Then
                ...
                If goUsuario.iEmpresa = 4 Then
                    ...
                    'Relatório
                    goCrystalReport.sReport = goCrystalReport.sPath & "FIN000000009_Lavalpa.rpt"
                ...
                Else
                    ...
                    'Relatório
                    goCrystalReport.sReport = goCrystalReport.sPath & "FIN000000009.rpt"
            ...
            goCrystalReport.sReportParameter(0).sParamenter = "@tipo"
            goCrystalReport.sReportParameter(0).sValue = IIf(cboTipo.SelectedIndex = -1, "", cboTipo.SelectedValue)
            'Seta Paramentro - Data Emissão Início
            goCrystalReport.sReportParameter(1).sParamenter = "@data_emissao_inicio"
            goCrystalReport.sReportParameter(1).sValue = IIf(dtpDataEmissaoInicioFiltro.Checked = False, "NULL", dtpDataEmissaoInicioFiltro.Value)
            'Seta Paramentro - Data Emissão Término
            goCrystalReport.sReportParameter(2).sParamenter = "@data_emissao_termino"
            goCrystalReport.sReportParameter(2).sValue = IIf(dtpDataEmissaoTerminoFiltro.Checked = False, "NULL", dtpDataEmissaoTerminoFiltro.Value)
            'Seta Paramentro - Data Vencimento Início
            goCrystalReport.sReportParameter(3).sParamenter = "@data_vencimento_inicio"
            goCrystalReport.sReportParameter(3).sValue = IIf(dtpDataVencimentoInicioFiltro.Checked = False, "NULL", dtpDataVencimentoInicioFiltro.Value)
            'Seta Paramentro - Data Vencimento Término
            goCrystalReport.sReportParameter(4).sParamenter = "@data_vencimento_termino"
            goCrystalReport.sReportParameter(4).sValue = IIf(dtpDataVencimentoTerminoFiltro.Checked = False, "NULL", dtpDataVencimentoTerminoFiltro.Value)
            'Seta Paramentro - Data Pagamento Início
            goCrystalReport.sReportParameter(5).sParamenter = "@data_pagamento_inicio"
            goCrystalReport.sReportParameter(5).sValue = IIf(dtpDataPagamentoInicioFiltro.Checked = False, "NULL", dtpDataPagamentoInicioFiltro.Value)
            'Seta Paramentro - Data Pagamento Término
            goCrystalReport.sReportParameter(6).sParamenter = "@data_pagamento_termino"
            goCrystalReport.sReportParameter(6).sValue = IIf(dtpDataPagamentoTerminoFiltro.Checked = False, "NULL", dtpDataPagamentoTerminoFiltro.Value)
            'Seta Paramentro - Código Centro de Gasto
            goCrystalReport.sReportParameter(7).sParamenter = "@conta_contabil"
            goCrystalReport.sReportParameter(7).sValue = sCodigoContaContabil
            'Seta Paramentro - Empresa
            goCrystalReport.sReportParameter(8).sParamenter = "@codigo_empresa"
            goCrystalReport.sReportParameter(8).sValue = goUsuario.iEmpresa
            'Seta Paramentro - Nome
            goCrystalReport.sReportParameter(9).sParamenter = "usuario"
            goCrystalReport.sReportParameter(9).sValue = goUsuario.sNome
            'Seta Paramentro - Código Conta Contábil
            goCrystalReport.sReportParameter(10).sParamenter = "conta_contabil"
            goCrystalReport.sReportParameter(10).sValue = sContaContabil

            If ((goDatabase.sInitialCatalog = "INTERACTI_NORSUL_PRD") And (goUsuario.iEmpresa = 4)) Then

                'Seta Paramentro - Lavalpa
                goCrystalReport.sReportParameter(11).sParamenter = "@lavalpa"
                goCrystalReport.sReportParameter(11).sValue = IIf(chkParceiro.Checked = True, chkLavalpa.Checked, "NULL")
                'Seta Paramentro - LeSix
                goCrystalReport.sReportParameter(12).sParamenter = "@le_six"
                goCrystalReport.sReportParameter(12).sValue = IIf(chkParceiro.Checked = True, chkLeSix.Checked, "NULL")
    ...
    Private Sub LoadTreeView()
        ...
        Try
            ...
            Dim oClsCadPlanoContas As New clsUsrCadPlanoContas

            'Limpa TreeView
            trvMain.Nodes.Clear()

            'Seta Parametros
            oClsCadPlanoContas.LoadTreeViewSelecionado(trvMain, txtContaContabilFiltro.Text.Trim)
