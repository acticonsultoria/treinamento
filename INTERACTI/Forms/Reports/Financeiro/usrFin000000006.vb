...
Public Class usrFin000000006

    'Variáveis da Classe
    Private oClsFin000000006 As New clsUsrFin000000006
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrFin000000006_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        Try
            ...
            Select Case e.KeyCode
                ...
                Case Keys.F5
                    Select Case sender.Name
                        Case "cboFornecedorFiltro" : Call LoadCombo(cboFornecedorFiltro, "sp_select_combo_cadastro_basico_fornecedor " & goUsuario.iEmpresa, False)
    ...
    Private Sub usrFin000000006_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            'Seta Parametros
            oForm.Grid = grdListagem
            oForm.NomeFormulario = Formulario.RelatorioFIN000000006
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioFIN000000006)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs)
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.RelatorioFIN000000006)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs)
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.RelatorioFIN000000006, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrFin000000006_KeyDown))
            ...
            'Verifica Direito
            btnExcelListagem.Enabled = VerificaDireito(Formulario.RelatorioFIN000000006, gcPrint)
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioFIN000000006, gcPrint)
        ...
        Try
            ...
            If goDatabase.sInitialCatalog = "INTERACTI_NORSUL_PRD" Then
                ...
                If goUsuario.iEmpresa = 4 Then
                    ...
                    'Seta Parametros
                    oClsFin000000006.LoadGridLavalpa(grdListagem, _
                ...
                Else
                    ...
                    'Seta Parametros
                    oClsFin000000006.LoadGrid(grdListagem, _
                                              IIf(cboSegmentoFiltro.SelectedIndex = -1, -1, cboSegmentoFiltro.SelectedValue), _
                                              IIf(cboFornecedorFiltro.SelectedIndex = -1, -1, cboFornecedorFiltro.SelectedValue), _
                                              IIf(cboTipoDataFiltro.SelectedIndex = -1, -1, cboTipoDataFiltro.SelectedValue), _
                                              IIf(dtpDataInicioFiltro.Enabled = True, dtpDataInicioFiltro.Value, ""), _
        ...
        Try
            ...
            If goDatabase.sInitialCatalog = "INTERACTI_NORSUL_PRD" Then
                ...
                If goUsuario.iEmpresa = 4 Then
                    ...
                    'Relatório
                    goCrystalReport.sReport = goCrystalReport.sPath & "FIN000000006_Lavalpa.rpt"
                ...
                Else
                    ...
                    'Relatório
                    goCrystalReport.sReport = goCrystalReport.sPath & "FIN000000006.rpt"
            ...
            goCrystalReport.sReportParameter(3).sParamenter = "@codigo_fornecedor"
            goCrystalReport.sReportParameter(3).sValue = IIf(cboFornecedorFiltro.SelectedIndex = -1, -1, cboFornecedorFiltro.SelectedValue)
            ...
            If ((goDatabase.sInitialCatalog = "INTERACTI_NORSUL_PRD") And (goUsuario.iEmpresa = 4)) Then
                ...
                goCrystalReport.sReportParameter(8).sParamenter = "@lavalpa"
                goCrystalReport.sReportParameter(8).sValue = IIf(chkParceiro.Checked = True, chkLavalpa.Checked, "NULL")
                'Seta Paramentro - LeSix
                goCrystalReport.sReportParameter(9).sParamenter = "@le_six"
                goCrystalReport.sReportParameter(9).sValue = IIf(chkParceiro.Checked = True, chkLeSix.Checked, "NULL")
