Public Class usrVen000000004

#Region "::: CONTROLES :::"

    Private Sub usrVen000000004_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrVen000000004_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "VEN000000004.rpt"
            ...
            goCrystalReport.sReportParameter(4).sParamenter = "grupo_item"
            goCrystalReport.sReportParameter(4).sValue = IIf(cboGrupoItem.SelectedIndex = -1, "", cboGrupoItem.Text)
            'Seta Paramentro - Data Pedido Início
            goCrystalReport.sReportParameter(5).sParamenter = "@data_pedido_inicio"
            ...
            goCrystalReport.sReportParameter(6).sParamenter = "@data_pedido_termino"
