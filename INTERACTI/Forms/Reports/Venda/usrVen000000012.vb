Public Class usrVen000000012

#Region "::: CONTROLES :::"

    Private Sub usrVen000000012_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrVen000000012_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioVEN0000000012, gcInsert)
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "VEN000000012.rpt"
