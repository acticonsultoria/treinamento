...
Public Class usrVen000000019

    'Variáveis da Classe
    Private oClsVen000000017 As New clsUsrVen000000019

#Region "::: CONTROLES :::"

    Private Sub usrVen000000017_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrVen000000017_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.RelatorioVEN000000019)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.RelatorioVEN000000019, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrVen000000017_KeyDown))
            ...
            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.RelatorioVEN000000019, gcPrint)
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioVEN000000019, gcPrint)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioVEN000000019)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            Call oClsVen000000017.LoadGrid(grdListagem, _
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            'Relatório
            goCrystalReport.sReport = goCrystalReport.sPath & "VEN000000017.rpt"
            ...
            goCrystalReport.sReportParameter(4).sParamenter = "@codigo_marca"
            goCrystalReport.sReportParameter(4).sValue = IIf(cboMarcaFiltro.SelectedIndex = -1, -1, cboMarcaFiltro.SelectedValue)
