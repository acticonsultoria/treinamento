...
Partial Class usrVen000000015
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(usrVen000000015))
        ...
        Me.txtNumeroMesesPedidoFiltro = New Janus.Windows.GridEX.EditControls.NumericEditBox()
        Me.lblNumeroMesesPedidoFiltro = New System.Windows.Forms.Label()
        ...
        Me.txtNumeroMesesOrcamentoFiltro = New Janus.Windows.GridEX.EditControls.NumericEditBox()
        Me.lblNumeroMesesOrcamentoFiltro = New System.Windows.Forms.Label()
        ...
        Me.pagLista.Text = "Relatório de Vendas - VEN000000015"
        '
        'btnAgruparGrid
        '
        ...
        Me.grpFiltro.Controls.Add(Me.txtNumeroMesesPedidoFiltro)
        Me.grpFiltro.Controls.Add(Me.lblNumeroMesesPedidoFiltro)
        ...
        Me.grpFiltro.Controls.Add(Me.txtNumeroMesesOrcamentoFiltro)
        Me.grpFiltro.Controls.Add(Me.lblNumeroMesesOrcamentoFiltro)
        ...
        '
        'txtNumeroMesesPedidoFiltro
        '
        Me.txtNumeroMesesPedidoFiltro.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtNumeroMesesPedidoFiltro.DecimalDigits = 0
        Me.txtNumeroMesesPedidoFiltro.Location = New System.Drawing.Point(710, 34)
        Me.txtNumeroMesesPedidoFiltro.Name = "txtNumeroMesesPedidoFiltro"
        Me.txtNumeroMesesPedidoFiltro.Size = New System.Drawing.Size(113, 20)
        Me.txtNumeroMesesPedidoFiltro.TabIndex = 10
        Me.txtNumeroMesesPedidoFiltro.Text = "0"
        Me.txtNumeroMesesPedidoFiltro.Value = New Decimal(New Integer() {0, 0, 0, 0})
        '
        'lblNumeroMesesPedidoFiltro
        '
        Me.lblNumeroMesesPedidoFiltro.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lblNumeroMesesPedidoFiltro.AutoSize = True
        Me.lblNumeroMesesPedidoFiltro.ImeMode = System.Windows.Forms.ImeMode.NoControl
        Me.lblNumeroMesesPedidoFiltro.Location = New System.Drawing.Point(707, 17)
        Me.lblNumeroMesesPedidoFiltro.Name = "lblNumeroMesesPedidoFiltro"
        Me.lblNumeroMesesPedidoFiltro.Size = New System.Drawing.Size(116, 14)
        Me.lblNumeroMesesPedidoFiltro.TabIndex = 9
        Me.lblNumeroMesesPedidoFiltro.Text = "Nº Meses  Não Vende:"
        '
        'lblDataFiltro
        '
        ...
        '
        'txtNumeroMesesOrcamentoFiltro
        '
        Me.txtNumeroMesesOrcamentoFiltro.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtNumeroMesesOrcamentoFiltro.DecimalDigits = 0
        Me.txtNumeroMesesOrcamentoFiltro.Location = New System.Drawing.Point(591, 34)
        Me.txtNumeroMesesOrcamentoFiltro.Name = "txtNumeroMesesOrcamentoFiltro"
        Me.txtNumeroMesesOrcamentoFiltro.Size = New System.Drawing.Size(113, 20)
        Me.txtNumeroMesesOrcamentoFiltro.TabIndex = 8
        Me.txtNumeroMesesOrcamentoFiltro.Text = "0"
        Me.txtNumeroMesesOrcamentoFiltro.Value = New Decimal(New Integer() {0, 0, 0, 0})
        '
        'lblNumeroMesesOrcamentoFiltro
        '
        Me.lblNumeroMesesOrcamentoFiltro.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lblNumeroMesesOrcamentoFiltro.AutoSize = True
        Me.lblNumeroMesesOrcamentoFiltro.ImeMode = System.Windows.Forms.ImeMode.NoControl
        Me.lblNumeroMesesOrcamentoFiltro.Location = New System.Drawing.Point(588, 17)
        Me.lblNumeroMesesOrcamentoFiltro.Name = "lblNumeroMesesOrcamentoFiltro"
        Me.lblNumeroMesesOrcamentoFiltro.Size = New System.Drawing.Size(106, 14)
        Me.lblNumeroMesesOrcamentoFiltro.TabIndex = 7
        Me.lblNumeroMesesOrcamentoFiltro.Text = "Nº Meses Não Orça:"
        '
        'cboUFFiltro
        '
        Me.cboUFFiltro.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.cboUFFiltro.Location = New System.Drawing.Point(515, 34)
        Me.cboUFFiltro.Name = "cboUFFiltro"
        Me.cboUFFiltro.Size = New System.Drawing.Size(70, 20)
        Me.cboUFFiltro.TabIndex = 6
        '
        'lblUFFiltro
        '
        Me.lblUFFiltro.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lblUFFiltro.AutoSize = True
        Me.lblUFFiltro.ImeMode = System.Windows.Forms.ImeMode.NoControl
        Me.lblUFFiltro.Location = New System.Drawing.Point(512, 17)
        Me.lblUFFiltro.Name = "lblUFFiltro"
        Me.lblUFFiltro.Size = New System.Drawing.Size(23, 14)
        Me.lblUFFiltro.TabIndex = 5
        ...
        'cboVendedorFiltro
        '
        Me.cboVendedorFiltro.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.cboVendedorFiltro.AutoSize = False
        Me.cboVendedorFiltro.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.cboVendedorFiltro.Location = New System.Drawing.Point(237, 34)
    ...
    Friend WithEvents txtNumeroMesesOrcamentoFiltro As Janus.Windows.GridEX.EditControls.NumericEditBox
    Friend WithEvents lblNumeroMesesOrcamentoFiltro As System.Windows.Forms.Label
    ...
    Friend WithEvents txtNumeroMesesPedidoFiltro As Janus.Windows.GridEX.EditControls.NumericEditBox
    Friend WithEvents lblNumeroMesesPedidoFiltro As System.Windows.Forms.Label
