...
Public Class usrVen000000020

    'Variáveis da Classe
    Private oClsVen000000018 As New clsUsrVen000000020
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.RelatorioVEN000000020)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.RelatorioVEN000000020, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Carrega ComboBox
            Call LoadCombo(cboVendedorFiltro, "sp_select_combo_cadastro_basico_item_marca " & goUsuario.iEmpresa)
            Call LoadComboColunasGrid(cboCongelarColuna, grdListagem)
            ...
            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.RelatorioVEN000000020, gcPrint)
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioVEN000000020, gcPrint)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioVEN000000020)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            Call oClsVen000000018.LoadGrid(grdListagem, _
                                           ...
                                           IIf(cboVendedorFiltro.SelectedIndex = -1, -1, cboVendedorFiltro.SelectedValue))
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            goCrystalReport.sReportParameter(4).sValue = IIf(cboVendedorFiltro.SelectedIndex = -1, -1, cboVendedorFiltro.SelectedValue)
