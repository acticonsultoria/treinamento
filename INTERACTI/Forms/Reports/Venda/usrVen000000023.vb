...
Public Class usrVen000000023

    'Variáveis da Classe
    Private oClsVen000000023 As New clsUsrVen000000023
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.RelatorioVEN000000023, gcPrint)
            btnVisualizarImpressao.Enabled = VerificaDireito(Formulario.RelatorioVEN000000023, gcPrint)

            Call LoadCombo(cboProduto, "sp_select_combo_cadastro_basico_item_produto_servico " & goUsuario.iEmpresa)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.RelatorioVEN000000023)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            Call oClsVen000000023.LoadGrid(grdListagem, _
                                           ...
                                           IIf(cboProduto.SelectedIndex = -1, -1, cboProduto.SelectedValue))
    ...
    Private Sub VisualizarImpressao()
        ...
        Try
            ...
            goCrystalReport.sReportParameter(3).sValue = IIf(cboProduto.SelectedIndex = -1, -1, cboProduto.SelectedValue)

            goCrystalReport.sReport = goCrystalReport.sPath & "VEN000000023.rpt"

            Dim oReport As New usrReport
            oReport.Dock = DockStyle.Fill

            'Abre Relatório
            frmMain.LoadPageReport("VEN000000023", "Pedido de Venda", oReport)
