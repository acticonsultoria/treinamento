...
Public Class usrCmpPedidoAprovacaoSuperior
...
#Region "::: PEDIDO COMPRA :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Controles
            oClsCmpPedido.LoadGridPedidoAprovacaoSuperior(grdListagem, _
    ...
    Private Sub Reprovar()
        ...
        Try
            ...
            If MsgBox("Deseja Reprovar o Pedido de Compra?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                ...
                'Aprova Pedido
                Call oClsCmpPedido.ReprovacaoSuperior(grdListagem.CurrentRow.Cells("codigo_pedido").Value)
    ...
    Private Sub Aprovar()
        ...
        Try
            ...
            If MsgBox("Deseja Reaprovar o Pedido de Compra?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                ...
                'Aprova Pedido
                Call oClsCmpPedido.AprovacaoSuperior(grdListagem.CurrentRow.Cells("codigo_pedido").Value, _
                                                     grdListagem.CurrentRow.Cells("valor_pedido").Value)
    ...
    Public Function Validacao() As Boolean
        ...
        Try
            ...
            'Verifica se o valor de aprovação do usuário é menor que o valor do pedido
            If grdListagem.CurrentRow.Cells.Item("alcada").Value = True Then
                MsgBox("Pedido fora da sua alçada de aprovação!", vbExclamation, "Alçada")
                Return False
            End If

            'Verifica se o usuário que fez a 1° aprovação superior é o mesmo usuário que está tentando aprovar pela 2° vez
            'Pedidos acima de 30k necessitam da aprovaçao de 2 diretores diferentes.
            If grdListagem.CurrentRow.Cells("codigo_usuario_aprovacao_superior").Value = goUsuario.iUsuario Then
                MsgBox("O pedido necessita da aprovação de 2 diretores diferentes. Você já aprovou este pedido.", vbExclamation, "Validação")
                Return False
            End If
