...
Public Class usrCmpPedidoReaprovar
...
#Region "::: PEDIDO COMPRA :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.ComprasPedidoReaprovar
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.ComprasPedidoReaprovar)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.ComprasPedidoReaprovar)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.ComprasPedidoReaprovar, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: PEDIDO COMPRA :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Controles
            oClsCmpPedido.LoadGridPedidoReaprovar(grdListagem, _
    ...
    Private Sub Aprovar()
        ...
        Try
            ...
            If MsgBox("Deseja Aprovar o Pedido de Compra?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                ...
                If VerificaAlcada(grdListagem.CurrentRow.Cells("valor_pedido").Value) = False Then Exit Sub

                If grdListagem.CurrentRow.Cells("valor_pedido").Value <= 1000 Then
    ...
    Private Function VerificaAlcada(dValorPedido As Double) As Boolean
        ...
        Try
            ...
            Dim dValorAlcada As Double = LoadCodigo("sp_load_compras_valor_alcada " & goUsuario.iUsuario & "," & goUsuario.iEmpresa)
