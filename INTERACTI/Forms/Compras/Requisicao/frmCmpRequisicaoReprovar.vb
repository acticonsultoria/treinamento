...
Public Class frmCmpRequisicaoReprovar
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ReprovarRequisicao()

        Try

            'Verifica se o Usuário deseja Reprovar a Requisição
            If MsgBox("Deseja Reprovar o(s) Produto(s) da(s) Requisição(ões) de Compra?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Text) = MsgBoxResult.Yes Then

                'Seta Cursor do Mouse
                Cursor.Current = Cursors.WaitCursor

                'Reprova Requisição
                oClsCmpRequisicaoAprovar.ReprovarRequisicao(txtJustificativa.Text.Trim)
