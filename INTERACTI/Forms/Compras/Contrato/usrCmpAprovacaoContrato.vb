...
Public Class usrCmpAprovacaoContrato
...
#Region "::: PEDIDO COMPRA :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrCmpAprovacaoContrato.LoadGrid(grdListagem, _
    ...
    Private Sub Aprovar()
        ...
        Try
            ...
            If MsgBox("Deseja Aprovar o Contrato?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                ...
                If grdListagem.CurrentRow.Cells("valor").Value <= 5000 Then
                    Call oClsUsrCmpAprovacaoContrato.AprovarContrato(grdListagem.CurrentRow.Cells("codigo").Value)
                Else

                    'Aprova Pedido
                    Call oClsUsrCmpAprovacaoContrato.GerarAprovacaoSuperior(grdListagem.CurrentRow.Cells("codigo").Value)
