...
Public Class usrIntImportacaoNFeTXT_V4_Magma
...
#Region "::: ENUM :::"
    ...
    Private Enum N03
        ...
        PercentualFCP = 8
        ValorFCP = 9
        ModalidadeBaseCalculoICMSST = 10
        IVA = 11
        ReducaoBaseCalculoST = 12
        BaseCalculoST = 13
        AliquotaST = 14
        ValorST = 15
        BaseCalculoFCPST = 16
    ...
    Private Enum N09
        ...
        PercentualFCP = 9
        ValorFCP = 10
        ModalidadeBaseCalculoICMSST = 11
        IVA = 12
        ReducaoBaseCalculoST = 13
        BaseCalculoST = 14
        AliquotaST = 15
        ValorST = 16
        BaseCalculoFCPST = 17
    ...
    Private Enum W02
        ...
        ValorFCPDestino = 4
        ValorICMSUFDestino = 5
        ValorICMSUFRemetende = 6
        'ValorTotalFCP = 7
        BaseCalculoICMSST = 7
        ValorICMSST = 8
        'ValorFCPST = 10
...
#Region "::: CONTROLES :::"
    Private Sub btnPastaVolumes_Click(sender As Object, e As EventArgs) Handles btnPastaVolumes.Click
        Try
            ...
            'Limpa Controle
            txtPastaVolumes.Text = ""
            'Carrega Arquivo
            Call LoadArquivoVolumes()
    ...
    Private Sub btnExcelGrid_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        ...
        Try
            ...
            If pagNotaFiscal.Selected = True Then
                Call Importar()
            End If

            If pagVolumes.Selected = True Then
                Call ImportarVolumes()
            End If
            'Importa Itens
            'Call Importar()
            'Call ImportarVolumes()
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub LoadArquivoVolumes()
        ...
        Try
            ...
            'Verifica se foi Selecionado o Arquivo
            If txtPastaVolumes.Text = "" Then
                'Váriaveis Locais
                Dim oFolder As New FolderBrowserDialog
                'Verifica se foi Selecionado algum Arquivo
                If oFolder.ShowDialog = DialogResult.OK Then
                    txtPastaVolumes.Text = oFolder.SelectedPath
                End If
                'Desabilita FolderDialog
                oFolder.Dispose()
            End If
            ...
            If txtPastaVolumes.Text <> "" Then
                ...
                'Carrega Arquivos
                Call LoadArquivoVolumes(txtPastaVolumes.Text, oDataTable)

                'Preenche Grid
                Call ConfigurarDataMemberGrid(grdVolumes)

                'Carrega Grid
                grdVolumes.DataSource = oDataSet.DefaultViewManager
                grdVolumes.DataMember = oDataSet.Tables(0).TableName
    ...
    Private Sub LoadArquivoVolumes(ByVal sFolder As String, _
                           ByRef oDataTable As DataTable)
        ...
        Try
            ...
            For Each sFile In Directory.GetFiles(sFolder)
                If sFile.ToLower.Contains(".txt") = True Then
                    Dim oDataRow As DataRow = oDataTable.NewRow
                    oDataRow("arquivo") = sFile
                    oDataRow("importado") = oClsIntImportacaoNFe.ArquivoImportadoVolumes(sFile)
                    oDataTable.Rows.Add(oDataRow)
                End If
            Next

            For Each sFolderChildren In Directory.GetDirectories(sFolder)
                Call LoadArquivoVolumes(sFolderChildren, oDataTable)
            Next
                        ...
                        While IsNothing(sLinha) = False
                            ...
                            Select Case sCampo(0)
                                ...
                                Case "I"
                                    ...
                                    oClsFatEmissaoNFeItem.CodigoProdutoServico = sCampo(I.CodigoProduto)
                                    oClsFatEmissaoNFeItem.CodigoEAN = sCampo(I.CodigoEAN)
                                    oClsFatEmissaoNFeItem.Descricao = sCampo(I.Descricao)
                                    oClsFatEmissaoNFeItem.NCM = sCampo(I.NCM)
                                    oClsFatEmissaoNFeItem.CodigoBeneficiamento = sCampo(I.CodigoBeneficiamentoFiscal)
                                    oClsFatEmissaoNFeItem.CodigoCFOP = 0
                                    oClsFatEmissaoNFeItem.CFOP = sCampo(I.CFOP)
                                    ' oClsFatEmissaoNFeItem.CEST = sCampo(I.CEST)
                                    oClsFatEmissaoNFeItem.CodigoNCM = 0

                                    oClsFatEmissaoNFeItem.Quantidade = CDbl(Replace(sCampo(I.QuantidadeComercial), ".", ","))
                                    oClsFatEmissaoNFeItem.ValorFrete = IIf(sCampo(I.ValorFrete) = "", 0, CDbl(Replace(sCampo(I.ValorFrete), ".", ",")))
                                    oClsFatEmissaoNFeItem.ValorSeguro = IIf(sCampo(I.ValorSeguro) = "", 0, CDbl(Replace(sCampo(I.ValorSeguro), ".", ",")))
                                    oClsFatEmissaoNFeItem.ValorOutrasDespesas = IIf(sCampo(I.ValorOutro) = "", 0, CDbl(Replace(sCampo(I.ValorOutro), ".", ",")))
                                    oClsFatEmissaoNFeItem.CodigoUnidadeMedida = 0
                                    oClsFatEmissaoNFeItem.UnidadeMedida = sCampo(I.UnidadeMedidaComercial)
                                    oClsFatEmissaoNFeItem.ValorUnitario = CDbl(Replace(sCampo(I.ValorUnitarioComercial), ".", ","))
                                    oClsFatEmissaoNFeItem.ValorDesconto = IIf(sCampo(I.ValorDesconto) = "", 0, CDbl(Replace(sCampo(I.ValorDesconto), ".", ",")))
                                    oClsFatEmissaoNFeItem.ValorTotal = CDbl(Replace(sCampo(I.ValorTotal), ".", ","))
                                    oClsFatEmissaoNFeItem.IncideValorTotalNF = sCampo(I.IncideTotal)
                                    oClsFatEmissaoNFeItem.PedidoCompra = sCampo(I.NumeroPedido)
                                    oClsFatEmissaoNFeItem.NumeroItemPedidoCompra = IIf(sCampo(I.NumeroItemPedido) = "", 0, sCampo(I.NumeroItemPedido))
                                ...
                                Case "N02"
                                    ...
                                    'oClsFatEmissaoNFeItem.PercentualFCPICMSPartilha = CDbl(Replace(sCampo(N02.PercentualFCP), ".", ","))
                                    'oClsFatEmissaoNFeItem.ValorFCPICMSPartilha = CDbl(Replace(sCampo(N02.ValorFCP), ".", ","))
                                ...
                                Case "N03"
                                    ...
                                    'oClsFatEmissaoNFeItem.BaseCalculo()
                                ...
                                Case "O"
                                    oClsFatEmissaoNFeItem.ClasseEnquadramentoIPI = sCampo(O.CodigoEnquadramento)
                                ...
                                Case "W02"
                                    ...
                                    oClsFatEmissaoNFe.ValorFCPICMSPartilha = CDbl(Replace(sCampo(W02.ValorFCPDestino), ".", ","))
    ...
    Private Sub ImportarVolumes()
        ...
        Try
            ...
            Dim sNumeroLote As String = ""
            Dim sNumeroVolume As String = ""
            Dim sTotalVolumes As String = ""
            ...
            For Each oRow As GridEXRow In grdVolumes.GetCheckedRows
                ...
                If System.IO.File.Exists(oRow.Cells("arquivo").Value) Then
                    ...
                    oClsIntImportacaoNFe.InsertArquivoVolumes(txtPastaVolumes.Text)
                    'Verifica quantos registros existe
                    While IsNothing(sLinha) = False
                        ...
                        sNumeroEtiqueta = sLinha.Substring(1, 17)
                        sNumeroLote = sLinha.Substring(18, 8)
                        sNumeroVolume = sLinha.Substring(26, 4)
                        sTotalVolumes = sLinha.Substring(30, 4)
                        sNumeroPedido = sLinha.Substring(37, 8)
                        sSetor = sLinha.Substring(45, 5)
                        sSemana = sLinha.Substring(50, 6)
                        sCodigoConsultora = sLinha.Substring(56, 6)

                        oClsIntImportacaoNFe.InsertVolumes(sNumeroEtiqueta, _
                                                           sNumeroLote, _
                                                           sNumeroVolume, _
                                                           sTotalVolumes, _
                                                           sNumeroPedido, _
