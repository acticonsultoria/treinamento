...
Public Class frmFinTituloDuplicarParcela

#Region "::: VARIAVEIS :::"

    'Variável da Classe
    Private dDataParcela As Date
...
#Region "::: PROPERTIE :::"
    ...
    Public WriteOnly Property DataParcela() As Date
        Set(ByVal value As Date)
            dDataParcela = value
        End Set
    End Property

    Public WriteOnly Property Parcela() As String
    ...
    Public WriteOnly Property NumeroParcela() As Integer
...
#Region "::: CONTROLES :::"
    ...
    Private Sub frmFinTituloDuplicarParcela_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnDesmembrarParcela_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDesmembrarParcela.Click
        ...
        Try
            ...
            If txtNumeroParcelas.Value > 0 Then
                ...
                For i = 1 To txtNumeroParcelas.Value
                    ...
                    oDataRow("data_vencimento") = DateAdd(DateInterval.Day, (txtIntervaloParcelas.Value * (i - 1)), dDataParcela)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            'Seta Controle
            txtNumeroParcela.Text = sParcela
    ...
    Private Sub DesmembrarParcela()

        Try

            'Váriaveis Locais
            Dim oClsFinTituloDuplicarParcela As New clsFrmFinTituloDuplicarParcela

            'Duplica Parcela
            Call oClsFinTituloDuplicarParcela.DuplicarParcela(lCodigoTituloCapa, _
                                                              iNumeroParcela, _
                                                              grdParcela)
