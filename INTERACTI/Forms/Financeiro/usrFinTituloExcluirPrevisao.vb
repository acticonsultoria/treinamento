...
Public Class usrFinTituloExcluirPrevisao

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsFinTituloExcluirPrevisao As New clsUsrFinTituloExcluirPrevisao
...
#Region "::: GERAL :::"
    ...
    Private Sub usrFinTituloExcluirPrevisao_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrFinTituloExcluirPrevisao_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: TÍTULO :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.FinanceiroExcluirPrevisao
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.FinanceiroExcluirPrevisao)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.FinanceiroExcluirPrevisao)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.FinanceiroExcluirPrevisao, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: GERAL :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrFinTituloExcluirPrevisao_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcluir.Enabled = VerificaDireito(Formulario.FinanceiroExcluirPrevisao, gcDelete)
            btnExcelGrid.Enabled = VerificaDireito(Formulario.FinanceiroExcluirPrevisao, gcPrint)
...
#Region "::: TÍTULO :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Controles
            oClsFinTituloExcluirPrevisao.LoadGrid(grdListagem, _
        ...
        Try
            ...
            If VerificaSelecaoRow(grdListagem) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro” & iif(gSelecaoRow.Count = 1, “?", “s?”), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                    ...
                    'Exclui Registro
                    oClsFinTituloExcluirPrevisao.Delete()
