...
Public Class usrFinDespesaPagamentoCancelar

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsFinDespesaCancelarPagamento As New clsUsrFinDespesaCancelarPagamento
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.FinanceiroDespesaPagamentoCancelar)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.FinanceiroDespesaPagamentoCancelar, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnCancelar.Enabled = VerificaDireito(Formulario.FinanceiroDespesaPagamentoCancelar, gcInsert)
...
#Region "::: CANCELAR :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Controles
            oClsFinDespesaCancelarPagamento.LoadGrid(grdListagem, _
    ...
    Private Sub CancelarPagamento()
        ...
        Try
            ...
            If VerificaSelecaoRow(grdListagem) = True Then
                ...
                If MsgBox(IIf(UBound(gSelecaoRow) > 0, "Deseja Cancelar as Baixas dos Títulos Selecionados?", "Deseja Cancelar a Baixa do Título Selecionado?"), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then

                    'Seta Cursor do Mouse
                    Cursor.Current = Cursors.WaitCursor

                    'Exclui Registro
                    Call oClsFinDespesaCancelarPagamento.CancelarPagamento()
