...
Public Class frmFinReceitaImportarPagamentoAntecipado
    ...
    Private Sub btnConfirmar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfirmar.Click
        ...
        Try
            ...
            If sCodigo <> "" Then
                ...
                oClsFinReceitaLancamento.InsertPagamentoAntecipado(sCodigo)
    ...
    Private Sub btnCancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancelar.Click
        ...
        Try
            ...
            If MsgBox("Deseja Cancelar a Importação?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Text) = MsgBoxResult.Yes Then
                ...
                'Seta Váriavel 
                'sResultado = "N"
                ExecuteQuery("delete from tb_int_importacao_financeiro_pagamento_antecipado where data_input = GETDATE() and importado = 0")
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            oClsFinReceitaLancamento.LoadGridPagamentoAntecipado(grdListagem)
