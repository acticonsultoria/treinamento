...
Public Class usrFinReceitaControleBoletoBancario

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsUsrFinReceitaControleBoletoBancario As New clsUsrFinReceitaControleBoletoBancario
...
#Region "::: PAGAMENTO :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.FinanceiroReceitaControleBoletoBancario
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.FinanceiroReceitaControleBoletoBancario)
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.FinanceiroReceitaControleBoletoBancario)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.FinanceiroReceitaControleBoletoBancario, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            btnExcelGrid.Enabled = VerificaDireito(Formulario.FinanceiroReceitaControleBoletoBancario, gcPrint)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Controles
            oClsUsrFinReceitaControleBoletoBancario.LoadGrid(grdListagem, _
                                                     ...
                                                     txtNossoNumeroFiltro.Text.Trim)
