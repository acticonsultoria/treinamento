...
Public Class usrFinReceitaCheque

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsFinReceitaCheque As New clsUsrFinReceitaCheque
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub usrFinReceitaCheque_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrFinReceitaCheque_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub grdListagem_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdListagem.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem, _
                                     Formulario.FinanceiroReceitaControleCheque)
    ...
    Private Sub grdListagem_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdListagem.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdListagem.Name, _
                                     Formulario.FinanceiroReceitaControleCheque, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrFinReceitaCheque_KeyDown))
            Call AddLostFocus(Me, New DelegateLostFocus(AddressOf Control_LostFocus))

            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.FinanceiroReceitaControleCheque, gcPrint)
            ...
            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.FinanceiroReceitaControleCheque)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Controles
            oClsFinReceitaCheque.LoadGrid(grdListagem, _
    ...
    Private Sub CompensarCheque()
        ...
        Try
            ...
            If VerificaDireito(Formulario.FinanceiroReceitaControleCheque, gcInsert) = True Then

                'Verifica se o Status da Parcela é Aberto
                If grdListagem.CurrentRow.Cells("status_pagamento").Value = StatusReceitaPagamento.ChequeNaoCompensado Then
    ...
    Private Sub CancelarCompensacao()
        ...
        Try
            ...
            'Verifica se o Usuário tem Direito
            If VerificaDireito(Formulario.FinanceiroReceitaControleCheque, gcAdministrator) = True Then

                'Verifica se o Status da Parcela é Aberto
                If grdListagem.CurrentRow.Cells("status_pagamento").Value = StatusReceitaPagamento.Quitado Then
                    ...
                    If MsgBox("Deseja Cancelar a Compensação do Cheque Selecionado?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Parent.Text) = MsgBoxResult.Yes Then
                        ...
                        oClsFinReceitaCheque.CancelarCompensarCheque(grdListagem.CurrentRow.Cells("codigo_titulo_capa").Value, _
                        ...
                        grdListagem.SetValue("status_pagamento", StatusReceitaPagamento.ChequeNaoCompensado)
                        grdListagem.Refresh()
