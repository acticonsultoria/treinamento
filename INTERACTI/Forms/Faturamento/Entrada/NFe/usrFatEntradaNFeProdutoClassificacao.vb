...
Public Class usrFatEntradaNFeProdutoClassificacao

#Region " :::: VARIAVEIS ::::"
    'Variáveis da Classe
    Private oClsUsrFatEntradaNFeProdutoClassificacao As New clsUsrFatEntradaNFeProdutoClassificacao
...
#Region "::: GERAL :::"
    ...
    Private Sub usrFatEntradaNFeProdutoClassificacao_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrFatEntradaNFeProdutoClassificacao_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
...
#Region ":::: CONTROLES ::::"
    ...
    Private Sub btnConfigurarGridListagem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGridListagem.Click
        ...
        Try
            ...
            oForm.NomeFormulario = Formulario.FaturamentoEntradaNFeProdutoClassificacao
            'Abre Formulário
            Call ConfigureMaskEdit(oForm) : Call LoadControlesTraducao(oForm) : oForm.ShowDialog(Me)

            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.FaturamentoEntradaNFeProdutoClassificacao)
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            'Configura Grid
            Call ConfiguraGrid(grdEstoque, Formulario.FaturamentoEntradaNFeProdutoClassificacao)
    ...
    Private Sub btnExcluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcluir.Click
        Try
            ...
            Call Excluir(grdListagem.CurrentRow.Cells("codigo").Value, _
                            grdListagem.CurrentRow.Cells("codigo_entrada_item").Value)
            'Limpa Formulário
            Call Novo()
    ...
    Private Sub grdEstoque_SizingColumn(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.SizingColumnEventArgs) Handles grdEstoque.SizingColumn
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdEstoque.Name, _
                                     Formulario.FaturamentoEntradaNFeProdutoClassificacao, _
                                     e.Column.Key, _
                                     e.ProposedWidth)
    ...
    Private Sub grdEstoque_ColumnMoved(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdEstoque.ColumnMoved
        ...
        Try
            ...
            Call UpdateConfiguraGrid(grdEstoque, _
                                     Formulario.FaturamentoEntradaNFeProdutoClassificacao)
...
#Region ":::: FUNCTION / SUB ::::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Seta Parametros
            oClsUsrFatEntradaNFeProdutoClassificacao.LoadGrid(grdListagem, _
                                                              ...
                                                              IIf(dtpDataEntradaInicioFiltro.Checked = False, "", dtpDataEntradaInicioFiltro.Value))
    ...
    Public Sub Editar(ByVal lCodigoEntradaCapa As Long, _
                      ByVal iCodigoEntradaItem As Integer)

        Try

            'Verifica se o Usuário tem direito para Alterar os Dados
            If VerificaDireito(Formulario.FaturamentoEntradaNFeProdutoClassificacao, gcUpdate) = True Then

                'Seta Cursor do Mouse
                Cursor.Current = Cursors.WaitCursor

                'Seta Código
                oClsUsrFatEntradaNFeProdutoClassificacao.CodigoEntradaCapa = lCodigoEntradaCapa
                oClsUsrFatEntradaNFeProdutoClassificacao.CodigoEntradaItem = iCodigoEntradaItem
                ...
                Call oClsUsrFatEntradaNFeProdutoClassificacao.LoadGridLote(grdEstoque, _
    ...
    Private Sub Salvar(ByVal lCodigoEntradaCapa As Long, _
                      ByVal iCodigoEntradaItem As Integer)
        ...
        Try
            ...
            If IsNumeric(btnInserir.Tag) Then
                ...
                'Atualiza Registro
                Call oClsUsrFatEntradaNFeProdutoClassificacao.Update(lCodigoEntradaCapa, _
            ...
            Else
                ...
                'Insere Registro
                Call oClsUsrFatEntradaNFeProdutoClassificacao.Insert(lCodigoEntradaCapa, _
                                                            iCodigoEntradaItem, _
                                                            cboDeposito.SelectedValue, _
                                                            txtQuantidadeEstoque.Value, _
                                                            sLote, _
    ...
    Private Sub LoadGridLote(ByVal lCodigoEntradaCapa As Long, _
                      ByVal iCodigoEntradaItem As Integer)
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            Call LoadCombo(cboDeposito, "sp_select_combo_cadastro_basico_deposito_faturamento_emissao " & goUsuario.iEmpresa & ", " & lCodigoEntradaCapa & ", " & iCodigoEntradaItem, False)
        ...
        Try
            ...
            If VerificaDireito(Formulario.FaturamentoEntradaNFeProdutoClassificacao, gcUpdate) = True Then
                ...
                With grdEstoque.CurrentRow.Cells
                    ...
                    'txtQuantidadeNotaFiscal.Value = .Item("quantidade_nota_fiscal").Value
    ...
    Private Sub Excluir(ByVal lCodigoEntradaCapa As Long, _
                      ByVal iCodigoEntradaItem As Integer)
        ...
        Try
            ...
            If VerificaSelecaoRow(grdEstoque) = True Then
                ...
                If MsgBox("Deseja excluir permanentemente este" & IIf(gSelecaoRow.Count = 1, " ", "s ") & gSelecaoRow.Count & " registro" & IIf(gSelecaoRow.Count = 1, "?", "s?"), MsgBoxStyle.Question + MsgBoxStyle.YesNo, Me.Text) = MsgBoxResult.Yes Then
                    ...
                    'Exclui Registro
                    oClsUsrFatEntradaNFeProdutoClassificacao.Delete(lCodigoEntradaCapa, _
                                                           iCodigoEntradaItem)
    ...
    Private Sub SalvarMovimentacao(ByVal lCodigoEmissaoCapa As Long)
        ...
        Try
            ...
            oClsUsrFatEntradaNFeProdutoClassificacao.SalvarLote(lCodigoEntradaCapa)
