Public Class frmFatEntradaNFLocalEntrega

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsFatEntradaNFLocalEntrega As New clsFrmFatEntradaNFeLocalEntrega
...
#Region "::: CONTROLES :::"
    ...
    Private Sub frmFatEntradaNFeLocalEntrega_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown, _
                                                                                                                                 txtCNPJ.KeyUp
    ...
    Private Sub frmFatEntradaNFeLocalEntrega_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub frmFatEntradaNFeLocalEntrega_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub txtCNPJ_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCNPJ.TextChanged
        ...
        Try
            ...
            If txtCNPJ.Text.Trim <> "" Then
                ...
                'Carrega Controles
                Call oClsFatEntradaNFLocalEntrega.LoadControlesCNPJ(txtCNPJ.Text.Trim, _
                                                                    txtLogradouro, _
                                                                    txtNumero, _
                                                                    txtComplemento, _
                                                                    txtBairro, _
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub LoadControles()
        ...
        Try
            ...
            'Carrega Controles
            Call oClsFatEntradaNFLocalEntrega.LoadControles(lCodigoEntradaCapa, _
                                                            txtCNPJ, _
                                                            txtLogradouro, _
                                                            txtNumero, _
                                                            txtComplemento, _
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsFatEntradaNFLocalEntrega.CNPJ = txtCNPJ.Text.Trim
            oClsFatEntradaNFLocalEntrega.Logradouro = txtLogradouro.Text.Trim
            oClsFatEntradaNFLocalEntrega.Numero = txtNumero.Text.Trim
            oClsFatEntradaNFLocalEntrega.Complemento = txtComplemento.Text.Trim
            oClsFatEntradaNFLocalEntrega.Bairro = txtBairro.Text.Trim
            oClsFatEntradaNFLocalEntrega.UF = IIf(cboUF.SelectedIndex = -1, -1, cboUF.SelectedValue)
            oClsFatEntradaNFLocalEntrega.CodigoMunicipio = IIf(cboMunicipio.SelectedIndex = -1, -1, cboMunicipio.SelectedValue)
            oClsFatEntradaNFLocalEntrega.CodigoEntradaCapa = lCodigoEntradaCapa

            'Salva o Luga de Entrega
            oClsFatEntradaNFLocalEntrega.Salvar()
