        ...
        Try
            ...
            Select Case grdListagem.CurrentColumn.Key
                ...
                Case "editar" : Call EditarNotaFiscal(grdListagem.CurrentRow.Cells("codigo").Value, _
                                                      grdListagem.CurrentRow.Cells("status").Value)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call LoadCombo(cboTipoNotaFiscal, "sp_select_combo_static_tipo_nota_fiscal_servico", True)
            ...
            tabDados.TabPages.Remove(pagDadosDespesa)
...
#Region "::: NOTA FISCAL :::"
    ...
    Private Sub EditarNotaFiscal(ByVal lCodigoEmissaoCapa As Long, _
