...
Public Class usrFatEmissaoNFs

#Region "::: VARIAVEIS :::"

    'Variáveis da Classe
    Private oClsFatEmissaoNFs As New clsUsrFatEmissaoNFs
...
#Region "::: GERAL :::"
    ...
    Private Sub usrFatEmissaoNFs_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub grdListagem_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdListagem.DoubleClick
        ...
        Try
            ...
            Select Case grdListagem.CurrentColumn.Key
                ...
                Case "imprimir"
                    If grdListagem.CurrentRow.Cells("status").Value = CInt(StatusNFSe.AutorizadoUso) Or _
                       grdListagem.CurrentRow.Cells("status").Value = CInt(StatusNFSe.Cancelada) Then
                    ...
                    End If
                Case "email" : Call EnviarEmailNFSe()
    ...
    Private Sub cboServico_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboServico.SelectedIndexChanged
        ...
        Try
            ...
            Else
                ...
                txtDescricao.Text += vbCrLf + vbCrLf + "Ficam reduzida a zero as Alíq. De PIS/COFINS, Conform. Lei 5171/2004, Art 6º."

                txtCnae.Text = LoadCodigo("sp_load_faturamento_servico_cnae " & goUsuario.iEmpresa & ", " & cboServico.SelectedValue)
    ...
    Private Sub CalculaImpostos() Handles txtValorServico.ValueChanged, _
        ...
        Try
            ...
            If btnSalvar.Enabled = True Then
                ...
                'Verifica se a Base de Calculo é maior que R$ 215,00 para incidir o IR
                If txtBaseCalculo.Value >= 215.0 Then
...
#Region "::: GERAL :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            btnTransmitirNFSE.Visible = True
            btnRetornarNFSE.Visible = True
...
#Region "::: NOTA FISCAL :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'EnviarEmail("teste", "tharcius.pivetta@acticonsultoria.com.br", "", "", "body", -1)
    ...
    Private Sub Novo()
        ...
        Try
            ...
            If goDatabase.sInitialCatalog = "INTERACTI_ASCON_PRD" Then
                cboModelo.SelectedValue = "A"
                cboTipoRPS.SelectedValue = 1
...
#Region "::: SERVIÇO :::"
    ...
    Private Sub SalvarServico()
        ...
        Try
            ...
            oClsFatEmissaoNFs.CNAE = txtCnae.Text.Trim
    ...
    'Private Sub Servico_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtAliquotaPIS.LostFocus, _
    ...
    '        Select Case sender.name
    '            Case "txtAliquotaPIS" : txtValorPIS.Value = txtBaseCalculo.Value * txtAliquotaPIS.Value / 100.0
    '            Case "txtAliquotaCOFINS" : txtValorCOFINS.Value = txtBaseCalculo.Value * txtAliquotaCOFINS.Value / 100.0
    '            Case "txtAliquotaINSS" : txtValorINSS.Value = txtBaseCalculo.Value * txtAliquotaINSS.Value / 100.0
    '            Case "txtAliquotaCSLL" : txtValorCSLL.Value = txtBaseCalculo.Value * txtAliquotaCSLL.Value / 100.0
    '            Case "txtAliquotaIR" : txtValorIR.Value = txtBaseCalculo.Value * txtAliquotaIR.Value / 100.0
    '        End Select
...
#Region " ::: INTEGRAÇÃO ::: "
    ...
    Private Sub Integracao()
        ...
        Try
            ...
            oClsIntegracao.IntegracaoNFSEmissaoPedidoVendaOrdemServico(btnSalvar.Tag)
            'estouqe
            oClsIntegracao.IntegracaoNFSEmissaoEstoque(btnSalvar.Tag)
...
#Region "::: FUNCTION / SUB (NFSe):::"
        ...
        Try
            ...
            If oClsNFSeConsultaSituacaoNFSe.Send = True Then
                ...
                Try
                    ...
                    If oClsNFSeConsultaSituacaoNFSe.Situacao = 2 Then 'Aguardando processamento
                    ...
                    ElseIf oClsNFSeConsultaSituacaoNFSe.Situacao = 4 Then
                    ...
                    ElseIf oClsNFSeRetornoEnvioNFSe.Send() = True Then
                        ...
                        If oXmlDocument.InnerXml.Contains(">E4<") Then
                            ...
                            'Verifica o Status
                            Call VerificaStatus(StatusNFSe.AguardandoRetorno)
                        ElseIf oXmlDocument.InnerXml.ToUpper.Contains("PROCESSAMENTO") Then
                            'Verifica Status
                            txtMensagemNFSe.Text = "O LOTE NÃO FOI PROCESSADO AINDA"
                            'Atualiza o Status da Nota Fiscal
                            oClsFatEmissaoNFs.UpdateStatusNotaFiscal(oClsFatEmissaoNFs.CodigoEmissaoNFSe, _
            ...
            oClsFatEmissaoNFs.EnviarEmailEmissaoNFS(txtCodigoVerificacao.Text.Trim)
    ...
    Private Sub EnviarEmailNFSe()
        ...
        Try
            ...
            'sCorpo &= "Para acessá-la, acesse o link a seguir: https://notajoseense.sjc.sp.gov.br/notafiscal-ws/servico/notafiscal/autenticacao/cpfCnpj/" & Replace(Replace(Replace(goUsuario.sCNPJEmpresa, ".", ""), "/", ""), "-", "") & "/inscricaoMunicipal/" & goEmitente.sInscricaoMunicipal & "/numeroNota/" & txtNotaFiscal.Text & "/codigoVerificacao/" & txtCodigoVerificacao.Text
            sCorpo &= "https://notajoseense.sjc.sp.gov.br/notafiscal/qrCodeServlet?idMultiTenant=8&hash=" & txtCodigoVerificacao.Text
    ...
    Private Sub EnviarEmailNFSe1()
        ...
        Try
            ...
            sArquivo = "\\DOMINIO\ACTi\NFS-e\Envio\P" & txtLote.Text & ".xml"
    ...
    Private Sub ImprimirNFSe(ByVal iCodigoTipoAmbiente As Integer, _
        ...
        Try
            ...
            'System.Diagnostics.Process.Start("https://notajoseense.sjc.sp.gov.br/notafiscal-ws/servico/notafiscal/autenticacao/cpfCnpj/" & Replace(Replace(Replace(goUsuario.sCNPJEmpresa, ".", ""), "/", ""), "-", "") & "/inscricaoMunicipal/" & goEmitente.sInscricaoMunicipal & "/numeroNota/" & lNotaFiscal & "/codigoVerificacao/" & sCodigoVerificacao)
            System.Diagnostics.Process.Start("https://notajoseense.sjc.sp.gov.br/notafiscal/qrCodeServlet?idMultiTenant=8&hash=" & sCodigoVerificacao)
...
#Region "::: IMPORTAR NFSE :::"
    Private Sub btnImportarNFSe_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImportarNFSe.Click
        Try
            ImportarNFSe()
        Catch ex As Exception
            TratamentoErro(ex.Message, Me.Parent.ToString)
    ...
    Private Sub ImportarNFSe()
        Try
            'Importar a NFS-e
            Dim sCodigoVerificacao As String = InputBox("Digite o código de verificação:", "Importar NFS-e")

            'Verificando
            If Not IsNumeric(sCodigoVerificacao) Then Exit Sub

            'Limpando os dados
            Call Novo()

            'Carrega Dados
            Dim oClsFatEntradaNFSeSJC As New clsFatEntradaNFSeSJC(sCodigoVerificacao)
            ...
            'Verifica se a Nota Fiscal foi Emitida pela Empresa
            If oClsFatEntradaNFSeSJC.CNPJPrestador.Trim.Replace(".", "").Replace("/", "").Replace("-", "") <> goEmitente.sCNPJ.Replace(".", "").Replace("/", "").Replace("-", "") Then
                MsgBox("Esta Nota Fiscal não foi Emitida pela Empresa: " & vbCrLf & goEmitente.sRazaoSocial & ".", MsgBoxStyle.Information, Me.Parent.Text)
                Exit Sub
            End If

            'Variável para receber o código criado
            Dim lCodigo As Long
            Dim sErro As String
            'Setando os dados
            With oClsFatEntradaNFSeSJC

                sErro = oClsFatEmissaoNFs.ImportarNFSe(lCodigo, _
                                               .NotaFiscal, _
                                               .NumeroRPS, _
                                               CDate(.Data), _
                                               .CodigoTipoTributacao, _
                                               .UFServico, _
                                               .MunicipioServico, _
                                               .CNPJTomador, _
                                               .RazaoSocialTomador, _
                                               sCodigoVerificacao, _
                                               Mid(.Servico.Replace(" / ", " "), 1, 14), _
                                               .Discriminacao, _
                                               .ValorServico, _
                                               .ReterISS, _
                                               .AliquotaISS, _
                ...
                If sErro = "" Then
                    frmMain.Informacao("NFs-e Importada com sucesso!", Color.Blue)
                Else
                    MsgBox(sErro, MsgBoxStyle.Exclamation, "Importar NFS-e")
                End If
                ...
                'Carrega Dados da Nota Fiscal
                Call oClsFatEmissaoNFs.LoadDadosNotaFiscal(lCodigo, _
                                                           cboModelo, _
                                                           cboSerie, _
                                                           txtNotaFiscal, _
                                                           txtDataEmissao, _
                ...
                '
                txtValorOriginal.Value = .ValorLiquido
            End With
        Catch ex As Exception
            TratamentoErro(ex.Message, Me.Parent.ToString)
        End Try
