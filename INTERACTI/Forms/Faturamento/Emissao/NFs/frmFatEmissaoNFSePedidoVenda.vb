...
Public Class frmFatEmissaoNFSePedidoVenda
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub frmFatEmissaoNFSePedidoVenda_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub frmFatEmissaoNFSePedidoVenda_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: IMPORTAR :::"
    ...
    Private Sub btnConfigurarGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfigurarGrid.Click
        ...
        Try
            ...
            'Configura Grid
            Call ConfiguraGrid(grdPedidoVenda, Formulario.FaturamentoEmissaoNFS)
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub ConfigurarFormulario()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf frmFatEmissaoNFSePedidoVenda_KeyDown))
            ...
            'Carrega Combo
            Call LoadCombo(cboClienteFiltro, "sp_select_combo_faturamento_venda_cliente " & goUsuario.iEmpresa & ", " & CInt(TipoItem.servico), False)
            Call LoadComboColunasGrid(cboCongelarColuna, grdPedidoVenda)

            'Carrega Combo - Grid
            ' Call LoadComboGrid(grdPedidoVenda, "codigo_ncm", "sp_select_combo_cadastro_basico_ncm " & goUsuario.iEmpresa)
...
#Region "::: IMPORTAR :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Verifica se foi Selecionado o Cliente
            If cboClienteFiltro.SelectedIndex = -1 And IsNumeric(txtNumeroPedidoFiltro.Text) = False Then
