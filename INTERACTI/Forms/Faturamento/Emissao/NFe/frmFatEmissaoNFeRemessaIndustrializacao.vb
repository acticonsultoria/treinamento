...
Public Class frmFatEmissaoNFeRemessaIndustrializacao

#Region "::: VARIAVEIS :::"

    'Variável da Classe
    Private oClsFatEmissaoNFeRemessaIndustrializacao As New clsFrmFatEmissaoNFeRemessaIndustrializacao
...
#Region "::: GERAL :::"
    ...
    Private Sub frmFatEmissaoNFeRemessaIndustrializacao_KeyDown(sender As Object, e As KeyEventArgs)
    ...
    Private Sub frmFatEmissaoNFeRemessaIndustrializacao_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: MATÉRIA PRIMA :::"
    ...
    Private Sub grdRemessaIndustrializacao_Click(sender As Object, e As EventArgs) Handles grdRemessaIndustrializacao.Click
    ...
    Private Sub grdRemessaIndustrializacao_CellValueChanged(sender As Object, e As ColumnActionEventArgs) Handles grdRemessaIndustrializacao.CellValueChanged
    ...
    Private Sub grdRemessaIndustrializacao_RowCheckStateChanged(sender As Object, e As RowCheckStateChangeEventArgs) Handles grdRemessaIndustrializacao.RowCheckStateChanged
    ...
    Private Sub grdRemessaIndustrializacao_GroupsChanging(sender As Object, e As GroupsChangingEventArgs) Handles grdRemessaIndustrializacao.GroupsChanging
...
#Region "::: GERAL :::"
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsFatEmissaoNFeRemessaIndustrializacao.LoadGrid(grdRemessaIndustrializacao, _
                                                                   IIf(cboFornecedorFiltro.SelectedIndex = -1, -1, cboFornecedorFiltro.SelectedValue), _
                                                                   IIf(cboOrdemProducaoFiltro.SelectedIndex = -1, -1, cboOrdemProducaoFiltro.SelectedValue))
    ...
    Private Sub Importar()
        ...
        Try
            ...
            Call oClsFatEmissaoNFeRemessaIndustrializacao.Iportar(lCodigoEmissaoCapa, _
