...
Public Class frmFatEmissaoNFeRemessa
...
#Region "::: DADOS GERAIS :::"
    ...
    Private Sub frmFatEmissaoNFeRemessa_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: IMPORTAR :::"
    ...
    Private Sub cboDestinacaoFiltro_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboDestinacaoFiltro.SelectedIndexChanged
    ...
    Private Sub grdRemessa_CellValueChanged(sender As Object, e As ColumnActionEventArgs) Handles grdRemessa.CellValueChanged
    ...
    Private Sub grdRemessa_RowCheckStateChanging(sender As Object, e As RowCheckStateChangingEventArgs) Handles grdRemessa.RowCheckStateChanging
