Public Class usrCfgNumeracaoOrdemServico
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCfgNumeracaoOrdemServico_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCfgNumeracaoOrdemServico_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub cboFormato_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboFormato.SelectedIndexChanged, _
                                                                                          ...
                                                                                          txtNumeroOrdemServico.ValueChanged, _
        ...
        Try
            ...
            If cboFormato.SelectedIndex <> -1 Then
                ...
                'Carrega Controles
                LoadDescricaoQuery(txtExemplo, "SELECT dbo.fn_formato_numero_documento_exemplo(" & txtNumeroOrdemServico.Value & ",'" & txtSigla.Text.Trim & "', GETDATE(), " & txtNumeroCaracter.Value & ", " & cboFormato.SelectedValue & ")")
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Carrega Controles
            oClsCfgNumeracaoDocumento.LoadControles("ORDEM SERVIÇO", _
                                                    "", _
                                                    txtSigla, _
                                                    txtNumeroCaracter, _
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCfgNumeracaoDocumento.Tipo = "ORDEM SERVIÇO"
            ...
            oClsCfgNumeracaoDocumento.NumeroDocumento = txtNumeroOrdemServico.Value
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If ValidaCampo(txtNumeroOrdemServico, lblNumeroOrdemServico, True) = False Then
                Exit Function
            End If
