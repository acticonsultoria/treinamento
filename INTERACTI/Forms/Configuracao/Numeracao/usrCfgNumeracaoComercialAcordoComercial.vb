Public Class usrCfgNumeracaoComercialAcordoComercial
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCfgNumeracaoComercialAcordoComercial_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCfgNumeracaoComercialAcordoComercial_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub cboFormato_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboFormato.SelectedIndexChanged, _
                                                                                          ...
                                                                                          txtNumeroAcordoComercial.ValueChanged, _
        ...
        Try
            ...
            If cboFormato.SelectedIndex <> -1 Then
                ...
                'Carrega Controles
                LoadDescricaoQuery(txtExemplo, "SELECT dbo.fn_formato_numero_documento_exemplo(" & txtNumeroAcordoComercial.Value & ",'" & txtSigla.Text.Trim & "', GETDATE(), " & txtNumeroCaracter.Value & ", " & cboFormato.SelectedValue & ")")
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnSalvar.Enabled = VerificaDireito(Formulario.ConfiguracaoNumeracaoComercialAcordoComercial, gcInsert)

            'Carrega Combo
            Call LoadCombo(cboFormato, "sp_select_combo_static_formato_numero", False)

            'Carrega Controles
            oClsCfgNumeracaoDocumento.LoadControles("COMERCIAL - ACORDO COMERCIAL", _
                                                    "", _
                                                    txtSigla, _
                                                    txtNumeroCaracter, _
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCfgNumeracaoDocumento.Tipo = "COMERCIAL - ACORDO COMERCIAL"
            ...
            oClsCfgNumeracaoDocumento.NumeroDocumento = txtNumeroAcordoComercial.Value
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If ValidaCampo(txtNumeroAcordoComercial, lblNumeroAcordoComercial, True) = False Then
                Exit Function
            End If
