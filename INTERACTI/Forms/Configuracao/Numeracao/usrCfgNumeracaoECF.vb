Public Class usrCfgNumeracaoECF
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCfgNumeracaoECF_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCfgNumeracaoECF_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub cboFormato_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboFormato.SelectedIndexChanged, _
        ...
        Try
            ...
            If cboFormato.SelectedIndex <> -1 Then
                ...
                'Carrega Controles
                LoadDescricaoQuery(txtExemplo, "SELECT dbo.fn_formato_numero_documento_exemplo(" & txtNumeroECF.Value & ",'" & txtSigla.Text.Trim & "', GETDATE(), " & txtNumeroCaracter.Value & ", " & cboFormato.SelectedValue & ")")
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnSalvar.Enabled = VerificaDireito(Formulario.ConfiguracaoNumeracaoECF, gcInsert)

            'Carrega Combo
            Call LoadCombo(cboFormato, "sp_select_combo_static_formato_numero", False)

            'Carrega Controles
            oClsCfgNumeracaoDocumento.LoadControles("ECF", _
                                                    "", _
                                                    txtSigla, _
                                                    txtNumeroCaracter, _
                                                    txtNumeroECF, _
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCfgNumeracaoDocumento.Tipo = "ECF"
            ...
            oClsCfgNumeracaoDocumento.NumeroDocumento = txtNumeroECF.Value
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If ValidaCampo(txtNumeroECF, lblNumeroECF, True) = False Then
                Exit Function
            End If
