Public Class usrCfgNumeracaoCotacao
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCfgNumeracaoCotacao_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCfgNumeracaoCotacao_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub cboFormato_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboFormato.SelectedIndexChanged, _
                                                                                          ...
                                                                                          txtNumeroCotacao.ValueChanged, _
        ...
        Try
            ...
            If cboFormato.SelectedIndex <> -1 Then
                ...
                'Carrega Controles
                LoadDescricaoQuery(txtExemplo, "SELECT dbo.fn_formato_numero_documento_exemplo(" & txtNumeroCotacao.Value & ",'" & txtSigla.Text.Trim & "', GETDATE(), " & txtNumeroCaracter.Value & ", " & cboFormato.SelectedValue & ")")
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnSalvar.Enabled = VerificaDireito(Formulario.ConfiguracaoNumeracaoCotacao, gcInsert)

            'Carrega Combo
            Call LoadCombo(cboFormato, "sp_select_combo_static_formato_numero", False)

            'Carrega Controles
            oClsCfgNumeracaoDocumento.LoadControles("COTACAO", _
                                                    "", _
                                                    txtSigla, _
                                                    txtNumeroCaracter, _
                                                    txtNumeroCotacao, _
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCfgNumeracaoDocumento.Tipo = "COTACAO"
            ...
            oClsCfgNumeracaoDocumento.NumeroDocumento = txtNumeroCotacao.Value
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If ValidaCampo(txtNumeroCotacao, lblNumeroCotacao, True) = False Then
                Exit Function
            End If
