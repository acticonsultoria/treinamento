Public Class usrCfgNumeracaoRequisicaoCompra
...
#Region "::: CONTROLES :::"
    ...
    Private Sub usrCfgNumeracaoRequisicaoCompra_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub usrCfgNumeracaoRequisicaoCompra_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub cboFormato_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboFormato.SelectedIndexChanged, _
                                                                                          ...
                                                                                          txtNumeroRequisicaoCompra.ValueChanged, _
        ...
        Try
            ...
            If cboFormato.SelectedIndex <> -1 Then
                ...
                'Carrega Controles
                LoadDescricaoQuery(txtExemplo, "SELECT dbo.fn_formato_numero_documento_exemplo(" & txtNumeroRequisicaoCompra.Value & ",'" & txtSigla.Text.Trim & "', GETDATE(), " & txtNumeroCaracter.Value & ", " & cboFormato.SelectedValue & ")")
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Verifica Direito
            btnSalvar.Enabled = VerificaDireito(Formulario.ConfiguracaoNumeracaoRequisicaoCompra, gcInsert)

            'Carrega Combo
            Call LoadCombo(cboFormato, "sp_select_combo_static_formato_numero", False)

            'Carrega Controles
            oClsCfgNumeracaoDocumento.LoadControles("REQUISICAO COMPRA", _
                                                    "", _
                                                    txtSigla, _
                                                    txtNumeroCaracter, _
                                                    txtNumeroRequisicaoCompra, _
                                                    cboFormato)
    ...
    Private Sub Salvar()
        ...
        Try
            ...
            'Seta Parametros
            oClsCfgNumeracaoDocumento.Tipo = "REQUISICAO COMPRA"
            ...
            oClsCfgNumeracaoDocumento.NumeroDocumento = txtNumeroRequisicaoCompra.Value
    ...
    Private Function Validacao() As Boolean
        ...
        Try
            ...
            If ValidaCampo(txtNumeroRequisicaoCompra, lblNumeroRequisicaoCompra, True) = False Then
                Exit Function
            End If
