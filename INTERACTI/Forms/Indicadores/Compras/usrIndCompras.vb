...
Public Class usrIndCompras

#Region "::: VÁRIAVEIS :::"

    'Classe
    Private oClsIndCompras As New clsUsrIndCompras
...
#Region "::: CONTROLES :::"
    ...
    Private Sub btnExcelAnalitico_Click(sender As Object, e As EventArgs) Handles btnExcelAnalitico.Click
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call LoadCombo(cboTipoFiltro, "sp_select_combo_static_indicador 'COMPRAS'")
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            If cboFornecedor.SelectionLength > 0 Then
                For i = 0 To UBound(cboFornecedor.CheckedValues)
                    sFornecedor &= IIf(sFornecedor = "", "", ",") & cboFornecedor.CheckedValues(i).ToString
                Next
            End If
            ...
            'Carrega Grid
            Call oClsIndCompras.LoadGrid(grdSintetico, _
                                         grdAnalitico, _
                                              chrMain, _
