...
Public Class usrIndFat000000001

#Region "::: VÁRIAVEIS :::"

    'Classe
    Private oClsIndFat000000001 As New clsUsrIndFat000000001

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrIndFat000000001_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrIndFat000000001_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            'Adiciona Título
            chrMain.Titles.Add("Faturamento por Estado", Dundas.Charting.WinControl.Docking.Top, oFont, Color.Black)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFat000000001.LoadGrid(grdListagem, _
    ...
    Private Sub LoadGrafico()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFat000000001.LoadGrafico(chrMain, _
                                                 IIf(dtpDataInicioFiltro.Enabled = True, dtpDataInicioFiltro.Value, ""), _
                                                 IIf(dtpDataTerminoFiltro.Enabled = True, dtpDataTerminoFiltro.Value, ""))
