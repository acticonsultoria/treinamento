...
Public Class usrIndFin000000001

#Region "::: VÁRIAVEIS :::"

    'Classe
    Private oClsIndFin000000001 As New clsUsrIndFin000000001

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrIndFin000000001_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrIndFin000000001_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrIndFin000000001_KeyDown))
            ...
            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.IndicadorFIN000000001)

            Dim oFont As New System.Drawing.Font("Arial", 14, FontStyle.Bold)

            'Adiciona Título
            chrMain.Titles.Add("Receita por Estado", Dundas.Charting.WinControl.Docking.Top, oFont, Color.Black)

            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.IndicadorFIN000000001, gcPrint)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000001.LoadGrid(grdListagem, _
    ...
    Private Sub LoadGrafico()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000001.LoadGrafico(chrMain, _
                                                 IIf(cboTipoDataFiltro.SelectedIndex = -1, -1, cboTipoDataFiltro.SelectedValue), _
                                                 IIf(dtpDataInicioFiltro.Enabled = True, dtpDataInicioFiltro.Value, ""), _
                                                 IIf(dtpDataTerminoFiltro.Enabled = True, dtpDataTerminoFiltro.Value, ""))
