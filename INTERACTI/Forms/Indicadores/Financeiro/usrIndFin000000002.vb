...
Public Class usrIndFin000000002

#Region "::: VÁRIAVEIS :::"

    'Classe
    Private oClsIndFin000000002 As New clsUsrIndFin000000002

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrIndFin000000002_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrIndFin000000002_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrIndFin000000002_KeyDown))
            ...
            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.IndicadorFIN000000002)

            Dim oFont As New System.Drawing.Font("Arial", 14, FontStyle.Bold)

            'Adiciona Título
            chrMain.Titles.Add("Receita por Segmento", Dundas.Charting.WinControl.Docking.Top, oFont, Color.Black)

            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.IndicadorFIN000000002, gcPrint)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000002.LoadGrid(grdListagem, _
    ...
    Private Sub LoadGrafico()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000002.LoadGrafico(chrMain, _
                                                 IIf(cboTipoDataFiltro.SelectedIndex = -1, -1, cboTipoDataFiltro.SelectedValue), _
                                                 IIf(dtpDataInicioFiltro.Enabled = True, dtpDataInicioFiltro.Value, ""), _
                                                 IIf(dtpDataTerminoFiltro.Enabled = True, dtpDataTerminoFiltro.Value, ""))
