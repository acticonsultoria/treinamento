...
Public Class usrIndFin000000004

#Region "::: VÁRIAVEIS :::"

    'Classe
    Private oClsIndFin000000004 As New clsUsrIndFin000000004

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrIndFin000000004_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrIndFin000000004_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrIndFin000000004_KeyDown))
            ...
            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.IndicadorFIN000000004)

            Dim oFont As New System.Drawing.Font("Arial", 14, FontStyle.Bold)

            'Adiciona Título
            chrMain.Titles.Add("Receita por Conta Contábil", Dundas.Charting.WinControl.Docking.Top, oFont, Color.Black)

            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.IndicadorFIN000000004, gcPrint)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000004.LoadGrid(grdListagem, _
    ...
    Private Sub LoadGrafico()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000004.LoadGrafico(chrMain, _
                                                 IIf(dtpDataInicioFiltro.Enabled = True, dtpDataInicioFiltro.Value, ""), _
                                                 IIf(dtpDataTerminoFiltro.Enabled = True, dtpDataTerminoFiltro.Value, ""))
