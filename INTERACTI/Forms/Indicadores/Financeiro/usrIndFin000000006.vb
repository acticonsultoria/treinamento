...
Public Class usrIndFin000000006

#Region "::: VÁRIAVEIS :::"

    'Classe
    Private oClsIndFin000000006 As New clsUsrIndFin000000006

#End Region

#Region "::: CONTROLES :::"

    Private Sub usrIndFin000000006_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub usrIndFin000000006_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "::: FUNCTION / SUB :::"
    ...
    Private Sub ConfigurarUserControl()
        ...
        Try
            ...
            Call AddKeyDown(Me, New DelegateKeyDown(AddressOf usrIndFin000000006_KeyDown))
            ...
            'Configura Grid
            Call ConfiguraGrid(grdListagem, Formulario.IndicadorFIN000000006)

            Dim oFont As New System.Drawing.Font("Arial", 14, FontStyle.Bold)

            'Adiciona Título
            chrMain.Titles.Add("Classificação dos Gasto", Dundas.Charting.WinControl.Docking.Top, oFont, Color.Black)

            'Verifica Direito
            btnExcelGrid.Enabled = VerificaDireito(Formulario.IndicadorFIN000000006, gcPrint)
    ...
    Private Sub LoadGrid()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000006.LoadGrid(grdListagem, _
    ...
    Private Sub LoadGrafico()
        ...
        Try
            ...
            'Carrega Grid
            Call oClsIndFin000000006.LoadGrafico(chrMain, _
                                                 IIf(dtpDataInicioFiltro.Enabled = True, dtpDataInicioFiltro.Value, ""), _
                                                 IIf(dtpDataTerminoFiltro.Enabled = True, dtpDataTerminoFiltro.Value, ""))
