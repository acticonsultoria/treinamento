...
namespace BoletoNet
{
    ...
    public enum EnumInstrucoes_BancoSicred
    {
    ...
    public class Instrucao_BancoSicred: AbstractInstrucao, IInstrucao
    {

        #region Construtores 

		public Instrucao_BancoSicred()
		{
			try
			{
        ...
        public Instrucao_BancoSicred(int codigo)
        {
            this.carregar(codigo, 0);
        }

        public Instrucao_BancoSicred(int codigo, int nrDias)
        {
