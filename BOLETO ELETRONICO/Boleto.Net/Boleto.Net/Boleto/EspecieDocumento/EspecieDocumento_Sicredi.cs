...
namespace BoletoNet
{
    public class EspecieDocumento_Sicredi : AbstractEspecieDocumento, IEspecieDocumento
    {
        ...
        public EspecieDocumento_Sicredi(int codigo)
        {
         ...
         public static int getCodigoEspecieByEnum(EnumEspecieDocumento_Sicredi especie)
        {
            switch (especie)
            {
                case EnumEspecieDocumento_Sicredi.DuplicataMercantilIndicacao: return 1;
        ...
        public static EnumEspecieDocumento_Sicredi getEnumEspecieByCodigo(int codigo)
        {
            switch (codigo)
            {
