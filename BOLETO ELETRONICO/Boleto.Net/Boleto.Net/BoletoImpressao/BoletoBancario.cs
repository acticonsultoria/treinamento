    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        public string GeraHtmlReciboSacado()
        {
            try
            {
                ...
                html.Append(Html.ReciboPagadorParte1);
                html.Append("<br />");
                html.Append(Html.ReciboPagadorParte2);
                html.Append(Html.ReciboPagadorParte3);
                html.Append(Html.ReciboPagadorParte4);
                html.Append(Html.ReciboPagadorParte5);
                html.Append(Html.ReciboPagadorParte6);
                html.Append(Html.ReciboPagadorParte7);

                if (Instrucoes.Count == 0)
                    html.Append(Html.ReciboPagadorParte8);

                MontaInstrucoes();
                html.Append(Html.ReciboCedenteParte12);
                //html.Append("<table class=""ctN w666"">");
                //html.Append("<tr class=""h13""><td /></tr><tr><td class=""Ar"">Corte na linha pontilhada</td></tr><tr><td class=""cut"" /></tr></table><table class=""ctN w666""><tr class=""h13""><td /></tr><tr class=""h13""><td /></tr><tr class=""h13""><td /></tr><tr class=""h13""><td /></tr><tr class=""h13""><td /></tr><tr class=""h13""><td /></tr></table>");
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras)
        {
            ...
            return html
                ...
                .Replace("@LOCALPAGAMENTO", Boleto.LocalPagamento.Replace(_ibanco.Nome,""))
                .Replace("@DATAVENCIMENTO", dataVencimento)
                .Replace("@CEDENTE", Cedente.Nome + " - " + Cedente.CPFCNPJ)
        ...
        public string MontaHtml(string fileName)
        {
            ...
            C2of5i cb = new C2of5i(Boleto.CodigoBarra.Codigo.Replace("-",""), 1, 50, Boleto.CodigoBarra.Codigo.Length);
