    ...
    internal class Banco_Bradesco : AbstractBanco, IBanco
    {
        ...
        public string GerarDetalheRemessaCNAB400(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                _detalhe += Utils.FitStringLength(boleto.NossoNumero, 12, 12, '0', 0, true, true, true); //Nosso Numero (11)
               ...
               // _detalhe += Mod11Bradesco(Utils.FitStringLength(boleto.NossoNumero, 11, 11, '0', 0, true, true, true), 7); // Digito de Auto Conferencia do Nosso Número (01)
