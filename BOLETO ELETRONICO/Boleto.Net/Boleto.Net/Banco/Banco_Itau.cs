...
namespace BoletoNet
{
    ...
    internal class Banco_Itau : AbstractBanco, IBanco
    {
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            ...
            {
                //Carteiras válidas
                int[] cv = new int[] { 112, 175, 176, 178, 109, 198, 107, 122, 142, 143, 196, 126, 131, 146, 150, 156, 157, 169, 121 };//Flavio(fhlviana@hotmail.com) - adicionado a carteira 109
                bool valida = false;
        ...
        public override void FormataCodigoBarra(Boleto boleto)
        {
            try
            {
                ...
                if (boleto.Carteira == "175" || boleto.Carteira == "176" || boleto.Carteira == "178" || boleto.Carteira == "156" || boleto.Carteira == "157" || boleto.Carteira == "109" || boleto.Carteira == "121")//Flavio(fhlviana@hotmail.com) - Adicionado carteira 109
                {
            ...
            try
            {
                ...
                switch (boleto.Instrucoes.Count)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        if (boleto.Instrucoes[0].Codigo.ToString() == "34")
                            _prazo += boleto.Instrucoes[0].QuantidadeDias;
                        break;
                    default:
                        if (boleto.Instrucoes[0].Codigo.ToString() == "34")
                            _prazo += boleto.Instrucoes[0].QuantidadeDias;
                        else if (boleto.Instrucoes[1].Codigo.ToString() == "34")
                            _prazo += boleto.Instrucoes[1].QuantidadeDias;
                        break;
                }
                if (_prazo == "")
                    _prazo = "00";
                _detalhe += _prazo; // Complemento do registro
                _detalhe += " ";
